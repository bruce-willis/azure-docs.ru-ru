...
**Диски SSD уровня "Стандартный"** обеспечивают более надежную работу, чем жесткие диски уровня "Стандартный", и в настоящее время доступны в предварительной версии. Дополнительные сведения о доступности дисков SSD уровня "Стандартный" в регионах приведены в разделе [Часто задаваемые вопросы о дисках виртуальных машин Azure IaaS, а также об управляемых и неуправляемых дисках уровня "Премиум"](../articles/virtual-machines/windows/faq-for-disks.md#standard-ssds-azure-regions).
...
| **Тип управляемых дисков HDD <br>уровня "Стандартный"** | **S4** | **S6** | **S10** | **S15** | **S20** | **S30** | **S40** | **S50** |
|------------------|---------|---------|--------|--------|--------|----------------|----------------|----------------| 
