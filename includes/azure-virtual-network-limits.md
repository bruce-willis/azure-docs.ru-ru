...
** Эти ограничения по умолчанию применяются к подпискам, для которых эти ограничения ранее не повышались по запросу в службу поддержки
