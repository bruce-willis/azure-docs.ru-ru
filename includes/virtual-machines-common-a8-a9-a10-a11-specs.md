...
Виртуальные машины HPC с поддержкой RDMA следует развертывать в одной и той же группе доступности или масштабируемом наборе виртуальных машин (при использовании модели развертывания с помощью Azure Resource Manager) или в одной и той же облачной службе (при использовании классической модели развертывания). Если вы используете масштабируемый набор виртуальных машин, ограничьте развертывание одной группой размещения. Например, в шаблоне Resource Manager задайте для свойства *singlePlacementGroup* значение *true*. Ниже приведены дополнительные требования к виртуальным машинам HPC с поддержкой RDMA для получения доступа к сети Azure RDMA.