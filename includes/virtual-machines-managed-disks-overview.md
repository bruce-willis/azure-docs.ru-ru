...
ms.locfileid: "35414592"
---
# <a name="azure-managed-disks-overview"></a>Обзор компонента "Управляемые диски" Azure

Компонент "Управляемые диски" Azure упрощает управление дисками виртуальных машин Azure IaaS. Он управляет [учетными записями хранения](../articles/storage/common/storage-introduction.md), связанными с этими дисками. Вам нужно лишь выбрать тип ([жесткий диск уровня "Стандартный"](../articles/virtual-machines/windows/standard-storage.md), диск SSD уровня "Премиум" или [диск SSD уровня "Стандартный"](../articles/virtual-machines/windows/premium-storage.md)) и размер диска, а Azure самостоятельно создаст диск и будет управлять им.
...
**Тип хранилища.** Для компонента "Управляемые диски" доступны три уровня производительности: [диски HDD уровня "Стандартный"](../articles/virtual-machines/windows/standard-storage.md), диски SSD уровня "Стандартный" (предварительная версия) и диски [уровня "Премиум"](../articles/virtual-machines/windows/premium-storage.md). Плата, взимаемая за использование управляемых дисков, зависит от того, какой тип хранилища выбран для диска.
...
| **Тип управляемого диска SSD <br>уровня "Стандартный"** | **E10** | **E15** | **E20** | **E30** | **E40** | **E50** |
|------------------|--------|--------|--------|----------------|----------------|----------------| 
| Размер диска        | 128 ГБ | 256 Гиб | 512 ГБ | 1024 Гиб (1 ТиБ) | 2048 Гиб (2 ТиБ) | 4095 Гиб (4 ТиБ) | 
