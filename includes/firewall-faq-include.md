...
### <a name="which-capabilities-are-supported-in-the-azure-firewall-public-preview-release"></a>Какие возможности поддерживаются в общедоступной предварительной версии службы "Брандмауэр Azure"?  
...
* Возможность централизованно создавать, применять и регистрировать политики приложений и сетевых подключений в подписках Azure и виртуальных сетях.
...
Сейчас служба "Брандмауэр Azure" находится на этапе управляемой общедоступной предварительной версии, к которой можно присоединиться с помощью команды PowerShell Register-AzureRmProviderFeature. Эта команда описана в документации по общедоступной предварительной версии этой службы.
...
Общедоступная предварительная версия службы "Брандмауэр Azure" поддерживает только фильтрацию исходящего трафика. Входящая защита для протоколов, отличных от HTTP/S (например, RDP, SSH или FTP), предварительно запланирована в общедоступной версии службы "Брандмауэр Azure".  
