...
## [Руководство по обеспечению безопасности](../active-directory/authentication/multi-factor-authentication-security-best-practices.md)
...
### [Развертывание MFA на основе облака](../active-directory/authentication/howto-mfa-getstarted.md)
...
#### [Адаптеры AD FS Windows Server 2016](https://docs.microsoft.com/windows-server/identity/ad-fs/operations/configure-ad-fs-and-azure-mfa)
...
## Сервер MFA
### [Развертывание MFA в локальной среде](../active-directory/authentication/howto-mfaserver-deploy.md)
...
## [Руководство пользователя MFA](../active-directory/authentication/end-user/current/multi-factor-authentication-end-user.md)
