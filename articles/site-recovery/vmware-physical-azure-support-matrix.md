...
>
> - Для загрузки виртуальных машин в Azure на серверах под управлением Red Hat Enterprise Linux 5.2–5.11 или CentOS 5.2–5.11 должны быть установлены компоненты служб интеграции Linux (LIS).
...
Debian 8; | 9.15 | С 3.16.0-4-amd64 по 3.16.0-5-amd64, с 4.9.0-0.bpo.4-amd64 по 4.9.0-0.bpo.5-amd64 |
