...
Требуется одна или несколько виртуальных машин, работающих на одном или нескольких изолированных или кластеризованных узлах Hyper-V. Можно также реплицировать виртуальные машины, запущенные на узлах под управлением System Center Virtual Machine Manager (VMM). Можно также реплицировать виртуальные машины, запущенные на узлах под управлением System Center Virtual Machine Manager (VMM).
