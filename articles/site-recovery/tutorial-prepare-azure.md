...
В этой статье показано, как подготовить компоненты Azure для репликации локальных виртуальных машин (Hyper-V или VMware) и физических серверов Windows или Linux в Azure. Из этого руководства вы узнаете, как выполнять такие задачи:
