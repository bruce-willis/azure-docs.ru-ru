...
6. Выберите компьютер, чтобы получить дополнительные сведения о нем. Сведения включают следующее. **Сведения о репликации**. Текущее состояние и работоспособность компьютера.
