...
Рекомендуется развернуть сервер конфигурации в виде высокодоступной виртуальной машины VMware. В следующей таблице представлены общие сведения о конфигурации сервера.

[!INCLUDE [site-recovery-configuration-server-requirements](../../includes/site-recovery-configuration-and-scaleout-process-server-requirements.md)]



### <a name="prepare-for-mysql-installation"></a>Подготовка к установке MySQL

MySQL устанавливается на сервере конфигурации. Это можно сделать с помощью одного из следующих методов:

- Разрешение на загрузку и установку Site Recovery при запуске мастера управления конфигурации сервера. Не требуется никаких конкретных действий.
- Загрузите вручную MySQL и поместите его в папку C:\Temp\ASRSetup. Запустите установку. При запуске мастера Site Recovery определит, что она установлена.
- Загрузите вручную MySQL и поместите его в папку C:\Temp\ASRSetup. При запуске мастер находит файл установки и устанавливает его из этого расположения. 
...
3. В разделе **Install third-party software** (Установка стороннего программного обеспечения) примите лицензионное соглашение. Установите MySQL в соответствии с [методом установки MySQL](#prepare-for-mysql-installation).
