...
> - Настройка репликации, включая политику репликации. Добавление сервера vCenter и обнаружение виртуальных машин. > - Добавление сервера vCenter и обнаружение. 
...
Узнайте, как автоматизировать другие задачи, из [справочника по командам PowerShell для Azure Site Recovery](https://docs.microsoft.com/powershell/module/AzureRM.RecoveryServices.SiteRecovery).
