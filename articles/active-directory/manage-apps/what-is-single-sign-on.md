...
* **Единый вход на основе пароля** позволяет безопасно хранить пароль приложений и воспроизводить его с помощью расширения веб-браузера или мобильного приложения. При едином входе на основе пароля используется 
*  процесс входа, предоставляемый приложением, но администраторы могут управлять паролями. Поэтому пользователю не нужно знать пароль.
