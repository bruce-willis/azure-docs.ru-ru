...
Дополнительные сведения о методах предварительной проверки подлинности см. в шаге 4 в [документе, посвященном публикации приложения](application-proxy-publish-azure-portal.md).
