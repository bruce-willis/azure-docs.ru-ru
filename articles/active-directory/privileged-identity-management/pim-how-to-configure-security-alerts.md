...
![Оповещения безопасности панели мониторинга PIM — снимок экрана](./media/pim-how-to-configure-security-alerts/PIM_security_dash.png)
...
2. Выберите **Управление привилегированными ролями** > **Параметры** > **Параметры оповещений**.
    ...
    ![Перейти к параметрам оповещений безопасности](./media/pim-how-to-configure-security-alerts/PIM_security_settings.png)
