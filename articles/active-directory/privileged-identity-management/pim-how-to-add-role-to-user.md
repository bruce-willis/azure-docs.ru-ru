...
В Azure AD, Office 365 и других службах и приложениях Майкрософт можно назначать пользователям организации различные административные роли.  Дополнительные сведения о доступных ролях можно найти в разделе, посвященном [ролям в Azure AD PIM](pim-roles.md).
...
> [!NOTE]
> Если компонент PIM еще не включен на портале Azure, см. статью [Приступая к работе с управлением привилегированными пользователями Azure AD](pim-getting-started.md).

Если требуется предоставить другому пользователю доступ к приложению PIM, требуемые роли пользователя описаны далее в статье о том, [как предоставить доступ к компоненту PIM](pim-how-to-give-access-to-pim.md).
...
Предоставив пользователям право на получение ролей, сообщите им, что они могут активировать их согласно инструкциям в статье [Как активировать и деактивировать роли в компоненте управления привилегированными пользователями Azure AD](pim-how-to-activate-role.md).
...
Если вам неизвестно, каким пользователям по-прежнему требуются назначенные им роли, можно [запустить проверку доступа для ролей](pim-how-to-start-security-review.md).
