...
![Корпоративные приложения](./media/howto-find-activity-reports/484.png "Корпоративные приложения")
...
![Параметры категории на странице фильтрации журналов аудита](./media/howto-find-activity-reports/06.png "Параметры категории на странице фильтрации журналов аудита")
...
Дополнительные сведения см. в статье [События риска Azure Active Directory](concept-risk-events.md).  
...
- [Отчет системы безопасности о пользователях под угрозой на портале Azure Active Directory](concept-user-at-risk.md)
...
![Отчет о входах в корпоративные приложения](./media/howto-find-activity-reports/199.png)
