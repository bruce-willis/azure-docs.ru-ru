...
На число записей, которые можно скачать, влияют особенности технической реализации, а также [политики хранения отчетов Azure Active Directory](reference-reports-data-retention.md).  
...
Дополнительные сведения о кодах ошибок входа в систему см. в статье [Коды ошибок отчета об активности входа на портале Azure Active Directory](reference-sign-ins-error-codes.md).
