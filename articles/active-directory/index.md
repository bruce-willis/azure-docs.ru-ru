            ...
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>Основы</h3>
                        <p>
                        <a href="/azure/active-directory/fundamentals/active-directory-whatis">Что такое Azure AD?</a><br/>
                        <a href="/azure/active-directory/fundamentals/understand-azure-identity-solutions">Решения для управления удостоверениями</a><br/>
                        <a href="/azure/active-directory/fundamentals/get-started-azure-ad">Начало работы</a><br/>
                        <a href="/azure/active-directory/fundamentals/whats-new">Новые возможности</a><br/>
                        <a href="/azure/active-directory/fundamentals/active-directory-deployment-plans">Планы развертывания Azure Active Directory</a>
                        </p>
                    </div>
                </div>
            </div>
    ...
    <li>
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3><a href="/azure/active-directory/users-groups-roles/index">Корпоративные пользователи</a></h3>
                        <p>
            ...
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        ...
                        <p>
                        <a href="/azure/active-directory/b2b/what-is-b2b">Категория "бизнес-бизнес" (B2B)</a><br/>
            ...
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        ...
                        <p>
                        <a href="/azure/active-directory/authentication/concept-sspr-howitworks">Пароли</a><br/>
                        <a href="/azure/active-directory/authentication/concept-mfa-howitworks">Многофакторная проверка подлинности</a><br/>
                        <a href="/azure/active-directory/active-directory-azureadjoin-passport">Windows Hello</a><br/>
                        <a href="/azure/active-directory/authentication/active-directory-certificate-based-authentication-get-started">Аутентификация на основе сертификата</a>
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        ...
                        <a href="/azure/active-directory/conditional-access/index">Условный доступ</a><br/>
                        <a href="/azure/active-directory/privileged-identity-management/pim-configure">Управление привилегированными пользователями</a>
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>Устройства</h3>
                        <p>
                        <a href="/azure/active-directory/devices/index">Управление устройствами</a><br/>
