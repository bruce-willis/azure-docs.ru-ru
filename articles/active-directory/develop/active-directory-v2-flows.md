...
Все типы маркеров и утверждений, доступных для приложения, описаны в [справочнике по маркерам версии 2.0](v2-id-and-access-tokens.md).
...
![Поток аутентификации веб-API](/media/v2-protocols-oidc/convergence_scenarios_webapi.png)
