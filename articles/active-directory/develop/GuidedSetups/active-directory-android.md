---
title: Начало работы с Android в Azure Active Directory версии 2 | Документация Майкрософт
description: Получение маркера доступа для приложения Android и вызов API Microsoft Graph или программных интерфейсов, которым требуется маркер доступа, из конечной точки Azure Active Directory версии 2.
