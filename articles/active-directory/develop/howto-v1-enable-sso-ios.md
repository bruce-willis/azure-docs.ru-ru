...
Читайте дальше, чтобы узнать, как мы используем эти брокеры и как они будут отображаться для пользователей при входе на платформу Microsoft Identity.
