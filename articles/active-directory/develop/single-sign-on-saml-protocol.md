...
![Рабочий процесс единого входа](./media/single-sign-on-saml-protocol/active-directory-saml-single-sign-on-workflow.png)
...
| Version (версия) | Обязательно | Этот параметр должен иметь значение **2.0**. |
