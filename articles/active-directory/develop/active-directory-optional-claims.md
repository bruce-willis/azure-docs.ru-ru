...
* Дополнительные сведения о стандартных утверждениях, предоставляемых Azure AD, см. в статье [Справочник по токенам в Azure AD](v1-id-and-access-tokens.md). 
