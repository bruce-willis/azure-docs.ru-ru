...
* [Объекты приложений](active-directory-application-objects.md#application-object). Объекты приложений можно считать определением приложения, хотя есть [исключения](#notes-and-exceptions).
