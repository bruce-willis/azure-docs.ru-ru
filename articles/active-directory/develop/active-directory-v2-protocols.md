...
* [Создание веб-приложений с использованием OpenID Connect](v2-protocols-oidc.md)
* [Создание одностраничных приложений с использованием неявного потока OAuth 2.0](v2-oauth2-implicit-grant-flow.md)
...
* [Azure Active Directory v2.0 and OAuth 2.0 On-Behalf-Of flow](v2-oauth2-on-behalf-of-flow.md) (Поток "От имени" Azure Active Directory версии 2.0 и OAuth 2.0)
