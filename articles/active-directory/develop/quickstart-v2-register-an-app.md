...
Чтобы создать приложение, которое поддерживает вход с помощью личных учетных записей Майкрософт (MSA) и рабочих или учебных учетных записей (Azure AD), сначала необходимо зарегистрировать приложение в корпорации Майкрософт. На данном этапе вы не сможете использовать любые существующие приложения с Azure AD или MSA, необходимо будет создать новое приложение.
...
Сначала перейдите на портал регистрации приложений Майкрософт: [https://apps.dev.microsoft.com/](https://apps.dev.microsoft.com/?referrer=https://azure.microsoft.com/documentation/articles&deeplink=/appList). 

Войти с помощью личной, рабочей или учебной учетной записи Майкрософт. Если у вас нет учетной записи, зарегистрируйтесь для получения личной учетной записи.
