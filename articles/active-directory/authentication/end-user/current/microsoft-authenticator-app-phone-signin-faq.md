...
Если у вас есть вопросы о приложении в целом, посетите страницу с [часто задаваемыми вопросами о приложении Microsoft Authenticator](../../../../multi-factor-authentication/end-user/microsoft-authenticator-app-faq.md).
