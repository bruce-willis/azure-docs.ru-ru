...
Узнайте, как [управлять параметрами двухфакторной проверки подлинности](../../../../multi-factor-authentication/end-user/multi-factor-authentication-end-user-manage-settings.md).

Узнайте, как [начать работу с приложением Microsoft Authenticator](../../../../multi-factor-authentication/end-user/microsoft-authenticator-app-how-to.md), чтобы вместо использоваться для входа уведомления вместо текстовых сообщений и звонков.
