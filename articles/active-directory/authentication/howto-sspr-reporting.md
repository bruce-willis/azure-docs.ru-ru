...
Если вы используете общедоступную предварительную версию службы конвергентной регистрации, то сведения об активности пользователей из журналов аудита будут указаны в категории **Методы проверки подлинности**.
