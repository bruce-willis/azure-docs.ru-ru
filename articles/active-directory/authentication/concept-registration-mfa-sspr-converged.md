---
title: Конвергентная регистрация методов SSPR и MFA в Azure AD
description: Регистрация методов Многофакторной идентификации Azure и самостоятельного сброса пароля Azure AD
...
ms.locfileid: "39415657"
---
# <a name="converged-registration-for-self-service-password-reset-and-azure-multi-factor-authentication"></a>Конвергентная регистрация методов самостоятельного сброса пароля и Многофакторной идентификации Azure
...
**Когда пользователь регистрирует телефон с помощью SMS, в качестве метода MFA по умолчанию устанавливается телефонный звонок**
   * Некоторые пользователи могут заметить, что для метода MFA по умолчанию после регистрации их номера телефона с помощью SMS устанавливается телефонный звонок. Пользователи могут разрешить эту проблему, изменив свой метод по умолчанию согласно следующим инструкциям. 
