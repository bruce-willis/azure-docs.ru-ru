...
Сведения о том, как добавить поддержку подготовки пользователей Azure AD в приложение, см. в разделе [Использование SCIM для автоматической подготовки пользователей и групп Azure Active Directory для приложений](manage-apps/use-scim-to-provision-users-and-groups.md).
