...
1. В поле поиска введите **SAP Cloud Platform**, выберите **SAP Cloud Platform** на панели результатов и нажмите кнопку **Добавить**, чтобы добавить это приложение.

    ![SAP Cloud Platform в списке результатов](./media/sap-hana-cloud-platform-tutorial/tutorial_sapcloudplatform_addfromgallery.png)
...
1. **[Создание тестового пользователя SAP Cloud Platform](#create-a-sap-cloud-platform-test-user)** нужно для того, чтобы в SAP Cloud Platform также существовал пользователь Britta Simon, связанный с одноименным пользователем в Azure AD.
...
1. В диалоговом окне **Единый вход** в разделе **Режим** выберите **Вход на основе SAML**, чтобы включить функцию единого входа.
    ...
    ![Диалоговое окно "Единый вход"](./media/sap-hana-cloud-platform-tutorial/tutorial_sapcloudplatform_samlbase.png)

1. В разделе **Домены и URL-адреса приложения SAP Cloud Platform** сделайте следующее.

    ![Сведения о домене и URL-адресах единого входа для приложения SAP Cloud Platform](./media/sap-hana-cloud-platform-tutorial/tutorial_sapcloudplatform_url.png)
...
1. В разделе **Сертификат подписи SAML** щелкните **Metadata XML** (Метаданные XML) и сохраните файл метаданных на компьютере.
    ...
    ![Ссылка для скачивания сертификата](./media/sap-hana-cloud-platform-tutorial/tutorial_sapcloudplatform_certificate.png) 

1. Нажмите кнопку **Сохранить** .

    ![Кнопка "Сохранить" в окне настройки единого входа](./media/sap-hana-cloud-platform-tutorial/tutorial_general_400.png)
...
1. Щелкните вкладку **Доверие** .
   
    ![Доверие](./media/sap-hana-cloud-platform-tutorial/ic790800.png "Доверие")

1. В разделе управления доверием на вкладке **Local Service Provider** (Поставщик локальных служб) выполните следующие действия:
...
1. После сохранения параметров на вкладке **Local Service Provider** (Поставщик локальных служб) выполните следующие действия, чтобы получить URL-адрес ответа:
...
1. Откройте вкладку **Trusted Identity Provider** (Доверенный поставщик удостоверений) и щелкните **Add Trusted Identity Provider** (Добавить доверенный поставщик удостоверений).
...
1. Откройте вкладку **General** (Общие) и нажмите кнопку **Browse** (Обзор), чтобы передать скачанный файл метаданных.
...
1. На вкладке **Атрибуты** сделайте следующее:
...
1. На портале Azure в области слева нажмите кнопку **Azure Active Directory**.
    ...
    ![Кнопка "Azure Active Directory"](./media/sap-hana-cloud-platform-tutorial/create_aaduser_01.png)

1. Чтобы открыть список пользователей, перейдите в раздел **Пользователи и группы** и щелкните **Все пользователи**.

    ![Ссылки "Пользователи и группы" и "Все пользователи"](./media/sap-hana-cloud-platform-tutorial/create_aaduser_02.png)

1. Чтобы открыть диалоговое окно **Пользователь**, в верхней части диалогового окна **Все пользователи** щелкните **Добавить**.

    ![Кнопка "Добавить"](./media/sap-hana-cloud-platform-tutorial/create_aaduser_03.png)

1. В диалоговом окне **Пользователь** сделайте следующее.

    ![Диалоговое окно "Пользователь"](./media/sap-hana-cloud-platform-tutorial/create_aaduser_04.png)
...
1. В списке приложений выберите **SAP Cloud Platform**.
    ...
    ![Ссылка на SAP Cloud Platform в списке приложений](./media/sap-hana-cloud-platform-tutorial/tutorial_sapcloudplatform_app.png)  
