...
1. В поле поиска введите **Fuze**.

    ![Создание тестового пользователя Azure AD](./media/fuze-tutorial/tutorial_fuze_000.png)

1. На панели результатов выберите **Fuze** и нажмите кнопку **Добавить**, чтобы добавить это приложение.

    ![Создание тестового пользователя Azure AD](./media/fuze-tutorial/tutorial_fuze_0001.png)
...
1. **[Создание тестового пользователя Fuze](#creating-a-fuze-test-user)** требуется для создания в Fuze пользователя Britta Simon, связанного с соответствующим пользователем в Azure AD.
...
1. В диалоговом окне **Единый вход** в разделе **Режим** выберите **Вход на основе SAML**, чтобы включить функцию единого входа.
    ...
    ![Настройка единого входа](./media/fuze-tutorial/tutorial_fuze_01.png)

1. В разделе **Домены и URL-адреса приложения Fuze** выполните следующие действия:

    ![Настройка единого входа](./media/fuze-tutorial/tutorial_fuze_020.png)
    
    В текстовом поле **URL-адрес для входа** введите следующий URL-адрес входа: `https://www.thinkingphones.com/jetspeed/portal/`

1.  Нажмите кнопку **Сохранить** .

    ![Настройка единого входа](./media/fuze-tutorial/tutorial_general_400.png)

1. В разделе **Сертификат подписи SAML** щелкните **XML метаданных** и сохраните XML-файл на компьютере.

    ![Настройка единого входа](./media/fuze-tutorial/tutorial_fuze_05.png) 

1. Чтобы настроить единый вход на стороне **Fuze**, отправьте в [службу поддержки Fuze](https://www.fuze.com/support) скачанный **XML-файл метаданных**. Это позволит службе поддержки Fuze правильно настроить подключение единого входа SAML на обоих сторонах.
...
1. На **портале управления Azure** в области навигации слева щелкните значок **Azure Active Directory**.
    ...
    ![Создание тестового пользователя Azure AD](./media/fuze-tutorial/create_aaduser_01.png) 

1. Перейдите в раздел **Пользователи и группы** и щелкните **Все пользователи**, чтобы отобразить список пользователей.
    
    ![Создание тестового пользователя Azure AD](./media/fuze-tutorial/create_aaduser_02.png) 

1. В верхней части диалогового окна щелкните **Добавить**, чтобы открыть диалоговое окно **Пользователь**.
 
    ![Создание тестового пользователя Azure AD](./media/fuze-tutorial/create_aaduser_03.png) 

1. На странице диалогового окна **Пользователь** выполните следующие действия.
 
    ![Создание тестового пользователя Azure AD](./media/fuze-tutorial/create_aaduser_04.png) 
...
1. В списке приложений выберите **Fuze**.

    ![Настройка единого входа](./media/fuze-tutorial/tutorial_fuze_50.png) 
