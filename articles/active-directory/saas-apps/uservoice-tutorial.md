...
1. В поле поиска введите **UserVoice**, выберите **UserVoice** на панели результатов и нажмите кнопку **Добавить**, чтобы добавить это приложение.

    ![UserVoice в списке результатов](./media/uservoice-tutorial/tutorial_uservoice_addfromgallery.png)
...
1. **[Создание тестового пользователя UserVoice](#create-a-uservoice-test-user)** требуется для того, чтобы в UserVoice существовал пользователь Britta Simon, связанный с одноименным пользователем в Azure AD.
...
1. В диалоговом окне **Единый вход** в разделе **Режим** выберите **Вход на основе SAML**, чтобы включить функцию единого входа.
    ...
    ![Диалоговое окно "Единый вход"](./media/uservoice-tutorial/tutorial_uservoice_samlbase.png)

1. В разделе **Домены и URL-адреса приложения UserVoice** выполните следующие действия:

    ![Сведения о домене и URL-адресах единого входа для приложения UserVoice](./media/uservoice-tutorial/tutorial_uservoice_url.png)
...
1. В разделе **Сертификат подписи SAML** скопируйте значение **Отпечаток**.
    ...
    ![Ссылка для скачивания сертификата](./media/uservoice-tutorial/tutorial_uservoice_certificate.png) 

1. Нажмите кнопку **Сохранить** .

    ![Кнопка "Сохранить" в окне настройки единого входа](./media/uservoice-tutorial/tutorial_general_400.png)

1. В разделе **Конфигурация UserVoice** щелкните **Настроить UserVoice**, чтобы открыть окно **Настройка единого входа**. Скопируйте **URL-адрес выхода и URL-адрес службы единого входа SAML** из раздела **Quick Reference** (Краткий справочник).

    ![Конфигурация UserVoice](./media/uservoice-tutorial/tutorial_uservoice_configure.png) 

1. В другом окне веб-браузера войдите на корпоративный сайт UserVoice с учетными данными администратора.

1. На панели инструментов в меню в верхней части экрана щелкните **Параметры**, а затем — **Веб-портал**.
   
    ![Раздел параметров на стороне приложения](./media/uservoice-tutorial/ic777519.png "Параметры")

1. На вкладке **Web portal** (Веб-портал) в разделе **User authentication** (Аутентификация пользователя) щелкните **Edit** (Изменить), чтобы открыть диалоговую страницу **Edit User Authentication** (Изменение аутентификации пользователя).
   
    ![Вкладка веб-портала](./media/uservoice-tutorial/ic777520.png "Веб-портал")

1. На странице **Изменение проверки подлинности пользователя** выполните следующие действия.
...
1. На портале Azure в области слева нажмите кнопку **Azure Active Directory**.
    ...
    ![Кнопка "Azure Active Directory"](./media/uservoice-tutorial/create_aaduser_01.png)

1. Чтобы открыть список пользователей, перейдите в раздел **Пользователи и группы** и щелкните **Все пользователи**.

    ![Ссылки "Пользователи и группы" и "Все пользователи"](./media/uservoice-tutorial/create_aaduser_02.png)

1. Чтобы открыть диалоговое окно **Пользователь**, в верхней части диалогового окна **Все пользователи** щелкните **Добавить**.

    ![Кнопка "Добавить"](./media/uservoice-tutorial/create_aaduser_03.png)

1. В диалоговом окне **Пользователь** сделайте следующее.

    ![Диалоговое окно "Пользователь"](./media/uservoice-tutorial/create_aaduser_04.png)
...
1. Выберите пункт **Общие**.

1. Выберите пункт **Агенты и разрешения**.
   
    ![Агенты и разрешения](./media/uservoice-tutorial/ic777812.png "Агенты и разрешения")

1. Нажмите кнопку **Добавить администраторов**.
   
    ![Добавление администраторов](./media/uservoice-tutorial/ic777813.png "Добавление администраторов")

1. В диалоговом окне **Пригласить администраторов** выполните следующие действия.
...
1. В списке приложений выберите **UserVoice**.

    ![Ссылка на UserVoice в списке "Приложения"](./media/uservoice-tutorial/tutorial_uservoice_app.png)  
