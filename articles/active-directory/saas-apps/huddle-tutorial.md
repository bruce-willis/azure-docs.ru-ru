...
1. В поле поиска введите **Huddle**.

    ![Создание тестового пользователя Azure AD](./media/huddle-tutorial/tutorial_huddle_search.png)

1. На панели результатов выберите **Huddle** и нажмите кнопку **Добавить**, чтобы добавить это приложение.
...
1. **[Создание тестового пользователя Huddle](#creating-a-huddle-test-user)** требуется для создания в Huddle пользователя Britta Simon, связанного с представлением этого же пользователя в Azure AD.
...
1. В диалоговом окне **Единый вход** в разделе **Режим** выберите **Вход на основе SAML**, чтобы включить функцию единого входа.
    ...
    ![Настройка единого входа](./media/huddle-tutorial/tutorial_huddle_samlbase.png)

1. В разделе **Домены и URL-адреса приложения Huddle** выполните следующие действия:

    ![Настройка единого входа](./media/huddle-tutorial/tutorial_huddle_url.png)
...
1. Нажмите кнопку **Сохранить** .
    ...
    ![Настройка единого входа](./media/huddle-tutorial/tutorial_general_400.png)

1. В разделе **Настройка Huddle** щелкните **Настроить Huddle**, чтобы открыть окно **Настройка единого входа**. Скопируйте **идентификатор сущности SAML и URL-адрес службы единого входа SAML** из раздела **Quick Reference** (Краткий справочник). 

    ![Настройка единого входа](./media/huddle-tutorial/tutorial_huddle_configure.png) 
    
1. Чтобы настроить единый вход на стороне Huddle, вам необходимо отправить скачанный файл **сертификата**, **URL-адрес службы единого входа SAML** и **идентификатор сущности SAML** в [службу поддержки клиентов Huddle](https://huddle.zendesk.com). Специалисты службы поддержки настроят подключение единого входа SAML на обеих сторонах.  
...
1. Чтобы открыть диалоговое окно **Пользователь**, в верхней части диалогового окна щелкните **Добавить**.
    ...
    ![Создание тестового пользователя Azure AD](./media/huddle-tutorial/create_aaduser_03.png) 

1. На странице диалогового окна **Пользователь** выполните следующие действия.
 
    ![Создание тестового пользователя Azure AD](./media/huddle-tutorial/create_aaduser_04.png) 
...
1. Нажмите **Рабочая область**.
1. Щелкните **People \> Invite People** (Пользователи > Пригласить пользователей).
   
   ![Люди](./media/huddle-tutorial/IC787838.png "Люди")

1. В разделе **Создание нового приглашения** выполните следующие действия.
...
1. В списке приложений выберите **Huddle**.
