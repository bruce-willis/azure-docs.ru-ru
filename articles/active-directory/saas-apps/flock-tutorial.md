...
3. **[Создание тестового пользователя приложения Flock](#create-a-flock-test-user)** требуется для того, чтобы во Flock существовал пользователь Britta Simon, связанный с одноименным пользователем в Azure AD.
...
3. В разделе **Домены и URL-адреса приложения Flock** выполните следующие действия:
    ...
    Б. В текстовом поле **Идентификатор** введите URL-адрес в следующем формате: `https://<subdomain>.flock.com/`
...
6. В разделе **Конфигурация Flock** щелкните **Настроить Flock**, чтобы открыть окно **Настройка единого входа**. Скопируйте **идентификатор сущности SAML и URL-адрес службы единого входа SAML** из раздела **Краткий справочник**.

    ![Конфигурация Flock](./media/flock-tutorial/tutorial_flock_configure.png) 

7. В другом окне веб-браузера войдите на свой корпоративный сайт Flock в качестве администратора.

8. Выберите вкладку **Authentication** (Аутентификация) в левой панели навигации и выберите **SAML Authentication** (Аутентификация SAML).
