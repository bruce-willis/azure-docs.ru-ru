...
1. В поле поиска введите **BambooHR**. В списке результатов выберите **BambooHR**, а затем щелкните **Добавить**.

    ![BambooHR в списке результатов](./media/bamboo-hr-tutorial/tutorial_bamboohr_addfromgallery.png)
...
1. В окне **единого входа** из раскрывающегося списка **Режим единого входа** выберите параметр **Вход на основе SAML**.
 
    ![Окно единого входа](./media/bamboo-hr-tutorial/tutorial_bamboohr_samlbase.png)

1. В разделе **Домены и URL-адреса приложения BambooHR** выполните следующие действия.

    ![Раздел "Домены и URL-адреса приложения BambooHR"](./media/bamboo-hr-tutorial/tutorial_bamboohr_url.png)
...
1. В разделе **Сертификат подписи SAML** щелкните **Сертификат (Base64)** и сохраните файл сертификата на компьютере.
    ...
    ![Ссылка для скачивания сертификата](./media/bamboo-hr-tutorial/tutorial_bamboohr_certificate.png) 

1. Щелкните **Сохранить**.

    ![Кнопка "Сохранить"](./media/bamboo-hr-tutorial/tutorial_general_400.png)

1. В разделе **Настройка BambooHR** выберите **Настроить BambooHR**, чтобы открыть окно **Настройка единого входа**. В разделе **Quick Reference** (Краткий справочник) скопируйте **URL-адрес службы единого входа SAML** для последующего использования.

    ![Настройка BambooHR](./media/bamboo-hr-tutorial/tutorial_bamboohr_configure.png) 

1. В новом окне войдите на свой корпоративный веб-сайт BambooHR в качестве администратора.

1. На домашней странице сделайте следующее.
...
1. На панели **SAML Single Sign-On** (Единый вход SAML) выполните следующие действия.
...
1. На портале Azure в области слева щелкните **Azure Active Directory**.
    ...
    ![Кнопка "Azure Active Directory"](./media/bamboo-hr-tutorial/create_aaduser_01.png)

1. Чтобы открыть список пользователей, перейдите в раздел **Пользователи и группы** и выберите **Все пользователи**.

    ![Ссылки "Пользователи и группы" и "Все пользователи"](./media/bamboo-hr-tutorial/create_aaduser_02.png)

1. В верхней части области **Все пользователи** выберите **Добавить**.

    ![Кнопка "Добавить"](./media/bamboo-hr-tutorial/create_aaduser_03.png)

1. В окне **Пользователь** сделайте следующее.

    ![Окно пользователя](./media/bamboo-hr-tutorial/create_aaduser_04.png)
...
1. Вверху панели инструментов выберите **Settings** (Параметры).
   
    ![Кнопка параметров](./media/bamboo-hr-tutorial/IC796694.png "Параметры")

1. Щелкните **Обзор**.

1. В области слева выберите **Security** (Безопасность) > **Users** (Пользователи).

1. Введите имя пользователя, пароль и адрес электронной почты действительной учетной записи Azure AD, которую необходимо настроить.
...
1. В списке **Корпоративные приложения** выберите **BambooHR**.

    ![Ссылка на BambooHR в списке "Корпоративные приложения"](./media/bamboo-hr-tutorial/tutorial_bamboohr_app.png)  

1. В области слева выберите **Пользователи и группы**.

    ![Ссылка "Пользователи и группы"][202]

1. Нажмите кнопку **Добавить**, затем в области **Добавление назначения** выберите **Пользователи и группы**.
...
1. В окне **Добавление назначения** нажмите кнопку **Назначить**.
