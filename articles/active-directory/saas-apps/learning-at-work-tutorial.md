...
3. В разделе **Домены и URL-адреса приложения Learning at Work** выполните следующие действия:
    ...
    Б. В текстовом поле **Идентификатор** введите URL-адрес в следующем формате: `https://<subdomain>.sabacloud.com/Saba/saml/SSO/alias/<company name>`
