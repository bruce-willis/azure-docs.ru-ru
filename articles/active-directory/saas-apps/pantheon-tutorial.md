...
1. В поле поиска введите **Pantheon**.

    ![Создание тестового пользователя Azure AD](./media/pantheon-tutorial/tutorial_pantheon_search.png)

1. На панели результатов выберите **Pantheon** и щелкните **Добавить**, чтобы добавить это приложение.

    ![Создание тестового пользователя Azure AD](./media/pantheon-tutorial/tutorial_pantheon_addfromgallery.png)
...
1. **[Создание тестового пользователя Pantheon](#creating-a-pantheon-test-user)** требуется для создания в Pantheon пользователя Britta Simon, связанного с представлением этого же пользователя в Azure AD.
...
1. В диалоговом окне **Единый вход** в разделе **Режим** выберите **Вход на основе SAML**, чтобы включить функцию единого входа.
    ...
    ![Настройка единого входа](./media/pantheon-tutorial/tutorial_pantheon_samlbase.png)

1. В разделе **Домены и URL-адреса приложения Pantheon** сделайте следующее:

    ![Настройка единого входа](./media/pantheon-tutorial/tutorial_pantheon_url.png)
...
1. Приложение Pantheon ожидает получить утверждение SAML в определенном формате. Для этого формата потребуется указать адрес электронной почты пользователя в качестве значения атрибута UserIdentifier. По умолчанию Azure AD использует для этого атрибута значение UserPrincipalName. Для успешной интеграции это значение следует изменить так, чтобы оно совпадало с адресом электронной почты пользователя. Интеграция будет работать только после выполнения правильного сопоставления.
    ...
    ![Настройка единого входа](./media/pantheon-tutorial/tutorial_attribute.png)    


1. В разделе **Сертификат подписи SAML** щелкните **Сертификат (Base64)**, а затем сохраните файл сертификата на компьютере.

    ![Настройка единого входа](./media/pantheon-tutorial/tutorial_pantheon_certificate.png)

1. Нажмите кнопку **Сохранить** .

    ![Настройка единого входа](./media/pantheon-tutorial/tutorial_general_400.png)

1. В разделе **Настройка Pantheon** выберите **Настроить Pantheon**, чтобы открыть окно **Настройка единого входа**. Скопируйте **URL-адрес службы единого входа SAML** из раздела **Краткий справочник**.

    ![Настройка единого входа](./media/pantheon-tutorial/tutorial_pantheon_configure.png) 

1. Чтобы настроить единый вход на стороне **Pantheon**, нужно отправить скачанный **сертификат** и **URL-адрес службы единого входа SAML** в [службу поддержки Pantheon](https://pantheon.io/docs/getting-support/).
...
1. На **портале Azure** в области навигации слева щелкните значок **Azure Active Directory**.
    ...
    ![Создание тестового пользователя Azure AD](./media/pantheon-tutorial/create_aaduser_01.png) 

1. Чтобы отобразить список пользователей, перейдите в раздел **Пользователи и группы** и щелкните **Все пользователи**.
    
    ![Создание тестового пользователя Azure AD](./media/pantheon-tutorial/create_aaduser_02.png) 

1. Чтобы открыть диалоговое окно **Пользователь**, в верхней части диалогового окна щелкните **Добавить**.
 
    ![Создание тестового пользователя Azure AD](./media/pantheon-tutorial/create_aaduser_03.png) 

1. На странице диалогового окна **Пользователь** выполните следующие действия.
 
    ![Создание тестового пользователя Azure AD](./media/pantheon-tutorial/create_aaduser_04.png) 
...
1. Перейдите на страницу **Organization** (Организация) панели мониторинга.
...
1. В списке приложений выберите **Pantheon**.
    ...
    ![Настройка единого входа](./media/pantheon-tutorial/tutorial_pantheon_app.png) 
