...
6. В разделе **Конфигурация Fluxx Labs** щелкните **Настроить Fluxx Labs**, чтобы открыть окно **Настройка единого входа**. Скопируйте **URL-адрес службы единого входа SAML** из раздела **Краткий справочник**.
...
10. В разделе атрибутов выполните следующие действия.
    ...
    f. В текстовое поле **URL-адрес единого входа для поставщика удостоверений** вставьте значение **URL-адреса службы единого входа SAML**, скопированное на портале Azure.
