...
11. Прокрутите эту страницу вниз до элемента **IDENTITY PROVIDER** (Поставщик удостоверений) в разделе **Single Sign-On** (Единый вход) и выполните следующие действия:
