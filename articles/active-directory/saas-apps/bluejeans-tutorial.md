...
1. В поле поиска введите **BlueJeans**.

    ![Создание тестового пользователя Azure AD](./media/bluejeans-tutorial/tutorial_bluejeans_search.png)

1. На панели результатов выберите **BlueJeans** и нажмите кнопку **Добавить**, чтобы добавить это приложение.
...
1. **[Создание тестового пользователя BlueJeans](#creating-a-bluejeans-test-user)** нужно для того, чтобы в BlueJeans также существовал пользователь Britta Simon, связанный с одноименным пользователем в Azure AD.
...
1. В разделе **Домены и URL-адреса приложения BlueJeans** выполните следующие действия.
...
1. В разделе **Настройка BlueJeans** щелкните **Настроить BlueJeans**, чтобы открыть окно **Настройка единого входа**. Скопируйте **URL-адрес выхода, URL-адрес изменения пароля и URL-адрес службы единого входа SAML** из раздела **Краткий справочник**.
...
1. Последовательно щелкните **Admin \> Group Settings \> Security** (Администратор > Параметры группы > Безопасность).
...
1. После этого выполните следующие действия.
...
1. Последовательно выберите пункты **Admin \> Manage Users \> Add User** (Администратор > Управление пользователями > Добавить пользователя).
...
1. Из списка приложений выберите **BlueJeans**.
