...
3. В разделе **Домены и URL-адреса приложения Autotask Endpoint Backup** выполните следующие действия:
    ...
    Б. В текстовом поле **URL-адрес ответа** введите URL-адрес в следующем формате: `https://<subdomain>.backup.autotask.net/singlesignon/saml/SSO`.
