...
10. В разделе **Единый вход** сделайте следующее:
    ...
    Б. Выберите для параметра **Identity provider type** (Тип поставщика удостоверений) значение **SAML 2.0**.
...
4. В разделе **Информация о пользователе** сделайте следующее:
    ...
    Б. Выберите параметр **Полномочия администратора** для учетной записи Azure AD, которую требуется подготовить.
