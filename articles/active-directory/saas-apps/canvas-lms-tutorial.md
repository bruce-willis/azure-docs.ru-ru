...
1. В поле поиска введите **Canvas**.

    ![Создание тестового пользователя Azure AD](./media/canvas-lms-tutorial/tutorial_canvaslms_search.png)

1. На панели результатов выберите **Canvas** и нажмите кнопку **Добавить**, чтобы добавить это приложение.

    ![Создание тестового пользователя Azure AD](./media/canvas-lms-tutorial/tutorial_canvaslms_addfromgallery.png)
...
1. **[Создание тестового пользователя Canvas](#creating-a-canvas-test-user)** нужно для того, чтобы в Canvas также существовал пользователь Britta Simon, связанный с одноименным пользователем в Azure AD.
...
1. В диалоговом окне **Единый вход** в разделе **Режим** выберите **Вход на основе SAML**, чтобы включить функцию единого входа.
    ...
    ![Настройка единого входа](./media/canvas-lms-tutorial/tutorial_canvaslms_samlbase.png)

1. В разделе **Домены и URL-адреса приложения Canvas** выполните следующие действия.

    ![Настройка единого входа](./media/canvas-lms-tutorial/tutorial_canvaslms_url.png)
...
1. В разделе **Сертификат подписи SAML** скопируйте значение **Отпечаток**.
    ...
    ![Настройка единого входа](./media/canvas-lms-tutorial/tutorial_canvaslms_certificate.png) 

1. Нажмите кнопку **Сохранить** .

    ![Настройка единого входа](./media/canvas-lms-tutorial/tutorial_general_400.png)

1. В разделе **Конфигурация Canvas** щелкните **Настроить Canvas**, чтобы открыть окно **Настройка единого входа**. Скопируйте **URL-адрес изменения пароля, URL-адрес выхода, идентификатор сущности SAML и URL-адрес службы единого входа SAML** из раздела **Краткий справочник**.

    ![Настройка единого входа](./media/canvas-lms-tutorial/tutorial_canvaslms_configure.png) 
 
1. В другом окне веб-браузера войдите на свой корпоративный веб-сайт Canvas в качестве администратора.

1. Выберите **Курсы \> Управляемые учетные записи \> Microsoft**.
   
    ![Canvas](./media/canvas-lms-tutorial/IC775990.png "Canvas")

1. На панели навигации слева выберите раздел **Проверка подлинности** и нажмите кнопку **Add New SAML Config** (Добавить новую конфигурацию SAML).
   
    ![Аутентификация](./media/canvas-lms-tutorial/IC775991.png "Аутентификация")

1. На странице "Текущая интеграция" выполните следующие действия.
...
1. На **портале Azure** в области навигации слева щелкните значок **Azure Active Directory**.
    ...
    ![Создание тестового пользователя Azure AD](./media/canvas-lms-tutorial/create_aaduser_01.png) 

1. Чтобы отобразить список пользователей, перейдите в раздел **Пользователи и группы** и щелкните **Все пользователи**.
    
    ![Создание тестового пользователя Azure AD](./media/canvas-lms-tutorial/create_aaduser_02.png) 

1. Чтобы открыть диалоговое окно **Пользователь**, в верхней части диалогового окна щелкните **Добавить**.
 
    ![Создание тестового пользователя Azure AD](./media/canvas-lms-tutorial/create_aaduser_03.png) 

1. На странице диалогового окна **Пользователь** выполните следующие действия.
 
    ![Создание тестового пользователя Azure AD](./media/canvas-lms-tutorial/create_aaduser_04.png) 
...
1. На странице диалогового окна "Добавление пользователя" выполните следующие действия.
...
1. Из списка приложений выберите **Canvas**.
    ...
    ![Настройка единого входа](./media/canvas-lms-tutorial/tutorial_canvaslms_app.png) 
