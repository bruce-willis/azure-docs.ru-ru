...
4. В поле поиска введите **Netsuite**.
    ...
    ![Создание тестового пользователя Azure AD](./media/netsuite-tutorial/tutorial_netsuite_search.png)

5. На панели результатов выберите **Netsuite** и нажмите кнопку **Добавить**, чтобы добавить это приложение.

    ![Создание тестового пользователя Azure AD](./media/netsuite-tutorial/tutorial_netsuite_addfromgallery.png)
...
11. На странице **Настройка SAML** выполните следующие действия.
    ...
    ![Настройка единого входа](./media/netsuite-tutorial/ns-sso-setup.png)
