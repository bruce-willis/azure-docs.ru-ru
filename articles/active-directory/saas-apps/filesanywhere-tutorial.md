...
1. В поле поиска введите **FilesAnywhere**.

    ![Создание тестового пользователя Azure AD](./media/filesanywhere-tutorial/tutorial_FilesAnywhere_search.png)

1. На панели результатов выберите **FilesAnywhere** и нажмите кнопку **Добавить**, чтобы добавить это приложение.

    ![Создание тестового пользователя Azure AD](./media/filesanywhere-tutorial/tutorial_FilesAnywhere_addfromgallery.png)
...
1. **[Создание тестового пользователя FilesAnywhere](#creating-a-filesanywhere-test-user)** требуется для создания в FilesAnywhere пользователя Britta Simon, связанного с соответствующим пользователем в Azure AD.
...
1. В диалоговом окне **Единый вход** в разделе **Режим** выберите **Вход на основе SAML**, чтобы включить функцию единого входа.
    ...
    ![Настройка единого входа](./media/filesanywhere-tutorial/tutorial_FilesAnywhere_samlbase.png)

1. Если вы хотите настроить приложение в **режиме, инициированном поставщиком удостоверений**, то в разделе **Домены и URL-адреса приложения FilesAnywhere** выполните следующие действия:

    ![Настройка единого входа](./media/filesanywhere-tutorial/tutorial_filesanywhere_url.png)
...
1. Если вы хотите настроить приложение в **режиме, инициированном поставщиком услуг**, то в разделе **Домены и URL-адреса приложения FilesAnywhere** выполните следующие действия:
    
    ![Настройка единого входа](./media/filesanywhere-tutorial/tutorial_filesanywhere_url1.png)
...
1. Приложение FilesAnywhere ожидает утверждения SAML в определенном формате. Настройте следующие утверждения для этого приложения. Управлять значениями этих атрибутов можно в разделе **Атрибуты пользователя** на странице интеграции приложения. На следующем снимке экрана приведен пример.
    
    ![Настройка единого входа](./media/filesanywhere-tutorial/tutorial_filesanywhere_attribute.png)
...
1. В разделе **Атрибуты пользователя** диалогового окна **Единый вход** настройте атрибут токена SAML, как показано на рисунке выше, и выполните следующие действия:
    ...
    ![Настройка единого входа](./media/filesanywhere-tutorial/tutorial_FilesAnywhere_04.png)
...
1. Нажмите кнопку **Сохранить** .
    ...
    ![Настройка единого входа](./media/filesanywhere-tutorial/tutorial_general_400.png)
...
1. В разделе **Сертификат для подписи токена SAML** щелкните **Certificate (Base64)** (Сертификат (Base64)), а затем сохраните файл сертификата на компьютере.
    ...
    ![Настройка единого входа](./media/filesanywhere-tutorial/tutorial_FilesAnywhere_certificate.png) 

1. В разделе **Конфигурация FilesAnywhere** щелкните **Настроить FilesAnywhere**, чтобы открыть окно **Настройка единого входа**.

    ![Настройка единого входа](./media/filesanywhere-tutorial/tutorial_FilesAnywhere_configure.png) 

    ![Настройка единого входа](./media/filesanywhere-tutorial/tutorial_FilesAnywhere_configuresignon.png)

1.  Чтобы настроить единый вход для своего приложения на стороне FilesAnywhere, обратитесь в [службу поддержки FilesAnywhere](mailto:support@FilesAnywhere.com) и предоставьте скачанный сертификат подписи токена SAML и URL-адрес единого входа (SSO).
...
1. На **портале управления Azure** в области навигации слева щелкните значок **Azure Active Directory**.
    ...
    ![Создание тестового пользователя Azure AD](./media/filesanywhere-tutorial/create_aaduser_01.png) 

1. Перейдите в раздел **Пользователи и группы** и щелкните **Все пользователи**, чтобы отобразить список пользователей.
    
    ![Создание тестового пользователя Azure AD](./media/filesanywhere-tutorial/create_aaduser_02.png) 

1. В верхней части диалогового окна щелкните **Добавить**, чтобы открыть диалоговое окно **Пользователь**.
 
    ![Создание тестового пользователя Azure AD](./media/filesanywhere-tutorial/create_aaduser_03.png) 

1. На странице диалогового окна **Пользователь** выполните следующие действия.
 
    ![Создание тестового пользователя Azure AD](./media/filesanywhere-tutorial/create_aaduser_04.png) 
...
1. В списке приложений выберите **FilesAnywhere**.

    ![Настройка единого входа](./media/filesanywhere-tutorial/tutorial_FilesAnywhere_app.png) 
