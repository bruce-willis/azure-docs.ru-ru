...
1. Если вы хотите настроить приложение в **режиме, инициированном поставщиком удостоверений**, то в разделе **Домены и URL-адреса приложения Cisco Cloud** выполните указанные ниже действия.
...
1. Чтобы настроить единый вход на стороне **Cisco Cloud**, отправьте скачанный **URL-адрес метаданных федерации приложений** в [группу поддержки Cisco Cloud](mailto:cpr-ops@cisco.com). Специалисты службы поддержки настроят подключение единого входа SAML на обеих сторонах.
