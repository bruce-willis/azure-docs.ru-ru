...
4. В поле поиска введите **AppDynamics**.
    ...
    ![Создание тестового пользователя Azure AD](./media/appdynamics-tutorial/tutorial_appdynamics_search.png)

5. На панели результатов выберите **AppDynamics** и нажмите кнопку **Добавить**, чтобы добавить это приложение.

    ![Создание тестового пользователя Azure AD](./media/appdynamics-tutorial/tutorial_appdynamics_addfromgallery.png)
...
2. В диалоговом окне **Единый вход** в разделе **Режим** выберите **Вход на основе SAML**, чтобы включить функцию единого входа.
    ...
    ![Настройка единого входа](./media/appdynamics-tutorial/tutorial_appdynamics_samlbase.png)
...
4. В разделе **Сертификат для подписи токена SAML** щелкните **Certificate (Base64)** (Сертификат (Base64)), а затем сохраните файл сертификата на компьютере.
    ...
    ![Настройка единого входа](./media/appdynamics-tutorial/tutorial_appdynamics_certificate.png) 

5. Нажмите кнопку **Сохранить** .

    ![Настройка единого входа](./media/appdynamics-tutorial/tutorial_general_400.png)

6. В разделе **Настройка AppDynamics** щелкните **Настроить AppDynamics**, чтобы открыть окно **Настройка единого входа**. Скопируйте **URL-адрес выхода и URL-адрес службы единого входа SAML** из раздела **Quick Reference** (Краткий справочник).

    ![Настройка единого входа](./media/appdynamics-tutorial/tutorial_appdynamics_configure.png) 
...
10. В разделе **Authentication Provider** (Поставщик проверки подлинности) выполните следующие действия.
    ...
    д. Выберите команду **Сохранить**.
     ...
     ![Сохранить](./media/appdynamics-tutorial/ic777673.png "Сохранить")
...
1. На **портале Azure** в области навигации слева щелкните значок **Azure Active Directory**.
    ...
    ![Создание тестового пользователя Azure AD](./media/appdynamics-tutorial/create_aaduser_01.png) 

2. Чтобы отобразить список пользователей, перейдите в раздел **Пользователи и группы** и щелкните **Все пользователи**.
    
    ![Создание тестового пользователя Azure AD](./media/appdynamics-tutorial/create_aaduser_02.png) 

3. Чтобы открыть диалоговое окно **Пользователь**, в верхней части диалогового окна щелкните **Добавить**.
 
    ![Создание тестового пользователя Azure AD](./media/appdynamics-tutorial/create_aaduser_03.png) 

4. На странице диалогового окна **Пользователь** выполните следующие действия.
 
    ![Создание тестового пользователя Azure AD](./media/appdynamics-tutorial/create_aaduser_04.png) 
...
2. Откройте раздел **Users** (Пользователи) и щелкните значок **+**, чтобы открыть диалоговое окно **Create User** (Создание пользователя).
    ...
    ![Пользователи](./media/appdynamics-tutorial/ic790229.png "Пользователи")

3. В разделе **Создание пользователя** выполните следующие действия.
   
    ![Создание пользователя](./media/appdynamics-tutorial/ic790230.png "Создание пользователя")
   
    a. Введите в текстовых полях **Username** (Имя пользователя), **Name** (Имя), **Email** (Адрес электронной почты), **New Password** (Новый пароль) и **Repeat New Password** (Введите новый пароль еще раз) соответствующие данные действующей учетной записи AAD, которую вы хотите подготовить.
...
2. Из списка приложений выберите **AppDynamics**.
    ...
    ![Настройка единого входа](./media/appdynamics-tutorial/tutorial_appdynamics_app.png) 
