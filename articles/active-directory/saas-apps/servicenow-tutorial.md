...
1. В поле поиска введите **ServiceNow**, на панели результатов выберите **ServiceNow** и нажмите кнопку **Добавить**, чтобы добавить это приложение.
...
1. **[Настройка единого входа Azure AD в ServiceNow Express](#configure-azure-ad-single-sign-on-for-servicenow-express)** необходима, чтобы пользователи могли использовать эту функцию.
1. **[Создание тестового пользователя Azure AD](#create-an-azure-ad-test-user)** требуется для проверки работы единого входа Azure AD от имени пользователя Britta Simon.
1. **[Создание тестового пользователя ServiceNow](#create-a-servicenow-test-user)** требуется для создания пользователя Britta Simon в ServiceNow, связанного с соответствующим пользователем в Azure AD.
...
1. В диалоговом окне **Единый вход** в разделе **Режим** выберите **Вход на основе SAML**, чтобы включить функцию единого входа.
    ...
    ![Диалоговое окно "Единый вход"](./media/servicenow-tutorial/tutorial_servicenow_samlbase.png)

1. В разделе **Домены и URL-адреса приложения ServiceNow** сделайте следующее.
...
1. Нажмите кнопку **Сохранить** .
    ...
    ![Кнопка "Сохранить" в окне настройки единого входа](./media/servicenow-tutorial/tutorial_general_400.png)
...
1. В левой области навигации найдите раздел **Multi-Provider SSO** (Единый вход с помощью нескольких поставщиков) с помощью панели поиска, затем щелкните **Properties** (Свойства).
...
1. В диалоговом окне **Multiple Provider SSO Properties** (Свойства единого входа для нескольких поставщиков) выполните следующие действия.
    ...
    b. Для параметра **Enable Auto Importing of users from all identity providers into the user table** (Включить автоматический импорт пользователей из всех поставщиков удостоверений в таблицу пользователей) выберите значение **Yes** (Да).
...
1. В левой области навигации найдите раздел **Multi-Provider SSO** (Единый вход с помощью нескольких поставщиков) с помощью панели поиска, затем щелкните **x509 Certificates** (Сертификаты x509).

    ![Настройка единого входа](./media/servicenow-tutorial/tutorial_servicenow_05.png "Настройка единого входа")

1. В диалоговом окне **X.509 Certificates** (Сертификаты X.509) нажмите кнопку **New** (Создать).

    ![Настройка единого входа](./media/servicenow-tutorial/ic7694974.png "Настройка единого входа")
...
1. В диалоговом окне SAML2 Update1 Properties (Свойства SAML2 Update1) выполните следующие действия.
    ...
    b. Введите **URL-адрес метаданных федерации приложений**, скопированный на портале Azure.

    c. Щелкните **Импорт**.

1. Будет прочитан URL-адрес метаданных поставщика удостоверений, а также будут заполнены все поля сведений.
    ...
    b. Скопируйте значение **ServiceNow Homepage** (Домашняя страница ServiceNow) и вставьте его в текстовое поле **URL-адрес для входа** в разделе **Домены и URL-адреса приложения ServiceNow** на портале Azure.
...
1. Щелкните значок меню для нового поставщика удостоверений, созданного в процессе настройки, и в предложенном списке выберите **copy sys_id** (копировать системный идентификатор).

    ![Настройка единого входа](./media/servicenow-tutorial/ic7694992.png "Настройка единого входа")

1. В поле поиска в верхней части окна слева выполните поиск по строке **sys_properties.list** и нажмите клавишу ВВОД.

    ![Настройка единого входа](./media/servicenow-tutorial/ic7694993.png "Настройка единого входа")

1. Нажмите кнопку **Создать**.

    ![Настройка единого входа](./media/servicenow-tutorial/ic7694994.png "Настройка единого входа")

1. В разделе **Системное свойство** выполните следующие действия:

    ![Настройка единого входа](./media/servicenow-tutorial/ic7694995.png "Настройка единого входа")

    a. Введите значение `glide.authenticate.sso.redirect.idp` в поле имени.

    b. В текстовое поле **Значение** вставьте значение sys_id, которое вы скопировали на предыдущем шаге.
...
1. В разделе **Системное свойство** выполните следующие действия:
    ...
    ![Настройка единого входа](./media/servicenow-tutorial/ic7694996.png "Настройка единого входа")

    a. Введите значение `glide.authenticate.multisso.test.connection.mandatory` в поле имени.

    b. В текстовое поле **Значение** введите **false**.

    c. Нажмите кнопку **Submit**(Отправить).

1. После этого вы сможете активировать новый поставщик удостоверений, чтобы включить единый вход.
...
1. В диалоговом окне **Единый вход** в разделе **Режим** выберите **Вход на основе SAML**, чтобы включить функцию единого входа.
    ...
    ![Настройка единого входа](./media/servicenow-tutorial/tutorial_servicenow_samlbase.png)
...
1. Нажмите кнопку **Сохранить** .
    ...
    ![Настройка единого входа](./media/servicenow-tutorial/tutorial_general_400.png)

1. Иначе говоря, для ServiceNow предоставляется служба настройки одним щелчком мыши, чтобы позволить Azure AD автоматически настроить ServiceNow для аутентификации на основе SAML. Чтобы включить эту службу, перейдите в раздел **Конфигурация ServiceNow** и щелкните **Настроить ServiceNow**, чтобы открыть окно "Настройка единого входа".

    ![Настройка единого входа](./media/servicenow-tutorial/tutorial_servicenow_configure.png)

1. Введите имя экземпляра ServiceNow, имя администратора и его пароль в форму **Настройка единого входа**, затем щелкните **Настроить сейчас**. Обратите внимание, что для этого указываемому пользователю с правами администратора должна быть назначена роль **security_admin** в ServiceNow. В противном случае, чтобы вручную настроить ServiceNow для использования Azure AD в качестве поставщика удостоверений SAML, щелкните **Настроить единый вход вручную** и скопируйте **URL-адрес выхода, идентификатор сущности SAML и URL-адрес службы единого входа SAML** из раздела "Краткий справочник".

    ![Настройка URL-адреса приложения](./media/servicenow-tutorial/configure.png "Настройка URL-адреса приложения")

1. Войдите в приложение ServiceNow Express в качестве администратора.

1. В расположенной слева области навигации щелкните **Единый вход**.

    ![Настройка URL-адреса приложения](./media/servicenow-tutorial/ic7694980ex.png "Настройка URL-адреса приложения")

1. В диалоговом окне **Единый вход** щелкните значок конфигурации в правом верхнем углу и настройте следующие свойства.
...
1. В диалоговом окне **Единый вход** щелкните **Добавить новый сертификат**.
...
1. В диалоговом окне **Единый вход** щелкните **Add New IdP** (Добавить нового поставщика удостоверений).

    ![Настройка единого входа](./media/servicenow-tutorial/ic7694976ex.png "Настройка единого входа")

1. В диалоговом окне **Add New Identity Provider** (Добавление нового поставщика удостоверений) в разделе **Configure Identity Provider** (Настройка поставщика удостоверений) выполните следующие действия.
...
1. В разделе **Additional Service Provider Properties** (Дополнительные свойства поставщика услуг) выполните следующие действия.
...
1. На портале Azure в области слева нажмите кнопку **Azure Active Directory**.
    ...
    ![Кнопка "Azure Active Directory"](./media/servicenow-tutorial/create_aaduser_01.png)

1. Чтобы открыть список пользователей, перейдите в раздел **Пользователи и группы** и щелкните **Все пользователи**.

    ![Ссылки "Пользователи и группы" и "Все пользователи"](./media/servicenow-tutorial/create_aaduser_02.png)

1. Чтобы открыть диалоговое окно **Пользователь**, в верхней части диалогового окна **Все пользователи** щелкните **Добавить**.

    ![Кнопка "Добавить"](./media/servicenow-tutorial/create_aaduser_03.png)

1. В диалоговом окне **Пользователь** сделайте следующее.

    ![Диалоговое окно "Пользователь"](./media/servicenow-tutorial/create_aaduser_04.png)
