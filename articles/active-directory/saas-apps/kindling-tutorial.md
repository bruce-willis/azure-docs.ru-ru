...
1. В поле поиска введите **Kindling**.

    ![Создание тестового пользователя Azure AD](./media/kindling-tutorial/tutorial_kindling_search.png)

1. На панели результатов выберите **Kindling** и нажмите кнопку **Добавить**, чтобы добавить приложение.
...
1. **[Создание тестового пользователя Kindling](#creating-a-kindling-test-user)** требуется для создания пользователя Britta Simon в Kindling, связанного с представлением этого пользователя в Azure AD.
...
1. В разделе **Домены и URL-адреса Kindling** выполните следующие действия:
...
1. В разделе **Настройка Kindling** щелкните **Настроить Kindling**, чтобы открыть окно **Настройка единого входа**. Скопируйте **URL-адрес выхода, идентификатор сущности SAML и URL-адрес службы единого входа SAML** из раздела **Краткий справочник**.

    ![Настройка единого входа](./media/kindling-tutorial/tutorial_kindling_configure.png) 

1. Чтобы настроить единый вход на стороне **Kindling**, нужно отправить скачанный **сертификат (Base64)**, **URL-адрес выхода, идентификатор сущности SAML и URL-адрес службы единого входа SAML** в [службу поддержки Kindling](mailto:support@kindlingapp.com).
...
1. В списке приложений выберите **Kindling**.
