...
1. В поле поиска введите **Optimizely**.

    ![Создание тестового пользователя Azure AD](./media/optimizely-tutorial/tutorial_optimizely_search.png)

1. На панели результатов выберите **Optimizely** и нажмите кнопку **Добавить**, чтобы добавить приложение.
...
1. **[Создание тестового пользователя Optimizely](#creating-an-optimizely-test-user)** требуется для создания в Optimizely пользователя Britta Simon, связанного с представлением этого же пользователя в Azure AD.
...
1. В разделе **Домен и URL-адреса приложения Optimizely** выполните следующие действия.
...
1. В разделе **Настройка Optimizely** щелкните **Настроить Optimizely**, чтобы открыть окно **Настройка единого входа**. Скопируйте **URL-адрес службы единого входа SAML** из раздела **Краткий справочник**.

    ![Настройка единого входа](./media/optimizely-tutorial/tutorial_optimizely_configure.png) 

1. Чтобы настроить единый вход на стороне приложения **Optimizely**, обратитесь к менеджеру по технической поддержке Optimizely и предоставьте скачанный **сертификат (Base64)** и **URL-адрес службы единого входа SAML**. 

1. В ответ на ваше электронное сообщение Optimizely предоставит URL-адрес входа (для единого входа, инициируемого поставщиком услуг) и идентификатор (идентификатор сущности поставщика службы).
...
1. В отдельном окне браузера войдите в приложение Optimizely.

1. Щелкните имя своей учетной записи в верхнем правом углу, затем щелкните **Account Settings**(Параметры учетной записи).
   
    ![единого входа Azure AD](./media/optimizely-tutorial/tutorial_optimizely_09.png)

1. На вкладке "Account" (Учетная запись) установите флажок **Enable SSO** (Включить единый вход) в области Single Sign On (Единый вход) раздела **Overview** (Общие сведения).
...
1. Чтобы добавить в проект нового сотрудника, щелкните **New Collaborator** (Создать сотрудника).
   
    ![Создание тестового пользователя Azure AD](./media/optimizely-tutorial/create_aaduser_10.png)

1. Введите электронный адрес и назначьте роль. Нажмите кнопку **Пригласить**.

    ![Создание тестового пользователя Azure AD](./media/optimizely-tutorial/create_aaduser_11.png)

1. Он получит приглашение по электронной почте. Этот электронный адрес будет использоваться для входа в приложение Optimizely.
...
1. Из списка приложений выберите **Optimizely**.
