...
4. В поле поиска введите **Dow Jones Factiva**.

    ![Создание тестового пользователя Azure AD](./media/dowjones-factiva-tutorial/tutorial_dowjonesfactiva_search.png)

5. На панели результатов выберите **Dow Jones Factiva** и нажмите кнопку **Добавить**, чтобы добавить приложение.
...
3. **[Создание тестового пользователя Dow Jones Factiva](#creating-a-dow-jones-factiva-test-user)** требуется для создания в Dow Jones Factiva пользователя Britta Simon, связанного с представлением этого же пользователя в Azure AD.
...
3. В разделе **Домены и URL-адреса приложения Dow Jones Factiva** не нужно выполнять никаких действий, так как приложение предварительно интегрировано с Azure.
...
6. Чтобы настроить единый вход на стороне **Dow Jones Factiva**, отправьте скачанный **XML-файл метаданных** в [службу поддержки Dow Jones Factiva](https://www.dowjones.com/contact/). Специалисты службы поддержки настроят подключение единого входа SAML на обеих сторонах.
