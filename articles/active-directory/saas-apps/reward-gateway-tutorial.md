...
4. В поле поиска введите **Reward Gateway**.

    ![Создание тестового пользователя Azure AD](./media/reward-gateway-tutorial/tutorial_rewardgateway_search.png)

5. На панели результатов выберите **Reward Gateway** и нажмите кнопку **Добавить**, чтобы добавить приложение.
...
3. В разделе **Домены и URL-адреса приложения Reward Gateway** сделайте следующее:
