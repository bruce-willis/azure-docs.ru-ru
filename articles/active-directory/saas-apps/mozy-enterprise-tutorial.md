...
1. В поле поиска введите **Mozy Enterprise**.

    ![Создание тестового пользователя Azure AD](./media/mozy-enterprise-tutorial/tutorial_mozyenterprise_search.png)

1. На панели результатов выберите **Mozy Enterprise** и щелкните **Добавить**, чтобы добавить приложение.

    ![Создание тестового пользователя Azure AD](./media/mozy-enterprise-tutorial/tutorial_mozyenterprise_addfromgallery.png)
...
1. **[Создание тестового пользователя Mozy Enterprise](#creating-a-mozy-enterprise-test-user)** требуется для создания пользователя Britta Simon в Mozy Enterprise, связанного с соответствующим пользователем в Azure AD.
...
1. В диалоговом окне **Единый вход** в разделе **Режим** выберите **Вход на основе SAML**, чтобы включить функцию единого входа.
    ...
    ![Настройка единого входа](./media/mozy-enterprise-tutorial/tutorial_mozyenterprise_samlbase.png)

1. В разделе **Домены и URL-адреса приложения Mozy Enterprise** выполните следующие действия:

    ![Настройка единого входа](./media/mozy-enterprise-tutorial/tutorial_mozyenterprise_url.png)
...
1. В разделе **Сертификат подписи SAML** щелкните **Сертификат (Base64)**, а затем сохраните файл сертификата на компьютере.
    ...
    ![Настройка единого входа](./media/mozy-enterprise-tutorial/tutorial_mozyenterprise_certificate.png) 

1. Нажмите кнопку **Сохранить** .

    ![Настройка единого входа](./media/mozy-enterprise-tutorial/tutorial_general_400.png)

1. В разделе **Настройка Mozy Enterprise** щелкните **Настроить Mozy Enterprise**, чтобы открыть окно **Настройка единого входа**. Скопируйте **идентификатор сущности SAML и URL-адрес службы единого входа SAML** из раздела **Краткий справочник**.

    ![Настройка единого входа](./media/mozy-enterprise-tutorial/tutorial_mozyenterprise_configure.png) 

1. В другом окне веб-браузера войдите на сайт Mozy Enterprise компании в качестве администратора.

1. В разделе **Конфигурация** щелкните **Политика проверки подлинности**.
   
   ![Политика аутентификации](./media/mozy-enterprise-tutorial/ic777314.png "Политика аутентификации")

1. В разделе **Политика проверки подлинности** сделайте следующее:
...
1. На **портале Azure** в области навигации слева щелкните значок **Azure Active Directory**.
    ...
    ![Создание тестового пользователя Azure AD](./media/mozy-enterprise-tutorial/create_aaduser_01.png) 

1. Чтобы отобразить список пользователей, перейдите в раздел **Пользователи и группы** и щелкните **Все пользователи**.
    
    ![Создание тестового пользователя Azure AD](./media/mozy-enterprise-tutorial/create_aaduser_02.png) 

1. Чтобы открыть диалоговое окно **Пользователь**, в верхней части диалогового окна щелкните **Добавить**.
 
    ![Создание тестового пользователя Azure AD](./media/mozy-enterprise-tutorial/create_aaduser_03.png) 

1. На странице диалогового окна **Пользователь** выполните следующие действия.
 
    ![Создание тестового пользователя Azure AD](./media/mozy-enterprise-tutorial/create_aaduser_04.png) 
...
1. Щелкните **Users** (Пользователи), а затем — **Add New User** (Добавить нового пользователя).
   
   ![Пользователи](./media/mozy-enterprise-tutorial/ic777317.png "Пользователи")
...
1. В списке приложений выберите **Mozy Enterprise**.

    ![Настройка единого входа](./media/mozy-enterprise-tutorial/tutorial_mozyenterprise_app.png) 
