...
1. В поле поиска введите **Dropbox for Business**, выберите **Dropbox for Business** на панели результатов и нажмите кнопку **Добавить**, чтобы добавить это приложение.
...
1. **[Создание тестового пользователя Dropbox for Business](#create-a-dropbox-for-business-test-user)** требуется для создания пользователя Britta Simon в Dropbox for Business, связанного с соответствующим пользователем в Azure AD.
...
1. В разделе **Домены и URL-адреса приложения Dropbox for Business** выполните указанные ниже действия.
...
1. В разделе **Настройка Dropbox for Business** щелкните **Настроить Dropbox for Business**, чтобы открыть окно **Настройка единого входа**. Скопируйте **URL-адрес службы единого входа SAML** из раздела **Краткий справочник**.

    ![Настройка Dropbox for Business](./media/dropboxforbusiness-tutorial/tutorial_dropboxforbusiness_configure.png) 

1. Чтобы настроить единый вход на стороне **Dropbox for Business**, перейдите к клиенту Dropbox for Business.
    ...
    ![Настройка единого входа](./media/dropboxforbusiness-tutorial/ic769510.png "Настройка единого входа")
   
    c. В **консоли администрирования** выберите пункт **Проверка подлинности** в левой области навигации. 
   
    ![Настройка единого входа](./media/dropboxforbusiness-tutorial/ic769511.png "Настройка единого входа")
    ...
    ![Настройка единого входа](./media/dropboxforbusiness-tutorial/ic769512.png "Настройка единого входа")
    ...
    ![Настройка единого входа](./media/dropboxforbusiness-tutorial/ic769513.png)
    
1. В разделе **Single sign-on** (Единый вход) на странице **Authentication** (Проверка подлинности) выполните следующие действия. 
   
    ![Настройка единого входа](./media/dropboxforbusiness-tutorial/IC769516.png "Настройка единого входа")
   
    a. Установите флажок **Обязательно**.
   
    b. В текстовое поле **URL-адрес входа** вставьте значение **URL-адрес службы единого входа SAML**, скопированное на портале Azure.
