...
3. В разделе **Домены и URL-адреса приложения SECURE DELIVER** выполните следующие действия.
    ...
    Б. В текстовом поле **Идентификатор** введите URL-адрес в следующем формате: `https://<companyname>.i-securedeliver.jp/sd/<tenantname>/postResponse`
