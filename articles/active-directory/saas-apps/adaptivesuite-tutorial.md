...
- Вы можете включить автоматический вход пользователей в Adaptive Insights (единый вход) с учетной записью Azure AD.
...
4. В поле поиска введите **Adaptive Insights**, выберите **Adaptive Insights** на панели результатов и нажмите кнопку **Добавить**, чтобы добавить это приложение.
    ...
    ![Создание тестового пользователя Azure AD](./media/adaptivesuite-tutorial/tutorial_adaptivesuite_addfromgallery.png)

##  <a name="configuring-and-testing-azure-ad-single-sign-on"></a>настройка и проверка единого входа в Azure AD.
В этом разделе описана настройка и проверка единого входа Azure AD в приложение Adaptive Insights с использованием тестового пользователя Britta Simon.
...
3. **[Создание тестового пользователя Adaptive Insights](#creating-an-adaptive-insights-test-user)** нужно для того, чтобы в Adaptive Insights также существовал пользователь Britta Simon, связанный с одноименным пользователем в Azure AD.
...
1. На портале Azure на странице интеграции с приложением **Adaptive Insights** щелкните **Единый вход**.

    ![Настройка единого входа][4]

2. В диалоговом окне **Единый вход** в разделе **Режим** выберите **Вход на основе SAML**, чтобы включить функцию единого входа.

    ![Настройка единого входа](./media/adaptivesuite-tutorial/tutorial_adaptivesuite_samlbase.png)

3. В разделе **Домены и URL-адреса приложения Adaptive Insights** сделайте следующее.

    ![Настройка единого входа](./media/adaptivesuite-tutorial/tutorial_adaptivesuite_url.png)
...
4. В разделе **Сертификат для подписи токена SAML** щелкните **Certificate (Base64)** (Сертификат (Base64)), а затем сохраните файл сертификата на компьютере.
    ...
    ![Настройка единого входа](./media/adaptivesuite-tutorial/tutorial_adaptivesuite_certificate.png)

5. Нажмите кнопку **Сохранить** .

    ![Настройка единого входа](./media/adaptivesuite-tutorial/tutorial_general_400.png)

6. В разделе **Настройка Adaptive Insights** щелкните **Настроить Adaptive Insights**, чтобы открыть окно **Настройка единого входа**. Скопируйте **идентификатор сущности SAML и URL-адрес службы единого входа SAML** из раздела **Quick Reference** (Краткий справочник).

    ![Настройка единого входа](./media/adaptivesuite-tutorial/tutorial_adaptivesuite_configure.png) 
...
1. На **портале Azure** в области навигации слева щелкните значок **Azure Active Directory**.
    ...
    ![Создание тестового пользователя Azure AD](./media/adaptivesuite-tutorial/create_aaduser_01.png) 

2. Чтобы отобразить список пользователей, перейдите в раздел **Пользователи и группы** и щелкните **Все пользователи**.

    ![Создание тестового пользователя Azure AD](./media/adaptivesuite-tutorial/create_aaduser_02.png) 

3. Чтобы открыть диалоговое окно **Пользователь**, в верхней части диалогового окна щелкните **Добавить**.

    ![Создание тестового пользователя Azure AD](./media/adaptivesuite-tutorial/create_aaduser_03.png) 

4. На странице диалогового окна **Пользователь** выполните следующие действия.

    ![Создание тестового пользователя Azure AD](./media/adaptivesuite-tutorial/create_aaduser_04.png)
...
### <a name="creating-an-adaptive-insights-test-user"></a>Создание тестового пользователя Adaptive Insights
...
**Чтобы назначить пользователя Britta Simon в Adaptive Insights, выполните следующие действия.**
...
2. Из списка приложений выберите **Adaptive Insights**.
    ...
    ![Настройка единого входа](./media/adaptivesuite-tutorial/tutorial_adaptivesuite_app.png)
