...
1. В поле поиска введите **Box** и выберите **Box** в списке результатов, затем щелкните **Добавить**.

    ![Box в списке результатов](./media/box-tutorial/tutorial_box_search.png)
...
1. В окне **Единый вход** в поле **Режим единого входа** выберите **Вход на основе SAML**.
    ...
    ![Окно "Единый вход"](./media/box-tutorial/tutorial_box_samlbase.png)

1. В разделе **Домены и URL-адреса приложения Box** выполните следующие действия.

    ![Сведения о домене и URL-адресах единого входа для приложения Box](./media/box-tutorial/url3.png)

    a. В поле **URL-адрес входа** введите URL-адрес в следующем формате: *https://\<поддомен>.box.com*.

    b. В текстовом поле **Идентификатор** введите адрес **box.net**.
...
1. В разделе **Сертификат подписи SAML** щелкните **XML метаданных** и сохраните файл метаданных на компьютере.
    ...
    ![Ссылка для скачивания сертификата](./media/box-tutorial/tutorial_box_certificate.png) 

1. Щелкните **Сохранить**.

    ![Кнопка "Сохранить" в окне настройки единого входа](./media/box-tutorial/tutorial_general_400.png)
    
1. Чтобы настроить единый вход для приложения, выполните процедуру из раздела [о самостоятельной настройке единого входа](https://community.box.com/t5/How-to-Guides-for-Admins/Setting-Up-Single-Sign-On-SSO-for-your-Enterprise/ta-p/1263#ssoonyourown).
...
1. На портале Azure в области слева щелкните **Azure Active Directory**.
    ...
    ![Ссылка на Azure Active Directory](./media/box-tutorial/create_aaduser_01.png)

1. Чтобы отобразить список активных пользователей, выберите **Пользователи и группы** > **Все пользователи**.

    ![Ссылки "Пользователи и группы" и "Все пользователи"](./media/box-tutorial/create_aaduser_02.png)

1. В верхней части окна **Все пользователи** выберите **Добавить**.

    ![Кнопка "Добавить"](./media/box-tutorial/create_aaduser_03.png)

    Откроется окно **Пользователь**.

1. В окне **Пользователь** сделайте следующее.

    ![Окно пользователя](./media/box-tutorial/create_aaduser_04.png)
...
1. В **списке приложений** выберите **Box**.
    ...
    ![Ссылка на Box](./media/box-tutorial/tutorial_box_app.png)  
