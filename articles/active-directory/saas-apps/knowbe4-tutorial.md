...
1. В поле поиска введите **KnowBe4 Security Awareness Training**, на панели результатов выберите **KnowBe4 Security Awareness Training** и нажмите кнопку **Добавить**, чтобы добавить это приложение.

    ![KnowBe4 Security Awareness Training в списке результатов](./media/knowbe4-tutorial/tutorial_knowbe4_addfromgallery.png)
...
1. **[Создание тестового пользователя KnowBe4 Security Awareness Training](#create-a-knowbe4-security-awareness-training-test-user)** требуется для создания пользователя Britta Simon в KnowBe4 Security Awareness Training, связанного с представлением этого же пользователя в Azure AD.
...
1. В диалоговом окне **Единый вход** в разделе **Режим** выберите **Вход на основе SAML**, чтобы включить функцию единого входа.
    ...
    ![Диалоговое окно "Единый вход"](./media/knowbe4-tutorial/tutorial_knowbe4_samlbase.png)

1. В разделе **KnowBe4 Security Awareness Training** выполните следующие действия:

    ![Сведения о домене и URL-адресах единого входа для приложения KnowBe4 Security Awareness Training](./media/knowbe4-tutorial/tutorial_knowbe4_url.png)
...
1. В разделе **Сертификат подписи SAML** щелкните **Certificate (Raw)** (Сертификат (необработанный)), а затем сохраните файл сертификата на компьютере.
    ...
    ![Ссылка для скачивания сертификата](./media/knowbe4-tutorial/tutorial_knowbe4_certificate.png) 

1. Нажмите кнопку **Сохранить** .

    ![Кнопка "Сохранить" в окне настройки единого входа](./media/knowbe4-tutorial/tutorial_general_400.png)

1. В разделе **Настройка KnowBe4 Security Awareness Training** щелкните **Настроить KnowBe4 Security Awareness Training**, чтобы открыть окно **Настройка единого входа**. Скопируйте **URL-адрес выхода, идентификатор сущности SAML и URL-адрес службы единого входа SAML** из раздела **Краткий справочник**.

    ![Настройка KnowBe4 Security Awareness Training](./media/knowbe4-tutorial/tutorial_knowbe4_configure.png) 

1. Чтобы настроить единый вход на стороне **KnowBe4 Security Awareness Training**, необходимо отправить скачанный **необработанный файл сертификата**, **URL-адрес выхода, идентификатор сущности SAML и URL-адрес службы единого входа** в [службу поддержки KnowBe4 Security Awareness Training](mailto:support@KnowBe4.com).
...
1. На портале Azure в области слева нажмите кнопку **Azure Active Directory**.
    ...
    ![Кнопка "Azure Active Directory"](./media/knowbe4-tutorial/create_aaduser_01.png)

1. Чтобы открыть список пользователей, перейдите в раздел **Пользователи и группы** и щелкните **Все пользователи**.

    ![Ссылки "Пользователи и группы" и "Все пользователи"](./media/knowbe4-tutorial/create_aaduser_02.png)

1. Чтобы открыть диалоговое окно **Пользователь**, в верхней части диалогового окна **Все пользователи** щелкните **Добавить**.

    ![Кнопка "Добавить"](./media/knowbe4-tutorial/create_aaduser_03.png)

1. В диалоговом окне **Пользователь** сделайте следующее.

    ![Диалоговое окно "Пользователь"](./media/knowbe4-tutorial/create_aaduser_04.png)
...
1. В списке приложений выберите **KnowBe4 Security Awareness Training**.

    ![Ссылка на KnowBe4 Security Awareness Training в списке приложений](./media/knowbe4-tutorial/tutorial_knowbe4_app.png)  
