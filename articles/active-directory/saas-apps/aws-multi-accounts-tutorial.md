...
1. Щелкните **IAM**. (Управление удостоверениями и доступом). 
...
1. В диалоговом окне **Attach Permissions Policies** (Привязка политик разрешений) щелкните **Next: Review** (Далее: проверка).  
...
1. Выполните шаги 9–17, чтобы создать несколько ролей, которые необходимо настроить для этой учетной записи. При наличии более двух учетных записей выполните те же шаги для всех учетных записей, чтобы создать для них роли.
