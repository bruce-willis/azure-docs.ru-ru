...
4. В поле поиска введите **Jostle**.
    ...
    ![Создание тестового пользователя Azure AD](./media/jostle-tutorial/tutorial_jostle_search.png)
...
3. В разделе **Домены и URL-адреса приложения Jostle** выполните следующие действия:
    ...
    ![Настройка единого входа](./media/jostle-tutorial/tutorial_jostle_url.png)

    a. В текстовом поле **URL-адрес для входа** введите URL-адрес в следующем формате: `https://<tanent name>.jostle.us/jostle-prod/`

    Б. В текстовом поле **Идентификатор** введите URL-адрес в следующем формате: `https://<tanent name>.jostle.us`
...
4. В разделе **Сертификат подписи SAML** щелкните **Metadata XML** (Метаданные XML) и сохраните файл метаданных на компьютере.
    ...
    ![Настройка единого входа](./media/jostle-tutorial/tutorial_jostle_certificate.png) 

5. Нажмите кнопку **Сохранить** .

    ![Настройка единого входа](./media/jostle-tutorial/tutorial_general_400.png)
