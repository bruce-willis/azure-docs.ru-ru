...
3. Нажмите **Добавить** в верхней части экрана.

    ![add_01](./media/jostle-tutorial/add_01.png)

4. В поле поиска в разделе **Добавить приложение** введите **Jostle**.
...
4. В разделе **Атрибуты пользователя** в поле **Идентификатор пользователя** введите `user.userprincipalname`

    ![url_02](./media/jostle-tutorial/url_02.png)

5. Щелкните **Сохранить** в верхней части окна.

6. Перейдите к **сертификату подписи SAML** и убедитесь, что для него установлено значение **Активно**. Затем нажмите кнопку **XML метаданных** и загрузите файл метаданных.
