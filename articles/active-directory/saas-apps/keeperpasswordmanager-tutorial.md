...
7. Чтобы настроить единый вход на стороне **Keeper Password Manager & Digital Vault**, выполните инструкции в [Руководстве по поддержке Keeper](https://keepersecurity.com/assets/pdf/KeeperSSOConnect_v11.pdf).
