...
1. В поле поиска введите **RFPIO**.

    ![Создание тестового пользователя Azure AD](./media/rfpio-tutorial/tutorial_rfpio_search.png)

1. На панели результатов выберите **RFPIO** и нажмите кнопку **Добавить**, чтобы добавить приложение.

    ![Создание тестового пользователя Azure AD](./media/rfpio-tutorial/tutorial_rfpio_addfromgallery.png)
...
1. **[Создание тестового пользователя RFPIO](#creating-a-rfpio-test-user)** требуется для создания в RFPIO пользователя Britta Simon, связанного с соответствующим пользователем в Azure AD.
...
1. В диалоговом окне **Единый вход** в разделе **Режим** выберите **Вход на основе SAML**, чтобы включить функцию единого входа.
    ...
    ![Настройка единого входа](./media/rfpio-tutorial/tutorial_rfpio_samlbase.png)

1. Если вы хотите настроить приложение в **режиме, инициированном поставщиком удостоверений**, то в разделе **Домены и URL-адреса приложения RFPIO** выполните следующие действия:

    ![Настройка единого входа](./media/rfpio-tutorial/tutorial_rfpio_url.png)
...
1. Установите флажок **Показать дополнительные параметры URL-адресов**, если хотите настроить приложение для работы в режиме, инициируемом **поставщиком услуг**. 
    ...
    ![Настройка единого входа](./media/rfpio-tutorial/tutorial_rfpio_url2.png)

    В текстовом поле **URL-адрес для входа** введите URL-адрес: `https://www.app.rfpio.com`

1. В разделе **Сертификат подписи SAML** щелкните **Metadata XML** (Метаданные XML) и сохраните файл метаданных на компьютере.

    ![Настройка единого входа](./media/rfpio-tutorial/tutorial_rfpio_certificate.png) 

1. Нажмите кнопку **Сохранить** .

    ![Настройка единого входа](./media/rfpio-tutorial/tutorial_general_400.png)

1. В другом окне веб-браузера войдите на веб-сайт **RFPIO** в качестве администратора.

1. Щелкните раскрывающийся список в нижнем левом углу.

    ![Настройка единого входа](./media/rfpio-tutorial/app1.png)

1. Щелкните **Organization Settings** (Параметры организации). 

    ![Настройка единого входа](./media/rfpio-tutorial/app2.png)

1. Щелкните **FEATURES & INTEGRATION** (Функции и интеграция).

    ![Настройка единого входа](./media/rfpio-tutorial/app4.png)

1. В окне **SAML SSO Configuration** (Конфигурация единого входа SAML) щелкните **Edit** (Изменить).

    ![Настройка единого входа](./media/rfpio-tutorial/app3.png)

1. В этом разделе выполните следующие действия.
...
1. На **портале Azure** в области навигации слева щелкните значок **Azure Active Directory**.
    ...
    ![Создание тестового пользователя Azure AD](./media/rfpio-tutorial/create_aaduser_01.png) 

1. Чтобы отобразить список пользователей, перейдите в раздел **Пользователи и группы** и щелкните **Все пользователи**.
    
    ![Создание тестового пользователя Azure AD](./media/rfpio-tutorial/create_aaduser_02.png) 

1. Чтобы открыть диалоговое окно **Пользователь**, в верхней части диалогового окна щелкните **Добавить**.
 
    ![Создание тестового пользователя Azure AD](./media/rfpio-tutorial/create_aaduser_03.png) 

1. На странице диалогового окна **Пользователь** выполните следующие действия.
 
    ![Создание тестового пользователя Azure AD](./media/rfpio-tutorial/create_aaduser_04.png) 
...
1. Щелкните **TEAM MEMBERS** (Участники команды).

    ![Настройка единого входа](./media/rfpio-tutorial/app6.png)

1. Щелкните **ADD MEMBERS** (Добавить участников).

    ![Настройка единого входа](./media/rfpio-tutorial/app7.png)

1. В разделе **Add New Members** (Добавление новых участников) выполните следующие действия.
...
1. В списке приложений выберите **RFPIO**.

    ![Настройка единого входа](./media/rfpio-tutorial/tutorial_rfpio_app.png) 
