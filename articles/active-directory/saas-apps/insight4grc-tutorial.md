...
1. Если вы хотите настроить приложение в режиме, инициированном **поставщиком удостоверений**, в разделе **Домены и URL-адреса приложения Insight4GRC** выполните следующие действия.
...
1. Для настройки единого входа на стороне **Insight4GRC** необходимо отправить скопированный **URL-адрес метаданных федерации приложений** в [службу поддержки Insight4GRC](mailto:support.ss@rsmuk.com). Специалисты службы поддержки настроят подключение единого входа SAML на обеих сторонах.
...
1. В списке приложений выберите **Insight4GRC**.
