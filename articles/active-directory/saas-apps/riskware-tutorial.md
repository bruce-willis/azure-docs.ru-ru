...
3. **[Создание тестового пользователя приложения Riskware](#create-a-riskware-test-user)** требуется для того, чтобы в Riskware существовал пользователь Britta Simon, связанный с одноименным пользователем в Azure AD.
...
3. В разделе **Домены и URL-адреса приложения Riskware** выполните следующие действия:
...
6. В разделе **Настройка Riskware** щелкните **Настроить Riskware**, чтобы открыть окно **Настройка единого входа**. Скопируйте **URL-адрес выхода и URL-адрес службы единого входа SAML** из раздела **Краткий справочник**.

    ![Настройка Riskware](./media/riskware-tutorial/tutorial_riskware_configure.png)

7. В другом окне веб-браузера войдите на корпоративный сайт Riskware в качестве администратора.

8. В правом верхнем углу щелкните **Maintenance** (Обслуживание), чтобы открыть страницу обслуживания.

    ![Настройка Riskware, раздел "Обслуживание"](./media/riskware-tutorial/tutorial_riskware_maintain.png)

9. На странице обслуживания щелкните **Authentication** (Аутентификация).

    ![Настройка Riskware, аутентификация](./media/riskware-tutorial/tutorial_riskware_authen.png)

10. На странице **Authentication Configuration** (Настройка аутентификации) выполните следующие действия:
    ...
    f. В текстовое поле **Post Form Field** (Поле формы POST) введите имя поля из ответа POST, которое содержит значение SAML, например SAMLResponse.
...
2. В правом верхнем углу щелкните **Maintenance** (Обслуживание), чтобы открыть страницу обслуживания. 

    ![Настройка Riskware, обслуживание](./media/riskware-tutorial/tutorial_riskware_maintain.png)

3. На странице обслуживания щелкните **People** (Пользователи).

    ![Настройка Riskware, пользователи](./media/riskware-tutorial/tutorial_riskware_people.png)

4. На вкладке **Details** (Подробные сведения) сделайте следующее:
...
6. На вкладке **Organisation** (Организация) сделайте следующее:
