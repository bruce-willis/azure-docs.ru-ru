...
1. В поле поиска введите **Veracode**, выберите **Veracode** на панели результатов и нажмите кнопку **Добавить**, чтобы добавить это приложение.

    ![Veracode в списке результатов](./media/veracode-tutorial/tutorial_veracode_addfromgallery.png)
...
1. **[Создание тестового пользователя Veracode](#create-a-veracode-test-user)** требуется для того, чтобы в Veracode существовал пользователь Britta Simon, связанный с одноименным пользователем в Azure AD.
...
1. В диалоговом окне **Единый вход** в разделе **Режим** выберите **Вход на основе SAML**, чтобы включить функцию единого входа.
    ...
    ![Диалоговое окно "Единый вход"](./media/veracode-tutorial/tutorial_veracode_samlbase.png)

1. В разделе **Домен и URL-адреса единого входа в Veracode** не нужно выполнять никаких действий, так как приложение уже предварительно интегрировано с Azure. 

    ![Настройка единого входа](./media/veracode-tutorial/tutorial_veracode_url.png)
...
1. В разделе **Сертификат для подписи токена SAML** щелкните **Certificate (Base64)** (Сертификат (Base64)), а затем сохраните файл сертификата на компьютере.
    ...
    ![Ссылка для скачивания сертификата](./media/veracode-tutorial/tutorial_veracode_certificate.png) 

1. В этом разделе показано, как разрешить пользователям проходить проверку подлинности в Veracode с помощью своей учетной записи Azure AD, используя федерацию на основе протокола SAML.
    ...
    ![Атрибуты](./media/veracode-tutorial/tutorial_veracode_attr.png "Атрибуты")
...
1. Чтобы добавить обязательные сопоставления атрибутов, выполните следующие действия.
    ...
    ![Атрибуты](./media/veracode-tutorial/tutorial_veracode_addattr.png "Атрибуты")
...
1. Нажмите кнопку **Сохранить** .
    ...
    ![Кнопка "Сохранить" в окне настройки единого входа](./media/veracode-tutorial/tutorial_general_400.png)

1. В разделе **Конфигурация Veracode** щелкните **Настроить Veracode**, чтобы открыть окно **Настройка единого входа**. Скопируйте значение **SAML Entity ID** (Идентификатор сущности SAML) из раздела **Краткий справочник**.

    ![Конфигурация Veracode](./media/veracode-tutorial/tutorial_veracode_configure.png) 

1. В другом окне веб-браузера войдите на веб-сайт Veracode вашей компании в качестве администратора.

1. В верхнем меню нажмите **Settings** (Параметры), а затем выберите **Admin** (Администратор).
   
    ![Администрирование](./media/veracode-tutorial/ic802911.png "Администрирование")

1. Щелкните вкладку **SAML** .
...
1. На портале Azure в области слева нажмите кнопку **Azure Active Directory**.
    ...
    ![Кнопка "Azure Active Directory"](./media/veracode-tutorial/create_aaduser_01.png)

1. Чтобы открыть список пользователей, перейдите в раздел **Пользователи и группы** и щелкните **Все пользователи**.

    ![Ссылки "Пользователи и группы" и "Все пользователи"](./media/veracode-tutorial/create_aaduser_02.png)

1. Чтобы открыть диалоговое окно **Пользователь**, в верхней части диалогового окна **Все пользователи** щелкните **Добавить**.

    ![Кнопка "Добавить"](./media/veracode-tutorial/create_aaduser_03.png)

1. В диалоговом окне **Пользователь** сделайте следующее.

    ![Диалоговое окно "Пользователь"](./media/veracode-tutorial/create_aaduser_04.png)
...
1. В списке приложений выберите **Veracode**.
    ...
    ![Ссылка на Veracode в списке "Приложения"](./media/veracode-tutorial/tutorial_veracode_app.png)  
