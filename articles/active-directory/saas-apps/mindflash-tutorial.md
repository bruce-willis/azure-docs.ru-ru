...
1. В поле поиска введите **Mindflash**.

    ![Создание тестового пользователя Azure AD](./media/mindflash-tutorial/tutorial_mindflash_search.png)

1. На панели результатов выберите **Mindflash** и нажмите кнопку **Добавить**, чтобы добавить приложение.

    ![Создание тестового пользователя Azure AD](./media/mindflash-tutorial/tutorial_mindflash_addfromgallery.png)
...
1. **[Создание тестового пользователя Mindflash](#creating-a-mindflash-test-user)** требуется для создания в Mindflash пользователя Britta Simon, связанного с представлением этого пользователя в Azure AD.
...
1. В диалоговом окне **Единый вход** в разделе **Режим** выберите **Вход на основе SAML**, чтобы включить функцию единого входа.
    ...
    ![Настройка единого входа](./media/mindflash-tutorial/tutorial_mindflash_samlbase.png)

1. В разделе **Домены и URL-адреса приложения Mindflash** выполните следующие действия:

    ![Настройка единого входа](./media/mindflash-tutorial/tutorial_mindflash_url.png)
...
1. В разделе **Сертификат подписи SAML** щелкните **Metadata XML** (Метаданные XML) и сохраните файл метаданных на компьютере.
    ...
    ![Настройка единого входа](./media/mindflash-tutorial/tutorial_mindflash_certificate.png) 

1. Нажмите кнопку **Сохранить** .

    ![Настройка единого входа](./media/mindflash-tutorial/tutorial_general_400.png)
...
1. На **портале Azure** в области навигации слева щелкните значок **Azure Active Directory**.
    ...
    ![Создание тестового пользователя Azure AD](./media/mindflash-tutorial/create_aaduser_01.png) 

1. Чтобы отобразить список пользователей, перейдите в раздел **Пользователи и группы** и щелкните **Все пользователи**.
    
    ![Создание тестового пользователя Azure AD](./media/mindflash-tutorial/create_aaduser_02.png) 

1. Чтобы открыть диалоговое окно **Пользователь**, в верхней части диалогового окна щелкните **Добавить**.
 
    ![Создание тестового пользователя Azure AD](./media/mindflash-tutorial/create_aaduser_03.png) 

1. На странице диалогового окна **Пользователь** выполните следующие действия.
 
    ![Создание тестового пользователя Azure AD](./media/mindflash-tutorial/create_aaduser_04.png) 
...
1. Перейдите в раздел **Управление пользователями**.
    ...
    ![Управление пользователями](./media/mindflash-tutorial/ic787140.png "Управление пользователями")

1. Нажмите кнопку **Add Users** (Добавить пользователей), а затем выберите **New** (Создать).

1. В разделе **Add New Users** (Добавление новых пользователей) введите соответствующие данные действующей учетной записи Azure AD, которую необходимо подготовить.
   
    ![Add New Users](./media/mindflash-tutorial/ic787141.png "Add New Users") (Добавление новых пользователей)
...
1. В списке приложений выберите **Mindflash**.

    ![Настройка единого входа](./media/mindflash-tutorial/tutorial_mindflash_app.png) 
