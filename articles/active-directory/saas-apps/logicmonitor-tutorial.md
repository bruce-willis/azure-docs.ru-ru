...
1. В поле поиска введите **LogicMonitor**.

    ![Создание тестового пользователя Azure AD](./media/logicmonitor-tutorial/tutorial_logicmonitor_search.png)

1. На панели результатов выберите **LogicMonitor**, а затем нажмите кнопку **Добавить**, чтобы добавить приложение.

    ![Создание тестового пользователя Azure AD](./media/logicmonitor-tutorial/tutorial_logicmonitor_addfromgallery.png)
...
1. **[Создание тестового пользователя LogicMonitor](#creating-a-logicmonitor-test-user)** требуется для создания в LogicMonitor пользователя Britta Simon, связанного с представлением этого пользователя в Azure AD.
...
1. В диалоговом окне **Единый вход** в разделе **Режим** выберите **Вход на основе SAML**, чтобы включить функцию единого входа.
    ...
    ![Настройка единого входа](./media/logicmonitor-tutorial/tutorial_logicmonitor_samlbase.png)

1. В разделе **Домен и URL-адреса приложения LogicMonitor** выполните следующие действия.

    ![Настройка единого входа](./media/logicmonitor-tutorial/tutorial_logicmonitor_url.png)

    a. В текстовом поле **URL-адрес для входа** введите URL-адрес в следующем формате: `https://<companyname>.logicmonitor.com`

    b. В текстовом поле **Идентификатор** введите URL-адрес в следующем формате: `https://<companyname>.logicmonitor.com`
...
1. В разделе **Сертификат подписи SAML** щелкните **Metadata XML** (Метаданные XML) и сохраните файл метаданных на компьютере.
    ...
    ![Настройка единого входа](./media/logicmonitor-tutorial/tutorial_logicmonitor_certificate.png) 

1. Нажмите кнопку **Сохранить** .

    ![Настройка единого входа](./media/logicmonitor-tutorial/tutorial_general_400.png)
...
1. В расположенной слева области навигации нажмите **Единый вход**
   
    ![Единый вход](./media/logicmonitor-tutorial/ic790053.png "Единый вход")

1. В разделе **Параметры единого входа** выполните следующие действия.
...
1. На **портале Azure** в области навигации слева щелкните значок **Azure Active Directory**.
    ...
    ![Создание тестового пользователя Azure AD](./media/logicmonitor-tutorial/create_aaduser_01.png) 

1. Чтобы отобразить список пользователей, перейдите в раздел **Пользователи и группы** и щелкните **Все пользователи**.
    
    ![Создание тестового пользователя Azure AD](./media/logicmonitor-tutorial/create_aaduser_02.png) 

1. Чтобы открыть диалоговое окно **Пользователь**, в верхней части диалогового окна щелкните **Добавить**.
 
    ![Создание тестового пользователя Azure AD](./media/logicmonitor-tutorial/create_aaduser_03.png) 

1. На странице диалогового окна **Пользователь** выполните следующие действия.
 
    ![Создание тестового пользователя Azure AD](./media/logicmonitor-tutorial/create_aaduser_04.png) 
...
1. В меню вверху щелкните **Settings** (Параметры), а затем выберите **Roles and Users** (Роли и пользователи).
   
    ![Roles and Users](./media/logicmonitor-tutorial/ic790056.png "Roles and Users") (Роли и пользователи)

1. Щелкните **Добавить**.

1. В разделе **Добавить учетную запись** выполните следующие действия.
...
1. В списке приложений выберите **LogicMonitor**.
    ...
    ![Настройка единого входа](./media/logicmonitor-tutorial/tutorial_logicmonitor_app.png) 
