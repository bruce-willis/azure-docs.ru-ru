...
3. **[Создание тестового пользователя Sedgwick CMS](#create-a-sedgwick-cms-test-user)** требуется для того, чтобы в Sedgwick CMS существовал пользователь Britta Simon, связанный с одноименным пользователем в Azure AD.
...
3. В разделе **Домены и URL-адреса приложения Sedgwick CMS** выполните следующие действия.
...
6. Чтобы настроить единый вход на стороне **Sedgwick CMS**, отправьте [группе поддержки Sedgwick CMS](https://www.sedgwick.com/contact/Pages/contactform.aspx) скачанный **XML-файл метаданных**. Специалисты службы поддержки настроят подключение единого входа SAML на обеих сторонах.
