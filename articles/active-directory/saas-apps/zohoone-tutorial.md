...
3. Если вы хотите настроить приложение в режиме, инициированном **поставщиком удостоверений**, в разделе **Домены и URL-адреса приложения Zoho One** сделайте следующее:
    ...
    Б. В текстовом поле **URL-адрес ответа** введите URL-адрес в следующем формате: `https://accounts.zoho.com/samlresponse/<saml-identifier>`.
...
10. В открывшемся окне сделайте следующее:
    ...
    Б. В текстовое поле **Sign-out URL** (URL-адрес выхода) вставьте **URL-адрес выхода**, скопированный на портале Microsoft Azure.
