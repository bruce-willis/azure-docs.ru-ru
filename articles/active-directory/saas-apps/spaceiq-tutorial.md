...
1. В поле поиска введите **SpaceIQ**, выберите **SpaceIQ** на панели результатов и нажмите кнопку **Добавить**, чтобы добавить это приложение.

    ![SpaceIQ в списке результатов](./media/spaceiq-tutorial/tutorial_spaceiq_addfromgallery.png)
...
1. **[Создание тестового пользователя приложения SpaceIQ](#create-a-spaceiq-test-user)** требуется для того, чтобы в SpaceIQ существовал пользователь Britta Simon, связанный с одноименным пользователем в Azure AD.
...
1. В диалоговом окне **Единый вход** в разделе **Режим** выберите **Вход на основе SAML**, чтобы включить функцию единого входа.
    ...
    ![Диалоговое окно "Единый вход"](./media/spaceiq-tutorial/tutorial_spaceiq_samlbase.png)

1. В разделе **Домены и URL-адреса приложения SpaceIQ** сделайте следующее:

    ![Сведения о домене и URL-адресах единого входа приложения SpaceIQ](./media/spaceiq-tutorial/tutorial_spaceiq_url.png)
...
1. В разделе **Сертификат подписи SAML** щелкните **Certificate (Base64)** (Сертификат (Base64)), а затем сохраните файл сертификата на компьютере.

    ![Ссылка для скачивания сертификата](./media/spaceiq-tutorial/tutorial_spaceiq_certificate.png) 

1. Нажмите кнопку **Сохранить** .

    ![Кнопка "Сохранить" в окне настройки единого входа](./media/spaceiq-tutorial/tutorial_general_400.png)

1. В разделе **Настройка SpaceIQ** щелкните **Настроить SpaceIQ**, чтобы открыть окно **Настройка единого входа**. Скопируйте значение **SAML Entity ID** (Идентификатор сущности SAML) из раздела **Краткий справочник**.

    ![Настройка SpaceIQ](./media/spaceiq-tutorial/tutorial_spaceiq_configure.png) 

1.  Откройте новое окно браузера и войдите в среду SpaceIQ в качестве администратора.

1. После входа щелкните значок головоломки в правом верхнем углу, а затем — **Integrations** (Интеграции).
...
1. На портале Azure в области слева нажмите кнопку **Azure Active Directory**.
    ...
    ![Кнопка "Azure Active Directory"](./media/spaceiq-tutorial/create_aaduser_01.png)

1. Чтобы открыть список пользователей, перейдите в раздел **Пользователи и группы** и щелкните **Все пользователи**.

    ![Ссылки "Пользователи и группы" и "Все пользователи"](./media/spaceiq-tutorial/create_aaduser_02.png)

1. Чтобы открыть диалоговое окно **Пользователь**, в верхней части диалогового окна **Все пользователи** щелкните **Добавить**.

    ![Кнопка "Добавить"](./media/spaceiq-tutorial/create_aaduser_03.png)

1. В диалоговом окне **Пользователь** сделайте следующее.

    ![Диалоговое окно "Пользователь"](./media/spaceiq-tutorial/create_aaduser_04.png)
...
1. В списке приложений выберите **SpaceIQ**.

    ![Ссылка на SpaceIQ в списке "Приложения"](./media/spaceiq-tutorial/tutorial_spaceiq_app.png)  
