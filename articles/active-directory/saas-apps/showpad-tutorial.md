...
1. В поле поиска введите **Showpad**.
    ...
    ![Создание тестового пользователя Azure AD](./media/showpad-tutorial/tutorial_showpad_search.png)

1. На панели результатов выберите **Showpad** и нажмите кнопку **Добавить**, чтобы добавить это приложение.

    ![Создание тестового пользователя Azure AD](./media/showpad-tutorial/tutorial_showpad_addfromgallery.png)
...
1. **[Создание тестового пользователя Showpad](#creating-a-showpad-test-user)** требуется для того, чтобы в Showpad существовал пользователь Britta Simon, связанный с одноименным пользователем в Azure AD.
...
1. В диалоговом окне **Единый вход** в разделе **Режим** выберите **Вход на основе SAML**, чтобы включить функцию единого входа.
    ...
    ![Настройка единого входа](./media/showpad-tutorial/tutorial_showpad_samlbase.png)

1. В разделе **Домены и URL-адреса приложения Showpad** выполните следующие действия.

    ![Настройка единого входа](./media/showpad-tutorial/tutorial_showpad_url.png)
...
1. В разделе **Сертификат подписи SAML** щелкните **Metadata XML** (Метаданные XML) и сохраните файл метаданных на компьютере.
    ...
    ![Настройка единого входа](./media/showpad-tutorial/tutorial_showpad_certificate.png) 

1. Нажмите кнопку **Сохранить** .

    ![Настройка единого входа](./media/showpad-tutorial/tutorial_general_400.png)

1. Войдите в клиент Showpad как администратор.

1. В верхнем меню щелкните пункт **Параметры**.
   
    ![Настройка единого входа на стороне приложения](./media/showpad-tutorial/tutorial_showpad_001.png) 

1. Перейдите к параметру **Single Sign-On** (Единый вход) и щелкните **Enable** (Включить).
   
    ![Настройка единого входа на стороне приложения](./media/showpad-tutorial/tutorial_showpad_002.png)

1. В диалоговом окне **Add a SAML 2.0 Service** (Добавление службы SAML 2.0) выполните следующие действия.
...
1. На **портале Azure** в области навигации слева щелкните значок **Azure Active Directory**.
    ...
    ![Создание тестового пользователя Azure AD](./media/showpad-tutorial/create_aaduser_01.png) 

1. Чтобы отобразить список пользователей, перейдите в раздел **Пользователи и группы** и щелкните **Все пользователи**.
    
    ![Создание тестового пользователя Azure AD](./media/showpad-tutorial/create_aaduser_02.png) 

1. Чтобы открыть диалоговое окно **Пользователь**, в верхней части диалогового окна щелкните **Добавить**.
 
    ![Создание тестового пользователя Azure AD](./media/showpad-tutorial/create_aaduser_03.png) 

1. На странице диалогового окна **Пользователь** выполните следующие действия.
 
    ![Создание тестового пользователя Azure AD](./media/showpad-tutorial/create_aaduser_04.png) 
...
1. Из списка приложений выберите **Showpad**.

    ![Настройка единого входа](./media/showpad-tutorial/tutorial_showpad_app.png) 
