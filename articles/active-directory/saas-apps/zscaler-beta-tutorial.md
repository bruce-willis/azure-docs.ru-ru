...
1. В поле поиска введите **Zscaler Beta**.

    ![Создание тестового пользователя Azure AD](./media/zscaler-beta-tutorial/tutorial_zscalerbeta_search.png)

1. На панели результатов выберите **Zscaler Beta** и нажмите кнопку **Добавить**, чтобы добавить это приложение.

    ![Создание тестового пользователя Azure AD](./media/zscaler-beta-tutorial/tutorial_zscalerbeta_addfromgallery.png)
...
1. **[Создание тестового пользователя Zscaler Beta](#creating-a-zscaler-beta-test-user)** требуется для того, чтобы в Zscaler Beta существовал пользователь Britta Simon, связанный с одноименным пользователем в Azure AD.
...
1. В диалоговом окне **Единый вход** в разделе **Режим** выберите **Вход на основе SAML**, чтобы включить функцию единого входа.
    ...
    ![Настройка единого входа](./media/zscaler-beta-tutorial/tutorial_zscalerbeta_samlbase.png)

1. В разделе **Домены и URL-адреса приложения Zscaler Beta** сделайте следующее.

    ![Настройка единого входа](./media/zscaler-beta-tutorial/tutorial_zscalerbeta_url.png)
...
1. В разделе **Сертификат подписи SAML** щелкните **Сертификат (Base64)**, а затем сохраните файл сертификата на компьютере.
    ...
    ![Настройка единого входа](./media/zscaler-beta-tutorial/tutorial_zscalerbeta_certificate.png) 

1. Нажмите кнопку **Сохранить** .

    ![Настройка единого входа](./media/zscaler-beta-tutorial/tutorial_general_400.png)

1. В разделе **Конфигурация Zscaler Beta** щелкните **настроить Zscaler Beta**, чтобы открыть окно **Настройка единого входа**. Скопируйте **URL-адрес службы единого входа SAML** из раздела **Краткий справочник**.

    ![Настройка единого входа](./media/zscaler-beta-tutorial/tutorial_zscalerbeta_configure.png) 
...
1. В разделе **Manage Administrators & Roles** (Управление администраторами и ролями) щелкните **Manage Users & Authentication** (Управление пользователями и проверкой подлинности).   
    ...
    ![Управление пользователями и проверкой подлинности](./media/zscaler-beta-tutorial/ic800207.png "Управление пользователями и проверкой подлинности")

1. В разделе **Выбор параметров проверки подлинности для организации** выполните следующие действия.   
                
    ![Аутентификация](./media/zscaler-beta-tutorial/ic800208.png "Аутентификация")
...
1. На странице диалогового окна **Configure SAML Single Sign-On Parameters** (Настройка параметров единого входа в SAML) выполните указанные ниже действия и нажмите кнопку **Готово**.
    ...
    ![Единый вход](./media/zscaler-beta-tutorial/ic800209.png "Единый вход")
...
1. На странице **Настройка проверки подлинности пользователей** выполните следующие действия.
    ...
    ![Администрирование](./media/zscaler-beta-tutorial/ic800210.png "Администрирование")
...
1. На **портале Azure** в области навигации слева щелкните значок **Azure Active Directory**.
    ...
    ![Создание тестового пользователя Azure AD](./media/zscaler-beta-tutorial/create_aaduser_01.png) 

1. Чтобы отобразить список пользователей, перейдите в раздел **Пользователи и группы** и щелкните **Все пользователи**.
    
    ![Создание тестового пользователя Azure AD](./media/zscaler-beta-tutorial/create_aaduser_02.png) 

1. Чтобы открыть диалоговое окно **Пользователь**, в верхней части диалогового окна щелкните **Добавить**.
 
    ![Создание тестового пользователя Azure AD](./media/zscaler-beta-tutorial/create_aaduser_03.png) 

1. На странице диалогового окна **Пользователь** выполните следующие действия.
 
    ![Создание тестового пользователя Azure AD](./media/zscaler-beta-tutorial/create_aaduser_04.png) 
...
1. Щелкните **Администрирование**.   
    ...
    ![Администрирование](./media/zscaler-beta-tutorial/ic781035.png "Администрирование")

1. Щелкните **Управление пользователями**.   
        
     ![Добавление](./media/zscaler-beta-tutorial/ic781036.png "Добавление")

1. На вкладке **Users** (Пользователи) нажмите кнопку **Add** (Добавить).
      
    ![Добавление](./media/zscaler-beta-tutorial/ic781037.png "Добавление")

1. В разделе "Добавить пользователя" выполните следующие действия.
        
    ![Добавление пользователя](./media/zscaler-beta-tutorial/ic781038.png "Добавление пользователя")
...
1. Из списка приложений выберите **Zscaler Beta**.
    ...
    ![Настройка единого входа](./media/zscaler-beta-tutorial/tutorial_zscalerbeta_app.png) 
