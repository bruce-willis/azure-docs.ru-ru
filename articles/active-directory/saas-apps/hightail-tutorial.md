...
9. Чтобы единый вход был настроен для вашего приложения, войдите в клиент Hightail с правами администратора.
    ...
    ![Настройка единого входа](./media/hightail-tutorial/tutorial_hightail_001.png) 

    Б. Установите флажок **Включить проверку подлинности SAML**.

    ![Настройка единого входа](./media/hightail-tutorial/tutorial_hightail_002.png) 
    ...
    ![Настройка единого входа](./media/hightail-tutorial/tutorial_hightail_003.png) 
    ...
    ![Настройка единого входа](./media/hightail-tutorial/tutorial_hightail_004.png)
    ...
    ![Настройка единого входа](./media/hightail-tutorial/tutorial_hightail_006.png)
