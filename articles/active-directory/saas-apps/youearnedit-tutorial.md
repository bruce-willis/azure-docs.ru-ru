...
1. В поле поиска введите **YouEarnedIt**, выберите **YouEarnedIt** на панели результатов и нажмите кнопку **Добавить**, чтобы добавить это приложение.
...
1. **[Создание тестового пользователя YouEarnedIt](#create-a-youearnedit-test-user)** требуется для того, чтобы в YouEarnedIt существовал пользователь Britta Simon, связанный с одноименным пользователем в Azure AD.
...
1. В разделе **Домены и URL-адреса приложения YouEarnedIt** выполните следующие действия.
...
1. В разделе **Конфигурация YouEarnedIt** щелкните **Настроить YouEarnedIt**, чтобы открыть окно **Настройка единого входа**. Скопируйте **URL-адрес службы единого входа SAML** из раздела **Краткий справочник**.

    ![Конфигурация YouEarnedIt](./media/youearnedit-tutorial/tutorial_youearnedit_configure.png) 

1. Чтобы настроить единый вход на стороне **YouEarnedIt**, отправьте скачанный **сертификат в кодировке Base64** и **URL-адрес службы единого входа SAML** [группе поддержки YouEarnedIt](https://youearnedit.freshdesk.com/support/tickets/new). Специалисты службы поддержки настроят подключение единого входа SAML на обеих сторонах.
...
1. В списке приложений выберите **YouEarnedIt**.
