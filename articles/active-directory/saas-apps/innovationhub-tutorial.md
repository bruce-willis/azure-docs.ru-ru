...
1. В поле поиска введите **Innovation Hub**, выберите **Innovation Hub** на панели результатов и нажмите кнопку **Добавить**, чтобы добавить это приложение.
...
1. **[Создание тестового пользователя приложения Innovation Hub](#create-an-innovation-hub-test-user)** требуется для создания в Innovation Hub пользователя Britta Simon, связанного с одноименным пользователем в Azure AD.
...
1. В разделе **Домены и URL-адреса приложения Innovation Hub** сделайте следующее:
...
1. Приложение Innovation Hub ожидает утверждения SAML в определенном формате. Настройте следующие утверждения для этого приложения. Управлять значениями этих атрибутов можно в разделе **Атрибуты пользователя** на странице интеграции приложения. На следующем снимке экрана приведен пример.
...
1. Для настройки единого входа на стороне **Innovation Hub** необходимо отправить скопированный **URL-адрес метаданных федерации** в [службу поддержки Innovation Hub](mailto:support@readify.net). Специалисты службы поддержки настроят подключение единого входа SAML на обеих сторонах.
...
1. В списке приложений выберите **Innovation Hub**.
