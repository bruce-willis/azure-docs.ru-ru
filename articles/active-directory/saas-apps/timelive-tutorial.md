...
1. В поле поиска введите **TimeLive**, выберите **TimeLive** на панели результатов и нажмите кнопку **Добавить**, чтобы добавить это приложение.
    ...
    ![TimeLive в списке результатов](./media/timelive-tutorial/tutorial_timelive_addfromgallery.png)
...
1. В диалоговом окне **Единый вход** в разделе **Режим** выберите **Вход на основе SAML**, чтобы включить функцию единого входа.
    ...
    ![Диалоговое окно "Единый вход"](./media/timelive-tutorial/tutorial_timelive_samlbase.png)

1. В разделе **Домены и URL-адреса приложения TimeLive** выполните следующие действия.

    ![Сведения о домене и URL-адресах единого входа приложения TimeLive](./media/timelive-tutorial/tutorial_timelive_url.png)
...
1. В разделе **Сертификат подписи SAML** щелкните **Сертификат (Base64)**, а затем сохраните файл сертификата на компьютере.
    ...
    ![Ссылка для скачивания сертификата](./media/timelive-tutorial/tutorial_timelive_certificate.png) 

1. Нажмите кнопку **Сохранить** .

    ![Кнопка "Сохранить" в окне настройки единого входа](./media/timelive-tutorial/tutorial_general_400.png)
    
1. В разделе **Конфигурация TimeLive** щелкните **Настроить TimeLive**, чтобы открыть окно **Настройка единого входа**. Скопируйте **URL-адрес выхода и URL-адрес службы единого входа SAML** из раздела **Краткий справочник**.

    ![Конфигурация TimeLive](./media/timelive-tutorial/tutorial_timelive_configure.png)

1. В другом окне браузера войдите на ваш корпоративный веб-сайт TimeLive в качестве администратора.

1. Выберите **Preferences** (Параметры) в разделе **Admin Options** (Параметры администрирования).

    ![Конфигурация TimeLive](./media/timelive-tutorial/configure1.png)

1. В разделе **Application Preference** (Параметры приложения) сделайте следующее.
...
1. Чтобы открыть список пользователей, перейдите в раздел **Пользователи и группы** и щелкните **Все пользователи**.
    ...
    ![Ссылки "Пользователи и группы" и "Все пользователи"](./media/timelive-tutorial/create_aaduser_02.png)

1. Чтобы открыть диалоговое окно **Пользователь**, в верхней части диалогового окна **Все пользователи** щелкните **Добавить**.

    ![Кнопка "Добавить"](./media/timelive-tutorial/create_aaduser_03.png)

1. В диалоговом окне **Пользователь** сделайте следующее.

    ![Диалоговое окно "Пользователь"](./media/timelive-tutorial/create_aaduser_04.png)
...
1. Из списка приложений выберите **TimeLive**.

    ![Ссылка на TimeLive в списке "Приложения"](./media/timelive-tutorial/tutorial_timelive_app.png)  
