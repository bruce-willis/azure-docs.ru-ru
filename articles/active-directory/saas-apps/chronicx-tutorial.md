...
3. **[Создание тестового пользователя приложения ChronicX®](#create-a-chronicx®-test-user)** требуется для того, чтобы в ChronicX® существовал пользователь Britta Simon, связанный с одноименным пользователем в Azure AD.
...
3. В разделе **Домены и URL-адреса приложения ChronicX®** сделайте следующее:
...
6. Чтобы настроить единый вход на стороне **ChronicX®**, отправьте скачанный **XML-файл метаданных** [службе поддержки ChronicX®](https://www.casebank.com/contact-us/). Специалисты службы поддержки настроят подключение единого входа SAML на обеих сторонах.
