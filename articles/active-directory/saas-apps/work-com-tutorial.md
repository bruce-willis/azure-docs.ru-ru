...
1. В поле поиска введите **Work.com**, выберите **Work.com** на панели результатов и нажмите кнопку **Добавить**, чтобы добавить это приложение.

    ![Добавление из коллекции](./media/work-com-tutorial/tutorial_work-com_addfromgallery.png)
...
1. В диалоговом окне **Единый вход** в разделе **Режим** выберите **Вход на основе SAML**, чтобы включить функцию единого входа.
    ...
    ![Параметр "Вход на основе SAML"](./media/work-com-tutorial/tutorial_work-com_samlbase.png)

1. В разделе **Домены и URL-адреса приложения Work.com** сделайте следующее:

    ![Раздел "Домены и URL-адреса приложения Work.com"](./media/work-com-tutorial/tutorial_work-com_url.png)
...
1. В разделе **Сертификат для подписи токена SAML** щелкните **Certificate (Base64)** (Сертификат (Base64)), а затем сохраните файл сертификата на компьютере.
    ...
    ![Раздел "Сертификат подписи SAML"](./media/work-com-tutorial/tutorial_work-com_certificate.png) 

1. Нажмите кнопку **Сохранить** .

    ![Кнопка "Сохранить"](./media/work-com-tutorial/tutorial_general_400.png)

1. В разделе **Настройка Work.com** щелкните **Настроить Work.com**, чтобы открыть окно **Настройка единого входа**. Скопируйте **URL-адрес выхода, идентификатор сущности SAML и URL-адрес службы единого входа SAML** из раздела **Краткий справочник**.

    ![Раздел "Настройка Work.com"](./media/work-com-tutorial/tutorial_work-com_configure.png) 
...
1. Войдите в клиент Work.com.

1. Перейдите в раздел **Настройка**.
    
    ![Настройка](./media/work-com-tutorial/ic794108.png "Настройка")

1. Разверните меню **Управление безопасностью**, а затем щелкните **Параметры единого входа**.
    
    ![Параметры единого входа](./media/work-com-tutorial/ic794113.png "Параметры единого входа")

1. На странице диалогового окна **Параметры единого входа** сделайте следующее:
...
1. В левой области навигации классического портала Work.com щелкните **Domain Management** (Управление доменами), чтобы развернуть соответствующий раздел, и щелкните **My Domain** (Мой домен), чтобы открыть страницу **My Domain** (Мой домен). 
...
1. На **портале Azure** в области навигации слева щелкните значок **Azure Active Directory**.
    ...
    ![Создание тестового пользователя Azure AD](./media/work-com-tutorial/create_aaduser_01.png) 

1. Чтобы отобразить список пользователей, перейдите в раздел **Пользователи и группы** и щелкните **Все пользователи**.
    
    ![Выберите "Пользователи и группы" > "Все пользователи".](./media/work-com-tutorial/create_aaduser_02.png) 

1. Чтобы открыть диалоговое окно **Пользователь**, в верхней части диалогового окна щелкните **Добавить**.
 
    ![Добавить](./media/work-com-tutorial/create_aaduser_03.png) 

1. На странице диалогового окна **Пользователь** выполните следующие действия.
 
    ![Диалоговое окно "Пользователь"](./media/work-com-tutorial/create_aaduser_04.png) 
...
1. В разделе "User Edit" (Изменение пользователя) выполните следующие действия, разместив в текстовые поля атрибуты действующей учетной записи Azure AD, которую вы хотите подготовить.
...
1. В списке приложений выберите **Work.com**.

    ![Work.com в списке приложений](./media/work-com-tutorial/tutorial_work-com_app.png) 
