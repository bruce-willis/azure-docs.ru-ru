...
4. В поле поиска введите **IriusRisk**, выберите **IriusRisk** на панели результатов и нажмите кнопку **Добавить**, чтобы добавить это приложение.
...
3. **[Создание тестового пользователя приложения IriusRisk](#create-a-iriusrisk-test-user)** требуется для того, чтобы в IriusRisk существовал пользователь Britta Simon, связанный с одноименным пользователем в Azure AD.
...
3. В разделе **Домены и URL-адреса приложения IriusRisk** выполните следующие действия.
...
6. Чтобы настроить единый вход на стороне **IriusRisk**, отправьте [группе поддержки IriusRisk](mailto:info@continuumsecurity.net) скачанный **XML-файл метаданных**. Специалисты службы поддержки настроят подключение единого входа SAML на обеих сторонах.
...
2. Из списка приложений выберите **IriusRisk**.
