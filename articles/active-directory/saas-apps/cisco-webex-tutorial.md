...
1. В поле поиска введите **Cisco Webex**. 

1. Выберите **Cisco Webex** в области результатов. Нажмите кнопку **Добавить**, чтобы добавить приложение.
...
1. [Создание тестового пользователя Cisco Webex](#create-a-cisco-webex-test-user) нужно для того, чтобы в Cisco Webex также существовал пользователь Britta Simon, связанный с одноименным пользователем в Azure AD.
...
1. В разделе **Домены и URL-адреса приложения Cisco Webex** сделайте следующее:
...
1. В разделе **Конфигурация Cisco Webex** выберите **Настроить Cisco Webex**, чтобы открыть окно **Настройка единого входа**. Скопируйте **URL-адрес выхода**, **идентификатор сущности SAML** и **URL-адрес службы единого входа SAML** из раздела **Краткий справочник**.

    ![Настройка единого входа](./media/cisco-webex-tutorial/tutorial_ciscowebex_configure.png) 

1. В другом окне веб-браузера войдите на свой корпоративный веб-сайт Cisco Webex в качестве администратора.

1. В верхнем меню выберите **Администрирование веб-сайта**.

    ![Администрирование сайта](./media/cisco-webex-tutorial/ic777621.png "Администрирование сайта")

1. В разделе **Управление сайтом** выберите **SSO Configuration** (Настройка единого входа).
   
    ![Настройка единого входа](./media/cisco-webex-tutorial/ic777622.png "Настройка единого входа")

1. В разделе **Federated Web SSO Configuration** (Настройка федеративного единого входа в Интернете) выполните следующие действия:
   
    ![Настройка федеративного единого входа](./media/cisco-webex-tutorial/ic777623.png "Настройка федеративного единого входа")  
...
1. Последовательно выберите пункты **Управление пользователями** > **Добавить пользователя**.
   
    ![Добавление пользователей](./media/cisco-webex-tutorial/ic777625.png "Добавление пользователей")

1. В разделе **Добавление пользователя** выполните следующие действия:
   
    ![Добавление пользователя](./media/cisco-webex-tutorial/ic777626.png "Добавление пользователя")   
