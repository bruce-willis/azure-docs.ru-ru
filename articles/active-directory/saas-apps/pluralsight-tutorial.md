...
1. В поле поиска введите **Pluralsight**, выберите **Pluralsight** на панели результатов и нажмите кнопку **Добавить**, чтобы добавить это приложение.

    ![Pluralsight в списке результатов](./media/pluralsight-tutorial/tutorial_pluralsight_addfromgallery.png)
...
1. **[Создание тестового пользователя Pluralsight](#create-a-pluralsight-test-user)** требуется для того, чтобы в Pluralsight существовал пользователь Britta Simon, связанный с одноименным пользователем в Azure AD.
...
1. В диалоговом окне **Единый вход** в разделе **Режим** выберите **Вход на основе SAML**, чтобы включить функцию единого входа.
    ...
    ![Диалоговое окно "Единый вход"](./media/pluralsight-tutorial/tutorial_pluralsight_samlbase.png)

1. В разделе **Домены и URL-адреса приложения Pluralsight** выполните следующие действия.

    ![Сведения о домене и URL-адресах единого входа для приложения Pluralsight](./media/pluralsight-tutorial/tutorial_pluralsight_url.png)
    ...
    b. В текстовом поле **Идентификатор** введите URL-адрес `www.pluralsight.com`.
...
1. В разделе **Сертификат подписи SAML** щелкните **Metadata XML** (Метаданные XML) и сохраните файл метаданных на компьютере.
    ...
    ![Ссылка для скачивания сертификата](./media/pluralsight-tutorial/tutorial_pluralsight_certificate.png) 

1. В этом разделе описано, как включить единый вход Azure AD на портале Azure AD и настроить единый вход в приложении Pluralsight.
    ...
    ![Настройка единого входа](./media/pluralsight-tutorial/tutorial_pluralsight_attribute.png)
...
1. Чтобы добавить требуемые **атрибуты маркера SAML**, для каждой строки в таблице ниже выполните следующие действия.
   ...
   a. В нижней части страницы нажмите кнопку **add user attribute** to open the **Добавить атрибут пользователя** .
     ...
     ![Настройка единого входа](./media/pluralsight-tutorial/tutorial_pluralsight_addattribute.png)
...
1. Нажмите кнопку **Сохранить** .
    ...
    ![Настройка единого входа](./media/pluralsight-tutorial/tutorial_general_400.png)

1. Чтобы настроить единый вход для своего приложения, свяжитесь с представителем отдела [профессиональных услуг](mailTo:professionalservices@pluralsight.com) Pluralsight и передайте ему скачанный файл метаданных.
...
1. На портале Azure в области слева нажмите кнопку **Azure Active Directory**.
    ...
    ![Кнопка "Azure Active Directory"](./media/pluralsight-tutorial/create_aaduser_01.png)

1. Чтобы открыть список пользователей, перейдите в раздел **Пользователи и группы** и щелкните **Все пользователи**.

    ![Ссылки "Пользователи и группы" и "Все пользователи"](./media/pluralsight-tutorial/create_aaduser_02.png)

1. Чтобы открыть диалоговое окно **Пользователь**, в верхней части диалогового окна **Все пользователи** щелкните **Добавить**.

    ![Кнопка "Добавить"](./media/pluralsight-tutorial/create_aaduser_03.png)

1. В диалоговом окне **Пользователь** сделайте следующее.

    ![Диалоговое окно "Пользователь"](./media/pluralsight-tutorial/create_aaduser_04.png)
...
1. В списке приложений выберите **Pluralsight**.
    ...
    ![Ссылка на Pluralsight в списке "Приложения"](./media/pluralsight-tutorial/tutorial_pluralsight_app.png)  
