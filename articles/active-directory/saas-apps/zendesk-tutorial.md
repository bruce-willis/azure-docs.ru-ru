...
1. В поле поиска введите **Zendesk**, выберите **Zendesk** на панели результатов и нажмите кнопку **Добавить**, чтобы добавить это приложение.

    ![Zendesk в списке результатов](./media/zendesk-tutorial/tutorial_zendesk_addfromgallery.png)
...
1. **[Создание тестового пользователя Zendesk](#create-a-zendesk-test-user)** требуется для создания в Zendesk пользователя Britta Simon, связанного с представлением этого же пользователя в Azure AD.
...
1. В диалоговом окне **Единый вход** в разделе **Режим** выберите **Вход на основе SAML**, чтобы включить функцию единого входа.
    ...
    ![Диалоговое окно "Единый вход"](./media/zendesk-tutorial/tutorial_zendesk_samlbase.png)

1. В разделе **Домены и URL-адреса приложения Zendesk** выполните следующие действия:

    ![Сведения о домене и URL-адресах единого входа для приложения Zendesk](./media/zendesk-tutorial/tutorial_zendesk_url.png)

    a. В текстовом поле **URL-адрес для входа** введите URL-адрес в следующем формате: `https://<subdomain>.zendesk.com`

    b. В текстовом поле **Идентификатор** введите значение в следующем формате: `<subdomain>.zendesk.com`.
...
1. В разделе **Сертификат подписи SAML** скопируйте значение **Отпечаток**.
    ...
    ![Ссылка для скачивания сертификата](./media/zendesk-tutorial/tutorial_zendesk_certificate.png)

1. Приложение Zendesk ожидает утверждения SAML в определенном формате. Обязательные атрибуты SAML отсутствуют, но при необходимости можно добавить атрибут из раздела **Атрибуты пользователя**, выполнив следующие шаги: 

     ![Настройка единого входа](./media/zendesk-tutorial/tutorial_zendesk_attributes1.png)

    a. Щелкните **Добавить атрибут**, чтобы открыть диалоговое окно **Добавление атрибута**.

    ![Добавление атрибута для настройки единого входа](./media/zendesk-tutorial/tutorial_attribute_04.png)

    ![Окно добавления атрибута для настройки единого входа](./media/zendesk-tutorial/tutorial_attribute_05.png)
...
1. Нажмите кнопку **Сохранить** .
    ...
    ![Кнопка "Сохранить" в окне настройки единого входа](./media/zendesk-tutorial/tutorial_general_400.png)

1. В разделе **Настройка Zendesk** щелкните **Настроить Zendesk**, чтобы открыть окно **Настройка единого входа**. Скопируйте **URL-адрес выхода и URL-адрес службы единого входа SAML** из раздела **Краткий справочник**.

    ![Конфигурация Zendesk](./media/zendesk-tutorial/tutorial_zendesk_configure.png) 

1. В другом окне браузера войдите на свой корпоративный сайт Zendesk в качестве администратора.
...
1. На портале Azure в области слева нажмите кнопку **Azure Active Directory**.
    ...
    ![Кнопка "Azure Active Directory"](./media/zendesk-tutorial/create_aaduser_01.png)

1. Чтобы открыть список пользователей, перейдите в раздел **Пользователи и группы** и щелкните **Все пользователи**.

    ![Ссылки "Пользователи и группы" и "Все пользователи"](./media/zendesk-tutorial/create_aaduser_02.png)

1. Чтобы открыть диалоговое окно **Пользователь**, в верхней части диалогового окна **Все пользователи** щелкните **Добавить**.

    ![Кнопка "Добавить"](./media/zendesk-tutorial/create_aaduser_03.png)

1. В диалоговом окне **Пользователь** сделайте следующее.

    ![Диалоговое окно "Пользователь"](./media/zendesk-tutorial/create_aaduser_04.png)
...
1. Откройте вкладку **Список клиентов** .

1. Выберите вкладку **User** (Пользователь) и нажмите кнопку **Add** (Добавить).

    ![Добавление пользователя](./media/zendesk-tutorial/ic773632.png "Добавление пользователя")
1. Введите **имя** и **электронный адрес** существующей учетной записи Azure AD, которую нужно подготовить, а затем нажмите кнопку **Сохранить**.
...
1. В списке приложений выберите **Zendesk**.
    ...
    ![Ссылка на Zendesk в списке приложений](./media/zendesk-tutorial/tutorial_zendesk_app.png)
