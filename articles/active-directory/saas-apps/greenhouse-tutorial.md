...
1. В поле поиска введите **Greenhouse**, выберите **Greenhouse** на панели результатов и нажмите кнопку **Добавить**, чтобы добавить это приложение.

    ![Greenhouse в списке результатов](./media/greenhouse-tutorial/tutorial_greenhouse_addfromgallery.png)
...
1. **[Создание тестового пользователя приложения Greenhouse](#create-a-greenhouse-test-user)** требуется для создания в Greenhouse пользователя Britta Simon, связанного с представлением пользователя в Azure AD.
...
1. В диалоговом окне **Единый вход** в разделе **Режим** выберите **Вход на основе SAML**, чтобы включить функцию единого входа.
    ...
    ![Диалоговое окно "Единый вход"](./media/greenhouse-tutorial/tutorial_greenhouse_samlbase.png)

1. В разделе **Домены и URL-адреса приложения Greenhouse** выполните следующие действия:

    ![Сведения о домене и URL-адресах единого входа приложения Greenhouse](./media/greenhouse-tutorial/tutorial_greenhouse_url.png)
...
1. В разделе **Сертификат подписи SAML** щелкните **Metadata XML** (Метаданные XML) и сохраните файл метаданных на компьютере.
    ...
    ![Ссылка для скачивания сертификата](./media/greenhouse-tutorial/tutorial_greenhouse_certificate.png) 
...
1. На портале Azure в области слева нажмите кнопку **Azure Active Directory**.
    ...
    ![Кнопка "Azure Active Directory"](./media/greenhouse-tutorial/create_aaduser_01.png)

1. Чтобы открыть список пользователей, перейдите в раздел **Пользователи и группы** и щелкните **Все пользователи**.

    ![Ссылки "Пользователи и группы" и "Все пользователи"](./media/greenhouse-tutorial/create_aaduser_02.png)

1. Чтобы открыть диалоговое окно **Пользователь**, в верхней части диалогового окна **Все пользователи** щелкните **Добавить**.

    ![Кнопка "Добавить"](./media/greenhouse-tutorial/create_aaduser_03.png)

1. В диалоговом окне **Пользователь** сделайте следующее.

    ![Диалоговое окно "Пользователь"](./media/greenhouse-tutorial/create_aaduser_04.png)
...
1. В меню вверху щелкните **Configure** (Настройка) и выберите **Users** (Пользователи).
   
   ![Пользователи](./media/greenhouse-tutorial/ic790791.png "Пользователи")

1. Нажмите кнопку **Новые пользователи**.
...
1. В списке приложений выберите **Greenhouse**.
    ...
    ![Ссылка на Greenhouse в списке "Приложения"](./media/greenhouse-tutorial/tutorial_greenhouse_app.png)  
