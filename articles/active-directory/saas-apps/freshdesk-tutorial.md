...
1. В поле поиска введите **FreshDesk**.

    ![Создание тестового пользователя Azure AD](./media/freshdesk-tutorial/tutorial_freshdesk_search.png)

1. На панели результатов выберите **FreshDesk** и нажмите кнопку **Добавить**, чтобы добавить это приложение.
...
1. **[Создание тестового пользователя FreshDesk](#creating-a-freshdesk-test-user)** требуется для создания во FreshDesk пользователя Britta Simon, связанного с соответствующим пользователем в Azure AD.
...
1. В разделе **Домены и URL-адреса приложения FreshDesk** введите в поле **URL-адрес для входа** значение `https://<tenant-name>.freshdesk.com` или любое другое значение, предлагаемое Freshdesk.
...
1. В разделе **Конфигурация FreshDesk** щелкните **Настроить FreshDesk**, чтобы открыть окно настройки единого входа. Скопируйте URL-адрес службы единого входа SAML и URL-адрес выхода из раздела **Краткий справочник**.
...
1. В верхнем меню щелкните **Администратор**.
   ...
   ![Администратор](./media/freshdesk-tutorial/IC776768.png "Администратор")

1. На вкладке **General Settings** (Общие параметры) щелкните **Security** (Безопасность).
   
   ![Безопасность](./media/freshdesk-tutorial/IC776769.png "Безопасность")
...
1. На вкладке **General Settings** (Общие параметры) выберите **Agents** (Агенты).
...
1. В диалоговом окне "Сведения об агенте " выполните следующие действия.
