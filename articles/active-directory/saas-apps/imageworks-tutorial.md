...
4. В поле поиска введите **IMAGE WORKS**, выберите **IMAGE WORKS** на панели результатов и нажмите кнопку **Добавить**, чтобы добавить это приложение.
...
3. **[Создание тестового пользователя IMAGE WORKS](#create-a-image-works-test-user)** требуется, чтобы в IMAGE WORKS существовал пользователь Britta Simon, связанный с одноименным пользователем в Azure AD.
...
3. В разделе **Домены и URL-адреса IMAGE WORKS** выполните следующие действия.
...
6. В разделе **Настройка IMAGE WORKS** щелкните **Настроить IMAGE WORKS**, чтобы открыть окно **Настройка единого входа**. Скопируйте **URL-адрес выхода, идентификатор сущности SAML и URL-адрес службы единого входа SAML** из раздела **Краткий справочник**.

    ![Настройка IMAGE WORKS](./media/imageworks-tutorial/tutorial_imageworks_configure.png) 

7. Чтобы настроить единый вход на стороне **IMAGE WORKS**, нужно отправить **скачанный сертификат в кодировке Base64, URL-адрес выхода, идентификатор сущности SAML и URL-адрес службы единого входа SAML** [группе поддержки IMAGE WORKS](mailto:iw-sd-support@fujifilm.com). Специалисты службы поддержки настроят подключение единого входа SAML на обеих сторонах.
...
2. В списке приложений выберите **IMAGE WORKS**.
