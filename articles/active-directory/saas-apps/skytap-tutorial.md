...
3. **[Создание тестового пользователя приложения Skytap](#create-a-skytap-test-user)** требуется для того, чтобы в Skytap существовал пользователь Britta Simon, связанный с одноименным пользователем в Azure AD.
...
3. Если вы хотите настроить приложение в режиме, инициируемом **IdP**, в разделе**Домены и URL-адреса приложения Skytap** выполните следующие действия:
...
7. Чтобы настроить единый вход на стороне **Skytap**, отправьте [службе поддержки Skytap](mailto:support@skytap.com) скачанный **XML-файл метаданных**. Специалисты службы поддержки настроят подключение единого входа SAML на обеих сторонах.
