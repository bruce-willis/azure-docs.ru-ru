...
6. Чтобы настроить единый вход на стороне **Atomic Learning**, отправьте скачанный **XML-файл метаданных** [группе поддержки Atomic Learning](mailto:cs@atomiclearning.com). Специалисты службы поддержки настроят подключение единого входа SAML на обеих сторонах.
