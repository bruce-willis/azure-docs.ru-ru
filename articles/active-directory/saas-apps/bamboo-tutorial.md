...
3. **[Создание тестового пользователя SAML SSO for Bamboo by resolution GmbH](#create-a-saml-sso-for-bamboo-by-resolution-gmbh-test-user)** требуется, чтобы создать в SAML SSO for Bamboo by resolution GmbH пользователя Britta Simon, связанного с соответствующим пользователем в Azure AD.
...
3. Если вы хотите настроить приложение в режиме, инициированном IDP, то в разделе **Домены и URL-адреса приложения SAML SSO for Bamboo by resolution GmbH** сделайте следующее:
...
7. Войдите на свой корпоративный сайт SAML SSO for Bamboo by resolution GmbH с правами администратора.

8. Справа от главной панели инструментов щелкните **Параметры** > **Надстройки**.

    ![Параметры](./media/bamboo-tutorial/tutorial_bamboo_setings.png)

9. В разделе "Безопасность" в строке меню щелкните **SAML SingleSignOn**.
