...
1. В поле поиска введите **Datahug**.

    ![Создание тестового пользователя Azure AD](./media/datahug-tutorial/tutorial_datahug_search.png)

1. На панели результатов выберите **Datahug** и нажмите кнопку **Добавить**, чтобы добавить приложение.

    ![Создание тестового пользователя Azure AD](./media/datahug-tutorial/tutorial_datahug_addfromgallery.png)
...
1. **[Создание тестового пользователя Datahug](#creating-a-datahug-test-user)** требуется для создания пользователя Britta Simon в Datahug, связанного с соответствующим представлением в Azure AD.
...
1. В диалоговом окне **Единый вход** в разделе **Режим** выберите **Вход на основе SAML**, чтобы включить функцию единого входа.
    ...
    ![Настройка единого входа](./media/datahug-tutorial/tutorial_datahug_samlbase.png)

1. Если вы хотите настроить приложение в **режиме, инициированном поставщиком удостоверений**, то в разделе **Домены и URL-адреса приложения Datahug** выполните следующие действия:

    ![Настройка единого входа](./media/datahug-tutorial/tutorial_datahug_ur1.png)
...
1. Установите флажок **Показать дополнительные параметры URL-адресов**, если хотите настроить приложение для работы в режиме, инициируемом **поставщиком услуг**.
    ...
    ![Настройка единого входа](./media/datahug-tutorial/tutorial_datahug_url2.png)
...
1. В разделе **Сертификат подписи SAML** щелкните **Metadata XML** (Метаданные XML) и сохраните файл метаданных на компьютере.
    ...
    ![Настройка единого входа](./media/datahug-tutorial/tutorial_datahug_certificate.png) 

1.  Установите флажок **Показать дополнительные параметры подписывания сертификатов** и выполните следующие действия:

    ![Настройка единого входа](./media/datahug-tutorial/tutorial_datahug_cert.png)
...
1. Нажмите кнопку **Сохранить** .
    ...
    ![Настройка единого входа](./media/datahug-tutorial/tutorial_general_400.png)
    
1. В разделе **Конфигурация Datahug** щелкните **Настроить Datahug**, чтобы открыть окно **Настройка единого входа**. Скопируйте **идентификатор сущности SAML** и **URL-адрес службы единого входа SAML** из раздела **Краткий справочник**.

    ![Настройка единого входа](./media/datahug-tutorial/tutorial_datahug_configure.png) 
...
1. На **портале Azure** в области навигации слева щелкните значок **Azure Active Directory**.
    ...
    ![Создание тестового пользователя Azure AD](./media/datahug-tutorial/create_aaduser_01.png) 

1. Чтобы отобразить список пользователей, перейдите в раздел **Пользователи и группы** и щелкните **Все пользователи**.
    
    ![Создание тестового пользователя Azure AD](./media/datahug-tutorial/create_aaduser_02.png) 

1. Чтобы открыть диалоговое окно **Пользователь**, в верхней части диалогового окна щелкните **Добавить**.
 
    ![Создание тестового пользователя Azure AD](./media/datahug-tutorial/create_aaduser_03.png) 

1. На странице диалогового окна **Пользователь** выполните следующие действия.
 
    ![Создание тестового пользователя Azure AD](./media/datahug-tutorial/create_aaduser_04.png) 
...
1. Наведите указатель мыши на **шестеренку** в верхнем правом углу и выберите **Settings** (Параметры).
   
   ![Добавление сотрудника](./media/datahug-tutorial/1.png)

1. Выберите элемент **People** (Люди) и откройте вкладку **Add Users** (Добавление пользователей).

    ![Добавление сотрудника](./media/datahug-tutorial/2.png)

1. Введите адрес электронной почты человека, для которого вы хотите создать учетную запись, и нажмите кнопку **Добавить**.
...
1. В списке приложений выберите **Datahug**.

    ![Настройка единого входа](./media/datahug-tutorial/tutorial_datahug_app.png) 
