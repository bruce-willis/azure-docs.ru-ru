...
1. В поле поиска введите **Kronos**.

    ![Создание тестового пользователя Azure AD](./media/kronos-tutorial/tutorial_kronos_search.png)

1. На панели результатов выберите **Kronos** и нажмите кнопку **Добавить**, чтобы добавить это приложение.

    ![Создание тестового пользователя Azure AD](./media/kronos-tutorial/tutorial_kronos_addfromgallery.png)
...
1. **[Создание тестового пользователя Kronos](#creating-a-kronos-test-user)** требуется для создания в Kronos пользователя Britta Simon, связанного с представлением этого же пользователя в Azure AD.
...
1. В диалоговом окне **Единый вход** в разделе **Режим** выберите **Вход на основе SAML**, чтобы включить функцию единого входа.
    ...
    ![Настройка единого входа](./media/kronos-tutorial/tutorial_kronos_samlbase.png)

1. В разделе **Домены и URL-адреса приложения Kronos** выполните следующие действия:

    ![Настройка единого входа](./media/kronos-tutorial/tutorial_kronos_url.png)

    a. В текстовом поле **Идентификатор** введите URL-адрес в следующем формате: `https://<company name>.kronos.net/`

    b. В текстовом поле **URL-адрес ответа** введите URL-адрес в следующем формате: `https://<company name>.kronos.net/wfc/navigator/logonWithUID`.
...
1. Приложение Kronos ожидает утверждения SAML в определенном формате. Обратитесь в [службу поддержки Kronos](https://www.kronos.in/contact/en-in/form), чтобы определить правильный идентификатор пользователя, который будет сопоставляться в приложении. Необходимо выполнить рекомендации, касающиеся атрибута, который следует использовать для данного сопоставления.
    ...
    ![Настройка единого входа](./media/kronos-tutorial/tutorial_kronos_attribute.png)
...
1. В разделе **Атрибуты пользователя** диалогового окна **Единый вход** выполните следующие действия.
    ...
    b. В раскрывающемся списке **Электронная почта** выберите **user.userprincipalname**.

1. В разделе **Сертификат подписи SAML** щелкните **Metadata XML** (Метаданные XML) и сохраните файл метаданных на компьютере.

    ![Настройка единого входа](./media/kronos-tutorial/tutorial_kronos_certificate.png) 

1. Нажмите кнопку **Сохранить** .

    ![Настройка единого входа](./media/kronos-tutorial/tutorial_general_400.png)

1. Чтобы настроить единый вход на стороне **Kronos**, отправьте в [службу поддержки Kronos](https://www.kronos.in/contact/en-in/form) скачанный **XML-файл метаданных**. 
...
1. На **портале Azure** в области навигации слева щелкните значок **Azure Active Directory**.
    ...
    ![Создание тестового пользователя Azure AD](./media/kronos-tutorial/create_aaduser_01.png) 

1. Чтобы отобразить список пользователей, перейдите в раздел **Пользователи и группы** и щелкните **Все пользователи**.
    
    ![Создание тестового пользователя Azure AD](./media/kronos-tutorial/create_aaduser_02.png) 

1. Чтобы открыть диалоговое окно **Пользователь**, в верхней части диалогового окна щелкните **Добавить**.
 
    ![Создание тестового пользователя Azure AD](./media/kronos-tutorial/create_aaduser_03.png) 

1. На странице диалогового окна **Пользователь** выполните следующие действия.
 
    ![Создание тестового пользователя Azure AD](./media/kronos-tutorial/create_aaduser_04.png) 
...
1. В списке приложений выберите **Kronos**.
    ...
    ![Настройка единого входа](./media/kronos-tutorial/tutorial_kronos_app.png) 
