...
В этом руководстве показано, как активировать Управляемое удостоверение службы для виртуальной машины Linux и как с его помощью получить учетные данные SAS (подписанный URL-адрес) для хранилища. Для этого используются [учетные данные SAS службы](/azure/storage/common/storage-dotnet-shared-access-signature-part-1?toc=%2fazure%2fstorage%2fblobs%2ftoc.json#types-of-shared-access-signatures). 
...
> [!div class="checklist"]
> * Активация Управляемого удостоверения службы на виртуальной машине Linux 
...
В рамках этого руководства мы создадим виртуальную машину Linux. Управляемое удостоверение службы можно также активировать на имеющейся виртуальной машине.
...
3. Чтобы зарегистрировать и активировать Управляемое удостоверение службы, нажмите кнопку **Да**. Чтобы отключить его, нажмите кнопку "Нет".
