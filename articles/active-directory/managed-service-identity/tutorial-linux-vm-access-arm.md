...
В этом руководстве показано, как активировать Управляемое удостоверение службы для виртуальной машины Linux и использовать его для получения доступа к API Azure Resource Manager. Управляемыми удостоверениями службы автоматически управляет Azure. Они позволяют проходить аутентификацию в службах, поддерживающих аутентификацию Azure AD, без указания учетных данных в коде. Вы узнаете, как выполнять следующие задачи:
...
В рамках этого руководства мы создадим виртуальную машину Linux. Управляемое удостоверение службы можно также включить на существующей виртуальной машине.
