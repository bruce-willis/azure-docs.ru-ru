...
![Политика риска входа](./media/overview/1014.png "Политика риска входа")
...
* задать пользователей и группы, к которым следует применять политику;
    ...
    ![Политика риска входа](./media/overview/1015.png "Политика риска входа")
* задать пороговое значение уровня риска входа (низкий, средний или высокий уровень), при достижении которого активируется политика;
    ...
    ![Политика риска входа](./media/overview/1016.png "Политика риска входа")
* задать элементы управления, которые будут применяться при активации политики;  

    ![Политика риска входа](./media/overview/1017.png "Политика риска входа")
* переключить состояние политики;

    ![Регистрация в MFA](./media/overview/403.png "Регистрация в MFA")
* проверить и оценить влияние изменений до их активации.

    ![Политика риска входа](./media/overview/1018.png "Политика риска входа")
...
- В колонке **Azure AD Identity Protection** в разделе **Настройка** щелкните **Политика риска для входа в систему**.
    ...
    ![Политика риска для пользователя](./media/overview/1014.png "Политика риска для пользователя")



## <a name="users-flagged-for-risk"></a>Пользователи, помеченные для события риска

Все активные [события риска](../reports-monitoring/concept-risk-events.md), обнаруженные Azure Active Directory для отдельных пользователей, формируют логическое понятие, которое называется "Пользователи, находящиеся в группе риска". "Пользователь, находящийся в группе риска" означает, что безопасность учетной записи пользователя, возможно, была нарушена.

![Пользователи, помеченные для события риска](./media/overview/1200.png)
...
![Риски для пользователя](./media/overview/1031.png "Риски для пользователя")
...
![Действия](./media/overview/34.png "Действия")
...
1. В колонке **Azure AD Identity Protection** в разделе **Исследовать** щелкните **События риска**.
    ...
    ![Сброс пароля вручную](./media/overview/1002.png "Сброс пароля вручную")
2. В списке **Risk events** (События риска) выберите риск.

    ![Сброс пароля вручную](./media/overview/1003.png "Сброс пароля вручную")
3. В колонке риска щелкните правой кнопкой мыши пользователя.

    ![Сброс пароля вручную](./media/overview/1004.png "Сброс пароля вручную")
...
![Действия](./media/overview/2222.png "Действия")
...
![Политика](./media/overview/1005.png "Политика")

**Вот как можно открыть диалоговое окно настройки**.

1. В колонке **Azure AD Identity Protection** щелкните **Пользователи, находящиеся в группе риска**.

    ![Сброс пароля вручную](./media/overview/1006.png "Сброс пароля вручную")
2. В списке пользователей выберите пользователя по крайней мере с одним событием риска.

    ![Сброс пароля вручную](./media/overview/1007.png "Сброс пароля вручную")
3. В колонке пользователя щелкните **Сбросить пароль**.

    ![Сброс пароля вручную](./media/overview/1008.png "Сброс пароля вручную")
...
![Политика риска для пользователя](./media/overview/1009.png "Политика риска для пользователя")
...
* задать пользователей и группы, к которым следует применять политику;
    ...
    ![Политика риска для пользователя](./media/overview/1010.png "Политика риска для пользователя")
* задать пороговое значение уровня риска для пользователей (низкий, средний или высокий уровень), при достижении которого активируется политика;
    ...
    ![Политика риска для пользователя](./media/overview/1011.png "Политика риска для пользователя")
* задать элементы управления, которые будут применяться при активации политики;

    ![Политика риска для пользователя](./media/overview/1012.png "Политика риска для пользователя")
* переключить состояние политики;

    ![Политика риска для пользователя](./media/overview/403.png "Регистрация в MFA")
* проверить и оценить влияние изменений до их активации.

    ![Политика риска для пользователя](./media/overview/1013.png "Политика риска для пользователя")
...
![Политика риска для пользователя](./media/overview/1019.png "Политика риска для пользователя")
...
* задать пользователей и группы, к которым следует применять политику;
    ...
    ![Политика MFA](./media/overview/1020.png "Политика MFA")
* задать элементы управления, которые будут применяться при активации политики;  

    ![Политика MFA](./media/overview/1021.png "Политика MFA")
* переключить состояние политики;

    ![Политика MFA](./media/overview/403.png "Политика MFA")
* просматривать текущее состояние регистрации.

    ![Политика MFA](./media/overview/1022.png "Политика MFA")
...
- В колонке **Azure AD Identity Protection** в разделе **Настройка** щелкните **Регистрация в многофакторной проверке подлинности**.
    ...
    ![Политика MFA](./media/overview/1019.png "Политика MFA")
...
* [Уязвимости, обнаруживаемые защитой идентификации Azure Active Directory](vulnerabilities.md)

* [События риска Azure Active Directory](../active-directory-identity-protection-risk-events.md)

* [Уведомления защиты идентификации Azure Active Directory](notifications.md)

* [Тренировочное задание по защите идентификации Azure Active Directory](playbook.md)

* [Глоссарий по защите идентификации Azure Active Directory](glossary.md)

* [Sign-in experiences with Azure AD Identity Protection](flows.md) (Процедуры входа с защитой идентификации Azure AD)

* [Защита идентификации Azure Active Directory. Разблокирование пользователей](howto-unblock-user.md)

* [Начало работы с защитой идентификации Azure Active Directory и Microsoft Graph](graph-get-started.md)
