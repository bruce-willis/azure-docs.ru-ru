...
5. Войдите в Dropbox с помощью URL-адреса входа со страницы **единого входа**.
  ...
  ![Страница входа в Dropbox](media/configure-saas-apps/sign-in-to-dropbox.png)
...
2. Настройте единый вход, выполнив следующие действия:
  ...
  ![Настройте единый вход в Box.](media/configure-saas-apps/configure-box-sso.png)
