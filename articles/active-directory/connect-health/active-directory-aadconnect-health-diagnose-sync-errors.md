...
![Процедура диагностики ошибок синхронизации](./media/active-directory-aadconnect-health-sync-iidfix/IIdFixSteps.png)
...
![Диагностика ошибок синхронизации в сценарии с потерянным объектом при существовании пользователя](./media/active-directory-aadconnect-health-sync-iidfix/IIdFixOrphanedCase.png)
...
![Диагностика ошибок синхронизации в сценарии с потерянным объектом, если владельцем является один пользователь](./media/active-directory-aadconnect-health-sync-iidfix/IIdFixOrphanedCase.png)
