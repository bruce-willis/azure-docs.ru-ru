...
![Создание политики](./media/active-directory-conditional-access-app-sign-in-risk/130.png)
...
10. Щелкните **Условия**. 
    ...
    ![Элементы управления доступом](./media/active-directory-conditional-access-app-sign-in-risk/19.png)

11. На странице **Условия**:

    ![Уровень риска при входе](./media/active-directory-conditional-access-app-sign-in-risk/21.png)
