...
В **конце июля 2018 г.** в письмах Azure Active Directory (Azure AD) будут отображаться обновленный дизайн, изменения адреса электронной почты отправителя и отображаемого имени отправителя при их отправке из следующих служб.
