...
> * Многофакторная Идентификация Azure может использоваться на уровне каждого пользователя или поставщика проверки подлинности. Дополнительные сведения см. в статье [Что такое Многофакторная идентификация Azure?](../authentication/multi-factor-authentication.md)
>
...
* Ознакомьтесь с [руководством разработчика](../develop/azure-ad-developers-guide.md) по Azure Active Directory.
