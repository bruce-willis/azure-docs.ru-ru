...
- [Настройка политики условного доступа](conditional-access/app-based-mfa.md).

- [Перенос политик условного доступа](conditional-access/best-practices.md#policy-migration).
