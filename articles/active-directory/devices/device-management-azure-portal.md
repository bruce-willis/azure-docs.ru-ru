...
- **Пользователи могут присоединять устройства к Azure AD**. Этот параметр позволяет выбрать пользователей, которые могут [присоединять устройства](overview.md#azure-ad-joined-devices) к Azure AD. Значение этого параметра по умолчанию — **Все**.
