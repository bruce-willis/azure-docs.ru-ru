...
3. При наличии открытого инцидента в службе поддержки Майкрософт запишите его номер (он понадобится позже). Если вы еще не создали инцидент в службе поддержки и вам требуется помощь, следуйте указаниям [службы поддержки Майкрософт](https://support.microsoft.com/contactus), чтобы открыть новый инцидент.
