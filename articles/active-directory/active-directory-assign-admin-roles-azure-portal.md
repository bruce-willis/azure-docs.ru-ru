...
* **Администраторы устройств**: эту роль можно назначить только в качестве роли дополнительного локального администратора в [параметрах устройства](https://aad.portal.azure.com/#blade/Microsoft_AAD_IAM/DevicesMenuBlade/DeviceSettings/menuId/). Пользователи с этой ролью становятся администраторами локальных компьютеров на всех устройствах с Windows 10, присоединенных к Azure Active Directory. Они не могут управлять объектами устройств в Azure Active Directory.
...
* **Администратор Dynamics 365**: пользователи с этой ролью имеют глобальные разрешения в Microsoft Dynamics 365 при наличии этой службы, а также возможность управлять запросами в службу поддержки и отслеживать работоспособность служб. Дополнительные сведения см. в статье [Роли администраторов в Office 365](https://support.office.com/article/About-Office-365-admin-roles-da585eea-f576-4f55-a1e0-87090b6aaa9d).
...
| Может | Не может |
| --- | --- |
| Чтение всех сведений о каталоге<br>Создание регистраций приложений<br>Обновление свойств для регистраций приложений<br>Получение корпоративных приложений<br>Управление разрешениями для регистраций приложений<br>Удаление регистраций приложений<br>Управление параметрами единого входа для корпоративных приложений<br>Управление параметрами подготовки для корпоративных приложений<br>Управление параметрами самообслуживания для корпоративных приложений<br>Управление параметрами разрешений для корпоративных приложений<br>Управление доступом для приложений<br>Управление параметрами подготовки<br>Удаление корпоративных приложений<br>Согласие от общего имени на все запросы делегированных разрешений<br>Согласие от общего имени на все запросы разрешений приложений, кроме Azure AD Graph или Microsoft Graph<br>Управление параметрами прокси приложения<br>Доступ к параметрам служб<br>Мониторинг работоспособности служб<br>Управление запросами в службу поддержки<br>Просмотр членства в скрытых группах | Создание, изменение и удаление групп<br>Управление лицензиями пользователей<br>Использование синхронизации каталогов<br>Просмотр отчетов о входах и журналов аудита | 

### <a name="application-developer"></a>Разработчик приложения

| Может | Не может |
| --- | --- |
| Чтение всех сведений о каталоге<br>Создание регистраций приложений<br>Согласие от своего имени | Просмотр журналов входа и аудита<br>Просмотр членства в скрытых группах |
...
| Может | Не может |
| --- | --- |
| Чтение всех сведений о каталоге<br>Создание регистраций приложений<br>Обновление свойств для регистраций приложений<br>Получение корпоративных приложений<br>Управление разрешениями для регистраций приложений<br>Удаление регистраций приложений<br>Управление параметрами единого входа для корпоративных приложений<br>Управление параметрами подготовки для корпоративных приложений<br>Управление параметрами самообслуживания для корпоративных приложений<br>Управление параметрами разрешений для корпоративных приложений<br>Управление доступом для приложений<br>Управление параметрами подготовки<br>Удаление корпоративных приложений<br>Согласие от общего имени на все запросы делегированных разрешений<br>Согласие от общего имени на все запросы разрешений приложений, кроме Azure AD Graph или Microsoft Graph<br>Доступ к параметрам служб<br>Мониторинг работоспособности служб<br>Управление запросами в службу поддержки<br>Просмотр членства в скрытых группах | Управление параметрами прокси приложения<br>Создание, изменение и удаление групп<br>Управление лицензиями пользователей<br>Использование синхронизации каталогов<br>Просмотр отчетов о входах и журналов аудита |
...
### <a name="global-administrator"></a>глобального администратора;
| Может | Не может |
| --- | --- |
...
### <a name="password-administrator--helpdesk-administrator"></a>Администратор паролей и администратор службы технической поддержки
| Может | Не может |
| --- | --- |
...
### <a name="service-administrator"></a>администратора служб;
| Может | Не может |
| --- | --- |
...
### <a name="to-add-a-user-as-a-global-administrator"></a>Добавление пользователя как глобального администратора
...
3. Откройте страницу пользователя, которого требуется назначить глобальным администратором.

4. На панели команд выберите **Роль каталога**.

5. Выберите **Добавить роль**.

6. На странице роли каталога выберите роль **Глобальный администратор** и нажмите кнопку **Выбрать**, чтобы сохранить изменения.
...
* Дополнительные сведения об изменении администраторов для подписки Azure см. в статье [Добавление или изменение администраторов подписки Azure](../billing-add-change-azure-subscription-administrator.md).
...
* [Управление группами](fundamentals/active-directory-manage-groups.md)
