...
* **Читатели каталогов[](#directory-readers)**: это устаревшая роль, которая будет назначаться приложениям, не поддерживающим [платформу предоставления разрешений](active-directory-integrating-applications.md). Ее не следует назначать пользователям.
...
* **[Писатели в каталоги](#directory-writers)**: это устаревшая роль, которая будет назначаться приложениям, не поддерживающим [платформу предоставления разрешений](active-directory-integrating-applications.md). Ее не следует назначать пользователям.
