...
> [!NOTE]
> Дополнительные сведения о вариантах синхронизации см. в статье [Интеграция локальных каталогов с Azure Active Directory](whatis-hybrid-identity.md).
> 
> 
