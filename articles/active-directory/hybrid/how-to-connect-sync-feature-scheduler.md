...
Если в конфигурацию необходимо внести изменения, то следует отключить планировщик. Например, чтобы [настроить фильтрацию](how-to-connect-sync-configure-filtering.md) или [внести изменения в правила синхронизации](how-to-connect-sync-change-the-configuration.md).

Чтобы отключить планировщик, запустите `Set-ADSyncScheduler -SyncCycleEnabled $false`.

![Отключение планировщика](./media/how-to-connect-sync-feature-scheduler/schedulerdisable.png)
...
* Изменение [фильтрации](how-to-connect-sync-configure-filtering.md), в результате которого изменяется число включаемых объектов.
...
2. При использовании сборки до версии 1.1.281 остановка планировщика не означает, что действующий соединитель прекратит выполнение своей текущей задачи. Чтобы принудительно остановить соединитель, выполните следующие действия. ![StopAConnector](./media/how-to-connect-sync-feature-scheduler/stopaconnector.png)
...
[Имена соединителей](how-to-connect-sync-service-manager-ui-connectors.md) и [имена профилей выполнения](how-to-connect-sync-service-manager-ui-connectors.md#configure-run-profiles) можно найти в [пользовательском интерфейсе Synchronization Service Manager](how-to-connect-sync-service-manager-ui.md).

![Вызов профиля выполнения](./media/how-to-connect-sync-feature-scheduler/invokerunprofile.png)  
