...
Начиная со сборки 1.1 (февраль 2016 года) можно настроить в [планировщике](how-to-connect-sync-feature-scheduler.md) другой цикл синхронизации по сравнению с 30 минутами по умолчанию.
...
* Вы можете [изменить потоки атрибутов](how-to-connect-sync-change-the-configuration.md#other-common-attribute-flow-changes) , если прямые потоки атрибутов по умолчанию не подходят для вашей организации.
* Если вы не хотите [отправлять атрибут в потоке](how-to-connect-sync-change-the-configuration.md#do-not-flow-an-attribute) и вам требуется удалить существующие значения атрибута в Azure AD, для этого необходимо создать правило.
...
![Отключенное правило синхронизации](./media/how-to-connect-sync-best-practices-changing-default-configuration/exchangedisabledrule.png)
...
![Предупреждение стандартного правила](./media/how-to-connect-sync-best-practices-changing-default-configuration/warningoutofboxrule.png)

Выберите **Да** для создания копии правила. Затем будет открыто клонированное правило.  
![Клонированное правило](./media/how-to-connect-sync-best-practices-changing-default-configuration/clonedrule.png)
