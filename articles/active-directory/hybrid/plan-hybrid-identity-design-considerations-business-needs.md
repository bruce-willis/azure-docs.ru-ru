...
Некоторые компоненты, которые составляют архитектуру гибридной идентификации ![](./media/plan-hybrid-identity-design-considerations/hybrid-identity-architechture.png)
