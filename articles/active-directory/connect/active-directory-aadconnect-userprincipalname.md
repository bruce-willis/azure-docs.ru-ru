...
Дополнительные сведения см. в статье [Configuring Alternate Login ID](https://docs.microsoft.com/windows-server/identity/ad-fs/operations/configuring-alternate-login-id) (Настройка альтернативного имени пользователя) и разделе [Конфигурация входа в Azure AD](active-directory-aadconnect-get-started-custom.md#azure-ad-sign-in-configuration).
...
![Сценарий 1](media/active-directory-aadconnect-userprincipalname/example1.png)
...
![Сценарий 2](media/active-directory-aadconnect-userprincipalname/example2.png)
...
![Сценарий 3](media/active-directory-aadconnect-userprincipalname/example3.png)
...
![Сценарий 4](media/active-directory-aadconnect-userprincipalname/example4.png)
...
![Сценарий 5](media/active-directory-aadconnect-userprincipalname/example5.png)
