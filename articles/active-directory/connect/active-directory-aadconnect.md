...
> - Корпорация Майкрософт настоятельно рекомендует не синхронизировать пользователей с ролями администратора в Azure Active Directory.
