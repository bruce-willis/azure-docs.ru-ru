...
Действия по исследованию можно привязать к [уведомлениям](identity-protection/notifications.md) , которые отправляет служба защиты идентификации Azure Active Directory по электронной почте.
...
* [Восстановление входа, представлявшего риск](identity-protection/flows.md#risky-sign-in-recovery)
* [Блокировка входа, представляющего риск](identity-protection/flows.md#risky-sign-in-blocked)  
* [Sign-in experiences with Azure AD Identity Protection](identity-protection/flows.md) (Процедуры входа с защитой идентификации Azure AD)  
...
- В колонке **Azure AD Identity Protection** в разделе **Настройка** щелкните **Политика риска для входа в систему**.
    ...
    ![Политика риска для пользователя](./media/active-directory-identityprotection/1014.png "Политика риска для пользователя")
...
![Политика риска для пользователя](./media/active-directory-identityprotection/1009.png "Политика риска для пользователя")
...
* задать пользователей и группы, к которым следует применять политику;
    ...
    ![Политика риска для пользователя](./media/active-directory-identityprotection/1010.png "Политика риска для пользователя")
* задать пороговое значение уровня риска для пользователей (низкий, средний или высокий уровень), при достижении которого активируется политика;
    ...
    ![Политика риска для пользователя](./media/active-directory-identityprotection/1011.png "Политика риска для пользователя")
* задать элементы управления, которые будут применяться при активации политики;

    ![Политика риска для пользователя](./media/active-directory-identityprotection/1012.png "Политика риска для пользователя")
* переключить состояние политики;

    ![Политика риска для пользователя](./media/active-directory-identityprotection/403.png "Регистрация в MFA")
* проверить и оценить влияние изменений до их активации.

    ![Политика риска для пользователя](./media/active-directory-identityprotection/1013.png "Политика риска для пользователя")
...
* [Восстановление скомпрометированной учетной записи](identity-protection/flows.md#compromised-account-recovery).  
* [Скомпрометированная учетная запись заблокирована](identity-protection/flows.md#compromised-account-blocked).  
...
![Политика риска для пользователя](./media/active-directory-identityprotection/1019.png "Политика риска для пользователя")
...
* [Регистрация с многофакторной проверкой подлинности](identity-protection/flows.md#multi-factor-authentication-registration).  
* [Процедуры входа с защитой идентификации Azure AD](identity-protection/flows.md).  
...
* [Уязвимости, обнаруживаемые защитой идентификации Azure Active Directory](identity-protection/vulnerabilities.md)

* [События риска Azure Active Directory](active-directory-identity-protection-risk-events.md)

* [Уведомления защиты идентификации Azure Active Directory](identity-protection/notifications.md)

* [Тренировочное задание по защите идентификации Azure Active Directory](identity-protection/playbook.md)

* [Глоссарий по защите идентификации Azure Active Directory](identity-protection/glossary.md)

* [Sign-in experiences with Azure AD Identity Protection](identity-protection/flows.md) (Процедуры входа с защитой идентификации Azure AD)

* [Защита идентификации Azure Active Directory. Разблокирование пользователей](identity-protection/howto-unblock-user.md)

* [Начало работы с защитой идентификации Azure Active Directory и Microsoft Graph](identity-protection/graph-get-started.md)
