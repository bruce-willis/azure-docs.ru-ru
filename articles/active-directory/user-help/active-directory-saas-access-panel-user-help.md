---
title: Устранение неполадок, возникающих при использовании портала "Мои приложения" и получении доступа к нему в Azure AD | Документы Майкрософт
