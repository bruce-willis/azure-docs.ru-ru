...
6. Утвердите уведомление для активации приложения с помощью приложения Microsoft Authenticator.
    ...
    >[!Note]
    >Если ваша организация позволяет это сделать, вы также получите код подтверждения вместе с уведомлением от приложения Microsoft Authenticator. Если вы хотите сделать код своим методом по умолчанию, следуйте инструкциям в статье [Управление сведениями для защиты](security-info-setup-auth-app.md).
