...
![Назначение группе без необходимых компонентов](./media/licensing-groups-resolve-problems/group-prerequisite-required.png)
...
![Группа с назначенными необходимыми компонентами](./media/licensing-groups-resolve-problems/group-addon-with-prerequisite.png)
