...
- Лицензирование на основе группы не регистрирует ошибки, когда лицензию невозможно назначить пользователю из-за дублирующейся конфигурации прокси-адреса в Exchange Online; во время назначения лицензии такие пользователи пропускаются. Дополнительные сведения о выявлении и устранении этой проблемы см. в [ этом разделе](licensing-groups-resolve-problems.md#license-assignment-fails-silently-for-a-user-due-to-duplicate-proxy-addresses-in-exchange-online).
