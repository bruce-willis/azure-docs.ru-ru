...
![Списки ACL в Data Lake Storage 1-го поколения](./media/data-lake-store-access-control/data-lake-store-acls-1.png)

Списки ACL для доступа и ACL по умолчанию имеют одинаковую структуру.

![Списки ACL в Data Lake Storage 1-го поколения](./media/data-lake-store-access-control/data-lake-store-acls-2.png)
...
![Списки ACL в Data Lake Storage 1-го поколения](./media/data-lake-store-access-control/data-lake-store-acls-3.png)
...
![Списки ACL в Data Lake Storage 1-го поколения](./media/data-lake-store-access-control/data-lake-store-acls-4.png)
...
![Списки ACL в Data Lake Storage 1-го поколения](./media/data-lake-store-access-control/data-lake-store-acls-5.png)
...
![Списки ACL в Data Lake Storage 1-го поколения](./media/data-lake-store-access-control/data-lake-store-acls-6.png)
...
В колонке **Обозреватель данных** учетной записи Data Lake Storage 1-го поколения щелкните **Доступ**, чтобы просмотреть списки ACL для файла или папки, просматриваемых в обозревателе данных. При выборе команды **Доступ** вы получите списки ACL для папки **catalog** из учетной записи **mydatastore**.

![Списки ACL в Data Lake Storage 1-го поколения](./media/data-lake-store-access-control/data-lake-store-show-acls-1.png)
...
![Списки ACL в Data Lake Storage 1-го поколения](./media/data-lake-store-access-control/data-lake-store-show-acls-simple-view.png)
...
![Списки ACL в Data Lake Storage 1-го поколения](./media/data-lake-store-access-control/data-lake-store-show-acls-advance-view.png)
...
В учетной записи Azure Data Lake Storage 1-го поколения предусмотрено несколько ролей Azure, в том числе:

* владельцы;
* участники;
* читатели;

Каждому пользователю с ролью **Владелец** учетной записи Data Lake Storage 1-го поколения автоматически присваивается статус суперпользователя этой учетной записи. Дополнительные сведения см. в статье об [управлении доступом на основе ролей](../role-based-access-control/role-assignments-portal.md).
...
При создании нового элемента файловой системы служба Data Lake Storage 1-го поколения присваивает значение группе владельцев.
...
На рисунке ниже показан алгоритм проверки доступа к учетным записям Data Lake Storage 1-го поколения.

![Алгоритм проверки доступа для списков ACL Data Lake Storage 1-го поколения](./media/data-lake-store-access-control/data-lake-store-acls-algorithm.png)
...
![Списки ACL в Data Lake Storage 1-го поколения](./media/data-lake-store-access-control/data-lake-store-acls-mask-1.png)
...
![Списки ACL в Data Lake Storage 1-го поколения](./media/data-lake-store-access-control/data-lake-store-acls-mask-2.png)

Вот как представлена маска файла или папки на портале Azure:

![Списки ACL в Data Lake Storage 1-го поколения](./media/data-lake-store-access-control/data-lake-store-show-acls-mask-view.png)
...
![Списки ACL в Data Lake Storage 1-го поколения](./media/data-lake-store-access-control/data-lake-store-acls-child-items-1.png)
...
![Списки ACL в Data Lake Storage 1-го поколения](./media/data-lake-store-access-control/data-lake-store-acls-child-items-2.png)

## <a name="advanced-topics-for-understanding-acls-in-data-lake-storage-gen1"></a>Темы для углубленного изучения принципов работы со списками ACL в Data Lake Storage 1-го поколения

Ниже представлено несколько дополнительных разделов, в которых подробно описано, как определяются списки ACL для файлов или папок в хранилище Data Lake Storage 1-го поколения.
...
В системе HDFS umask, как правило, является параметром конфигурации уровня сайта, управляемым администраторами. Data Lake Storage 1-го поколения использует маску **umask уровня учетной записи**, которую нельзя изменить. В следующей таблице показана работа umask в Data Lake Storage 1-го поколения.
...
![Списки ACL в Data Lake Storage 1-го поколения](./media/data-lake-store-access-control/data-lake-store-acls-umask.png)

### <a name="the-sticky-bit"></a>Бит фиксации

Бит фиксации является расширенной функцией файловой системы POSIX. В контексте Data Lake Storage 1-го поколения потребность в использовании бита фиксации маловероятна.

В приведенной ниже таблице показано, как работает бит фиксации в Data Lake Storage 1-го поколения.
...
Ниже приведены ответы на часто задаваемые вопросы, возникающие при работе со списками ACL в Data Lake Storage 1-го поколения.
...
| маска | umask|
|------|------|
| Свойство **маски** доступно в любом файле или папке. | **Umask** является свойством учетной записи Data Lake Storage 1-го поколения. Таким образом, в Data Lake Storage 1-го поколения возможно только одно свойство umask.    |
