...
Эта операция основана на вызове REST API, определенном [здесь](https://docs.microsoft.com/en-us/rest/api/datalakestore/accounts/create).
...
Эта операция основана на вызове REST API, определенном [здесь](https://docs.microsoft.com/en-us/rest/api/datalakestore/accounts/delete).
