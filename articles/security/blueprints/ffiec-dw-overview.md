---
title: Схема безопасности и соответствия требованиям Azure. Хранилище данных для FFIEC
description: Схема безопасности и соответствия требованиям Azure. Хранилище данных для FFIEC
services: security
author: meladie
...
ms.locfileid: "37906370"
---
# <a name="azure-security-and-compliance-blueprint-data-warehouse-for-ffiec-financial-services"></a>Схема безопасности и соответствия требованиям Azure. Хранилище данных для финансовых служб FFIEC

## <a name="overview"></a>Обзор

Эта схема безопасности и соответствия требованиям Azure является руководством по развертыванию архитектуры хранилища данных в Azure, подходящей для сбора, хранения и получения финансовых данных, регулируемых Федеральным советом по надзору за финансовыми учреждениями (Federal Financial Institution Examination Council, FFIEC).
...
![Схема эталонной архитектуры хранилища данных для FFIEC](images/ffiec-dw-architecture.png "Схема эталонной архитектуры хранилища данных для FFIEC")
...
Схему потока данных для этой эталонной архитектуры можно [скачать](https://aka.ms/ffiec-dw-tm/) или просмотреть ниже. Используя эту модель, клиенты могут выявить зоны потенциального риска в инфраструктуре системы при внесении изменений.

![Модель рисков хранилища данных для FFIEC](images/ffiec-dw-threat-model.png "Модель рисков хранилища данных для FFIEC")
...
-   [Фабрика данных Azure](https://docs.microsoft.com/azure/data-factory/introduction) — это управляемая облачная служба, созданная для сложных гибридных проектов извлечения, преобразования и загрузки и интеграции данных. Фабрика данных Azure обладает возможностями, помогающими отслеживать и находить финансовые данные, и содержит средства визуализации и мониторинга для определения времени поступления данных и их источника. С помощью фабрики данных Azure клиенты могут создавать и планировать управляемые данными рабочие процессы (конвейеры), которые принимают данные из разнородных хранилищ данных. Эти конвейеры позволяют клиентам принимать данные как из внутренних, так и из внешних источников. Затем клиенты могут обрабатывать данные и преобразовывать их для вывода в хранилища данных, такие как хранилище данных SQL Azure.
