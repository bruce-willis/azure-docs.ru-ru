...
- Готовы начать тестирование приложений, размещенных в Microsoft Azure, на проникновение? Если да, перейдите на страницу [Penetration Testing Rules of Engagement](https://www.microsoft.com/msrc/pentest-rules-of-engagement?rtc=2) (Правила регистрации на выполнение тестов на проникновение) и заполните форму уведомления о тестировании.
