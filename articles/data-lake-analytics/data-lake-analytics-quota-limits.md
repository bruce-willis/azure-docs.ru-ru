...
ms.locfileid: "34623984"
---
# <a name="adjust-quotas-and-limits-in-azure-data-lake-analytics"></a>Настройка квот и ограничений в Azure Data Lake Analytics

Узнайте, как настроить и увеличить квоту в учетных записях Azure Data Lake Analytics (ADLA). Зная ее ограничения, вы сможете понять поведение задания U-SQL. Все квоты являются мягкими, то есть максимальное ограничение можно увеличить, обратившись в службу поддержки Azure.
