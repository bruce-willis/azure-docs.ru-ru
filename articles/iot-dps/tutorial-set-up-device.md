...
4. Создайте пакет SDK для платформы разработки на основании механизмов аттестации, которые будут использоваться. Используйте одну из следующих команд (также обратите внимание на две точки в конце строки каждой команды). По завершении CMake создает подкаталог `/cmake` с содержимым для вашего устройства.
