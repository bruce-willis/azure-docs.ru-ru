...
Сертификат устройства можно добавить в Центр Интернета вещей вручную. Сертификат также можно автоматически подготовить с помощью экземпляра службы подготовки устройств. В этой статье мы предположим, что используется экземпляр службы подготовки для поддержки автоматической подготовки.
...
3. После того как скомпрометированный сертификат был удален из службы подготовки, перейдите в Центр Интернета вещей и удалите регистрацию устройства, связанную с этим сертификатом.     
...
1. Щелкните вкладку **Сертификаты** для своего экземпляра службы подготовки.
...
4. Щелкните вкладку **Управление регистрациями** для своего экземпляра службы подготовки и щелкните список **Группы регистрации**. Щелкните название своей группы регистрации в списке.
...
6. Когда скомпрометированный сертификат будет удален из службы подготовки, перейдите к связанному Центру Интернета вещей, который содержит скомпрометированные регистрации устройств, и удалите регистрации, связанные с этим сертификатом.
...
3. Когда скомпрометированный сертификат будет удален из службы подготовки, перейдите к связанному Центру Интернета вещей, который содержит регистрацию устройства, и удалите регистрацию, связанную с этим сертификатом.
...
2. Щелкните вкладку **Управление регистрациями** для своего экземпляра службы подготовки и щелкните список **Группы регистрации**. Щелкните название своей группы регистрации в списке.
...
4. Позже, когда срок действия первичного сертификата истечет, щелкните вкладку **Сертификаты** для своего экземпляра службы подготовки. Выберите сертификат с истекшим сроком действия в списке и нажмите кнопку **Удалить**. Подтвердите удаление, введя имя сертификата и нажав кнопку **ОК**.
