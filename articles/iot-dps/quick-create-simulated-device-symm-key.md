...
Хотя в этой статье показано, как выполнить подготовку с использованием отдельной регистрации, можно использовать те же процедуры с группами регистраций. Единственная разница заключается в том, что нужно использовать производный ключ устройства с уникальным идентификатором регистрации. В группах регистрации симметричный ключ регистрации непосредственно не используется. Хотя группы регистрации с использованием симметричных ключей не ограничиваются устаревшими устройствами, [статья о подготовке к работе устаревших устройств с использованием аттестации с помощью симметричных ключей](how-to-legacy-device-symm-key.md) содержит пример группы регистрации. Дополнительные сведения см. в разделе [о групповых регистрациях](concepts-symmetric-key-attestation.md#group-enrollments).
