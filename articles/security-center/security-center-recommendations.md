...
| [Включение адаптивного управления приложениями](security-center-adaptive-application.md) | Рекомендуется применять адаптивное управление приложениями на виртуальных машинах Windows. Эта функция находится на этапе предварительной версии и доступна в центре безопасности Azure уровня "Стандартный". Дополнительные сведения о ценовых категориях центра безопасности см. на странице [Цены](security-center-pricing.md). |
