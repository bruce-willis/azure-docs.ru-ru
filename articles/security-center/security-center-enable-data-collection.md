...
2. В раскрывающемся меню выберите рабочую область для хранения собранных данных.
  ...
  > [!NOTE]
  > В этом раскрывающемся меню доступны все рабочие области во всех ваших подписках. Ознакомьтесь с разделом [Выбор рабочих областей между подписками](security-center-enable-data-collection.md#cross-subscription-workspace-selection), чтобы получить дополнительную информацию.
  >
  >
...
При выборе рабочей области для хранения данных доступны все рабочие области во всех ваших подписках. Выбор рабочих областей между подписками позволяет собирать данные из виртуальных машин, работающих в разных подписках, и сохранять их в рабочей области на свой выбор. Данная возможность работает с виртуальными машинами под управлением Linux и Windows.

> [!NOTE]
> Выбор рабочих областей между подписками является частью уровня "Бесплатный" центра безопасности Azure. Дополнительные сведения о ценовых категориях центра безопасности см. на странице [Цены](security-center-pricing.md).
>
>
