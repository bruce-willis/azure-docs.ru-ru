...
### <a name="download-azure-storage-explorer-110"></a>Скачивание Обозревателя службы хранилища Azure 1.1.0
- [Обозреватель службы хранилища Azure 1.1.0 для Windows](https://go.microsoft.com/fwlink/?LinkId=708343)
- [Обозреватель службы хранилища Azure 1.1.0 для Mac](https://go.microsoft.com/fwlink/?LinkId=708342)
- [Обозреватель службы хранилища Azure 1.1.0 для Linux](https://go.microsoft.com/fwlink/?LinkId=722418)
...
* Получение подписок для учетных записей государственных организаций США было нарушено. Эта ошибка исправлена. [№ 61](https://github.com/Microsoft/AzureStorageExplorer/issues/61)
* Время истечения срока для политик доступа неправильно сохранялось. Эта ошибка исправлена. [№ 50](https://github.com/Microsoft/AzureStorageExplorer/issues/50)
* При создании URL-адреса SAS для элемента в контейнере имя элемента не добавлялось к URL-адресу. Эта ошибка исправлена. [№ 44](https://github.com/Microsoft/AzureStorageExplorer/issues/44)
...
* Для некоторых действий нажатие кнопки "Отмена" срабатывало не всегда. Эта ошибка исправлена. [№ 125](https://github.com/Microsoft/AzureStorageExplorer/issues/125)
* Для некоторых действий скорость передачи была неправильной. Эта ошибка исправлена. [№ 124](https://github.com/Microsoft/AzureStorageExplorer/issues/124)
