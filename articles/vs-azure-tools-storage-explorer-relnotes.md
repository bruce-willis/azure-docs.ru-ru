...
ms.locfileid: "38990903"
---
# <a name="microsoft-azure-storage-explorer-release-notes"></a>Заметки о выпуске Обозревателя службы хранилища Microsoft Azure

Эта статья содержит заметки о выпуске Обозревателя службы хранилища Azure 1.2.0, а также заметки о выпусках предыдущих версий.
...
### <a name="download-azure-storage-explorer-130"></a>Загрузка Обозревателя службы хранилища Azure 1.3.0
- [Обозреватель службы хранилища Azure 1.3.0 для Windows](https://go.microsoft.com/fwlink/?LinkId=708343)
- [Обозреватель службы хранилища Azure 1.3.0 для Mac](https://go.microsoft.com/fwlink/?LinkId=708342)
- [Обозреватель службы хранилища Azure 1.3.0 для Linux](https://go.microsoft.com/fwlink/?LinkId=722418)
