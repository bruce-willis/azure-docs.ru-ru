...
1. Добавьте новый пакет. Заполните раздел **Сведения о пакете** в приведенной ниже форме.
   ...
   * **Параметры политики.** Примените [Политику Azure](../azure-policy/azure-policy-introduction.md) к управляемому приложению, чтобы указать требования соответствия для развернутых решений. Выберите нужную политику из доступных вариантов. В качестве **параметров политики** укажите строку JSON со значениями параметров. Дополнительные сведения об определении политик и формате значений параметров см. в описании [примеров политик Azure](../azure-policy/json-samples.md).
