...
- **Компьютеры для обновления**. Выберите виртуальные машины, которые нужно обновить. Сведения о готовности компьютера отображаются в столбце **Готовность к обновлению агента**. Вы можете просмотреть состояние работоспособности компьютера перед планированием развертывания обновлений.
...
> [!WARNING]
> Для обновлений, требующих перезагрузки, виртуальная машина перезапускается автоматически.
