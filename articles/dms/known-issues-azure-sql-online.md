...
### <a name="data-migration-errors-do-not-provide-additional-details-on-the-database-detailed-status-blade"></a>Ошибки перемещения данных не предоставляют дополнительные сведения в колонке подробностей о состоянии базы данных.
