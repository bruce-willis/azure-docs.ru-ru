...
В этой статье описано, как компания Contoso оценивает локальное приложение SmartHotel для переноса в Azure.
