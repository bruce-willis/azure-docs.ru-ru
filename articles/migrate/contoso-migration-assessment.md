...
- Виртуальные машины должны иметь прямое подключение к Интернету.  
        ...
        Если виртуальные машины не имеют подключения к Интернету, на них должен быть установлен [шлюз Oxy Gateway](../log-analytics/log-analytics-oms-gateway.md) Azure Log Analytics.
...
Теперь у компании Contoso появилась возможность импортировать загруженный файл на экземпляр vCenter Server и подготовить сервер конфигурации виртуальной машины.
...
Чтобы просмотреть зависимости между виртуальными машинами, к которым она хочет получить доступ, компания Contoso загружает и устанавливает агенты на виртуальных машинах приложений. Компания Contoso устанавливает агенты на всех виртуальных машинах для своих приложений, как для Windows, так и для Linux.
