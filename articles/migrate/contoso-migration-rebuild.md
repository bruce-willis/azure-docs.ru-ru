...
[Статья 9. Рефакторинг приложения в веб-приложениях Azure и базе данных SQL Azure](contoso-migration-refactor-web-app-sql.md) | В статье демонстрируется, как Contoso переносит приложение SmartHotel360 в веб-приложение Azure, а базу данных приложения — в экземпляр SQL Server Azure. | Доступна
...
[Статья 12. Повторное проектирование приложения для использования контейнеров Azure и Базы данных SQL](contoso-migration-rearchitect-container-sql.md) | В статье демонстрируется, как Contoso переносит и перепроектирует приложение SmartHotel360 в Azure. Специалисты компании перепроектируют веб-уровень приложения в контейнер Windows и переносят базу данных приложения в Базу данных SQL Azure. | Доступна
Статья 13. Повторное создание приложения в Azure | В статье описано, как Contoso повторно создает свое приложение SmartHotel360, используя ряд возможностей и служб Azure, включая Службу приложений Azure, Azure Kubernetes, Функции Azure, Cognitive Services и Cosmos DB. | Эта статья
...
> * **Шаг 6. Публикация внешнего интерфейса**. Специалисты компании публикуют приложение SmartHotel360 в Службе приложений Azure и приложении-функции, которое будет вызываться службой домашних животных.
...
4. В разделе **сборки и выпуска** специалисты компании создают новое определение с использованием VSTS Git в качестве источника из импортированного репозитория. 
...
На заключительном этапе специалисты компании Contoso публикуют приложение SmartHotel360 в Службе приложений Azure и в приложении-функции, которое будет вызываться службой домашних животных.
