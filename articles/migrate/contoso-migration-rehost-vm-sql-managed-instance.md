...
- Приложение SmartHotel расположено на нескольких виртуальных машинах (**WEBVM** и **SQLVM**), находящихся на узле VMware ESXi версии 6.5 (**contosohost1.contoso.com**). 
...
- Управляемый экземпляр SQL поддерживает агент SQL Server, что важно для приложения SmartHotel. Компании Contoso нужна эта совместимость, так как без нее придется заново проектировать планы обслуживания приложения.
