...
Статья 5. Перемещение приложения в виртуальные машины Azure | Специалисты компании Contoso переносят виртуальные машины приложения SmartHotel на виртуальные машины Azure с помощью службы Site Recovery. | Эта статья
...
- **Минимизация рисков**. Приложение SmartHotel критически важно для бизнеса компании Contoso. Ей нужно без рисков перенести приложение в Azure.
