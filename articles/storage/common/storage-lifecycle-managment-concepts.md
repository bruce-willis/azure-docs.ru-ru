...
Иногда данные необходимо удалять через несколько дней или месяцев после их создания, чтобы снизить затраты на хранение или соблюдать требования законодательства. Вы можете настроить политику управления жизненным циклом, чтобы удалять устаревшие данные при достижении определенного возраста. В следующем примере представлена политика, которая удаляет все BLOB-объекты (префикс не указан) старше 365 дней.
