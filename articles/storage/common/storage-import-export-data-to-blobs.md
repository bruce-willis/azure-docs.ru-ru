...
5. В разделе **Сводка** сделайте следующее:
    ...
    ![Создание задания импорта — шаг 4](./media/storage-import-export-data-to-blobs/import-to-blob4.png)
