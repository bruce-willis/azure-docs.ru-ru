...
**URI запроса**: `/?comp=list`. Создается из конечной точки учетной записи хранилища BLOB-объектов https://myaccount.blob.core.windows.net/?comp=list и строки ресурса `http://myaccount.blob.core.windows.net`.
