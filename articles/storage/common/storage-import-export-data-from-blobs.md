...
3. В разделе **Сведения о задании** сделайте следующее:
    ...
    - Выберите учетную запись хранения, в которой хранятся данные для экспорта. 
...
5. В разделе **Сводка** сделайте следующее:
    ...
    - Чтобы отправить диски в Azure, запишите название задания и предоставленный адрес центра обработки данных Azure. 
