...
description: Функция "Шифрование службы хранилища Azure" позволяет шифровать данные хранилища BLOB-объектов Azure, службы файлов Azure, хранилища очередей Azure и хранилища таблиц Azure на стороне службы при сохранении и расшифровывать данные при извлечении с помощью управляемых клиентом ключей.
services: storage
author: lakasa
manager: jeconnoc
ms.service: storage
