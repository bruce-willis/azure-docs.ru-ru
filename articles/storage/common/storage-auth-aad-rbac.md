...
1. Войдите в свою учетную запись хранения на [портале Azure](https://azure.portal.com/).
...
1. Перейдите в свою учетную запись хранения на [портале Azure](https://azure.portal.com/) и откройте **Обзор** для учетной записи.
