...
> |data.api|строка|Имя операции API, которая активировала это событие. Для событий BlobCreated это значение — PutBlob, PutBlockList или CopyBlob. Для событий BlobDeleted — DeleteBlob. Эти значения совпадают с именами API, которые присутствуют в журналах диагностики службы хранилища Azure. Ознакомьтесь со статьей [Storage Analytics Logged Operations and Status Messages](https://docs.microsoft.com/rest/api/storageservices/storage-analytics-logged-operations-and-status-messages) (Операции с протоколированием и сообщения о состоянии Аналитики Службы хранилища).|
