...
Если есть вероятность, что данные могут быть случайно изменены или удалены приложением или другим пользователем учетной записи хранения, мы рекомендуем включить обратимое удаление. Обратимое удаление является одной из частей стратегии защиты данных и может помочь предотвратить случайную потерю данных.
...
* [Что делать в случае простоя службы хранилища Azure](../common/storage-disaster-recovery-guidance.md?toc=%2fazure%2fstorage%2fblobs%2ftoc.json)
