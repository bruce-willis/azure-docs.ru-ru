...
Эта ошибка возникает, если при создании облачной конечной точки вы указали общий файловый ресурс Azure, содержащий некоторые данные. Выполнение задания обнаружения изменений, которое проверит наличие изменений в общей папке Azure, запланировано единожды каждые 24 часа.  Время завершения задания зависит от размера пространства имен в общей папке Azure.  После завершения эта ошибка должна исчезнуть.
