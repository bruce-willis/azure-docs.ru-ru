...
|----|----------------------|--------------|------------------|
| Накопительный пакет обновления за июнь | 3.2.0.0 | 15 августа 2018 г. | Поддерживается (рекомендуемая версия) |
| Общедоступная версия | 3.1.0.0 | 19 июля 2018 г. | Поддерживаются |
| Накопительный пакет обновления за июнь | 3.0.13.0 | 29 июня 2018 г. | Срок действия версии агента истечет 1 октября 2018 г. |
| Обновление 2 | 3.0.12.0 | 22 мая 2018 г. | Срок действия версии агента истечет 1 октября 2018 г. |
| Накопительный пакет обновления за апрель | 2.3.0.0 | 8 мая 2018 г. | Срок действия версии агента истечет 1 октября 2018 г. |
| Накопительный пакет обновления за март | 2.2.0.0 | 12 марта 2018 г. | Срок действия версии агента истечет 1 октября 2018 г. |
| Накопительный пакет обновления за февраль | 2.1.0.0 | 28 февраля 2018 г. | Срок действия версии агента истечет 1 октября 2018 г. |
| Обновление 1 | 2.0.11.0 | 8 февраля 2018 г. | Срок действия версии агента истечет 1 октября 2018 г. |
| Накопительный пакет обновления за январь | 1.4.0.0 | 8 января 2018 г. | Срок действия версии агента истечет 1 октября 2018 г. |
| Накопительный пакет обновления за ноябрь | 1.3.0.0 | 30 ноября 2017 г. | Срок действия версии агента истечет 1 октября 2018 г. |
| Накопительный пакет обновления за октябрь | 1.2.0.0 | 31 октября 2017 г. | Срок действия версии агента истечет 1 октября 2018 г. |
| Первоначальный выпуск предварительной версии | 1.1.0.0 | 26 сентября 2017 г. | Срок действия версии агента истечет 1 октября 2018 г. |
...
## <a name="agent-version-30130"></a>Версия агента 3.0.13.0
Следующие заметки о выпуске предназначены для версии агента службы "Синхронизация файлов Azure" 3.0.13.0 (выпущено 29 июня 2018 года). Они являются дополнением к заметкам о выпуске для версии 3.0.12.0.

Этот выпуск включает следующее исправление:
- При добавлении сервера в существующую группу синхронизации возникает ошибка синхронизации, если точки повторного анализа расположены в конечной точке на сервере.
