...
Сейчас максимальный размер общего файлового ресурса Azure — 5 ТиБ. Из-за этого ограничения при развертывании файлового ресурса Azure следует учитывать ожидаемый рост объема данных. Обратите внимание, что учетная запись хранения Azure может хранить несколько файловых ресурсов общим объемом 500 Тебибайт.
