...
## <a name="cannot-connect-or-mount-an-azure-file-share"></a>Не удалось подключиться к общей папке Azure или подключить его
...
### <a name="cause"></a>Причина:
По умолчанию при подключении файловых ресурсов Azure в Linux с помощью CIFS не поддерживается использование символьных ссылок. Вы увидите примерно такую ошибку:
```
ln -s linked -n t
