...
При наличии кластера HDInsight с доступом к хранилищу Azure Data Lake поколения 2 (предварительная версия) можно использовать такие средства экосистемы Hadoop, как DistCp, для копирования данных **из хранилища кластера HDInsight (WASB) в учетную запись с поддержкой хранилища Azure Data Lake поколения 2 и обратно**. В этой статье содержатся инструкции по использованию средства DistCp.

## <a name="prerequisites"></a>предварительным требованиям

* **Подписка Azure**. См. страницу [бесплатной пробной версии Azure](https://azure.microsoft.com/pricing/free-trial/).
* **Учетная запись службы хранилища Azure с включенной функцией хранилища Azure Data Lake (предварительная версия)**. Инструкции по ее созданию см. в [этой статье](quickstart-create-account.md).
