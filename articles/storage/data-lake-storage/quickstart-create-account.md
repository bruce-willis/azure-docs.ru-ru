...
Azure CLI также можно установить и применять локально. Для этого руководства требуется Azure CLI 2.0.38 или более поздней версии. Чтобы узнать версию, выполните команду `az --version`. Если вам необходимо выполнить установку или обновление, см. статью [Установка Azure CLI 2.0](/cli/azure/install-azure-cli).
...
> [!NOTE]
> Иерархическое пространство имен включена только в восточной части США, восточной части США 2, западной части США, западной части США 2, центрально-западной части США, Северной Европе, Западной Европе, Юго-Восточной Азии и Восточной Австралии. Убедитесь, что при создании учетной записи хранения указано одно из этих расположений.
