...
При создании приложения логики для сообщений служебной шины настройте для него использование [PeekLock](../service-bus-messaging/service-bus-messaging-overview.md#queues) для доступа к группе сообщений. При использовании PeekLock приложение логики может проверять каждое сообщение перед завершением или отменой. Такой подход защищает от случайной потери сообщений.
