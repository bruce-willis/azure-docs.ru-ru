---
title: Решения корпоративной интеграции с использованием Azure Logic Apps | Документы Майкрософт
description: Сведения о том, как создавать автоматизированные рабочие процессы и бизнес-процессы, интегрирующие данные, службы, приложения и системы на предприятиях и в организациях, с помощью Logic Apps. Создавайте решения для интеграции данных, систем, корпоративных приложений (EAI) и сценариев оркестрации.
services: logic-apps
...
[Logic Apps](https://azure.microsoft.com/services/logic-apps) помогает создавать решения, которые интегрируют приложения, данные, системы и службы на разных предприятиях или в организациях путем автоматизации задач и бизнес-процессов в виде [рабочих процессов](#logic-app-concepts). Logic Apps — облачная служба в Azure, которая упрощает разработку и создание масштабируемых решений интеграции приложений (EAI), данных, систем и реализации взаимодействия типа "бизнес-бизнес" в облаке, локальных системах или в обеих средах.
...
Для создания решений интеграции с приложениями логики воспользуйтесь растущей коллекцией соединителей, включающей [более 200 соединителей](../connectors/apis-list.md). Эта коллекция содержит соединители для других служб Azurе, таких как служебная шина, функции и хранилище, а также соединители для SQL, Office 365, Dynamics, BizTalk, Salesforce, SAP, Oracle DB, общих папок и многие другие. Эти [соединители](#logic-app-concepts) предоставляют [триггеры](#logic-app-concepts) и [действия](#logic-app-concepts), позволяющие создавать приложения логики, которые безопасно обращаются к данным и обрабатывают их в режиме реального времени.
...
Например, при использовании Microsoft BizTalk Server приложения логики можно подключить к BizTalk Server с помощью [соединителя BizTalk Server](../connectors/apis-list.md#on-premises-connectors) и обеспечить взаимодействие приложений с BizTalk Server с помощью этого соединителя. Затем можно расширить или начать выполнять операции BizTalk в приложениях логики, включив [соединители для учетной записи интеграции](../connectors/apis-list.md#integration-account-connectors), которые доступны в пакете интеграции Enterprise. 
