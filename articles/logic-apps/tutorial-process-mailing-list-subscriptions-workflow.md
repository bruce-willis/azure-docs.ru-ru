...
description: В этом руководстве описывается, как создать автоматизированные рабочие процессы утверждения для обработки подписок на список рассылки с помощью Azure Logic Apps
services: logic-apps
