...
ms.locfileid: "35298820"
---
# <a name="create-scopes-that-run-workflow-actions-based-on-group-status-in-azure-logic-apps"></a>Создание областей, которые выполняют действия рабочего процесса на основе состояния группы в Azure Logic Apps
