...
| Имена блочного BLOB-объекта и страничного BLOB-объекта      | Имена BLOB-объектов указываются с учетом регистра и могут содержать любое сочетание знаков. <br> Длина имени BLOB-объекта должна составлять от 1 до 1024 знаков. <br> Зарезервированные символы URL-адреса должны быть правильно экранированы. <br>Число сегментов пути в имени BLOB-объекта не может превышать 254. Сегмент пути — это строка между последовательными разделителями (такими как косая черта "/"), соответствующая имени виртуального каталога. |
