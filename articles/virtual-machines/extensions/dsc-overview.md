...
- **Version** (Версия). Указывает версию устанавливаемого расширения DSC. Сведения о версиях приведены в [журнале версий расширения DSC](/powershell/dsc/azuredscexthistory).
