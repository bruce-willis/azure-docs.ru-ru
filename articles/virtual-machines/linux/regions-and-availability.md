---
title: Регионы Azure и функции доступности для виртуальных машин Linux | Документация Майкрософт
description: Узнайте о регионах и функциях доступности для запуска виртуальных машин Linux в Azure.
