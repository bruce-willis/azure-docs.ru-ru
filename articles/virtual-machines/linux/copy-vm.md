...
В этой статье показано, как создать копию виртуальной машины Azure под управлением Linux, используя Azure CLI 2.0 и модель развертывания с помощью Azure Resource Manager. 
