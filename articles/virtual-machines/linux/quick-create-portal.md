...
5. На странице **Параметры** нажмите **Сеть** > **Группа безопасности сети** > **Выберите общедоступные входящие порты** и укажите **HTTP** и **SSH (22)**. Сохраните остальные значения по умолчанию и нажмите кнопку **ОК**.
