...
Azure Load Balancer может быть подсистемой балансировки нагрузки уровня "Стандартный" или "Базовый". Load Balancer уровня "Стандартный" имеет больше возможностей, чем Load Balancer уровня "Базовый". Для группы доступности Load Balancer уровня "Базовый" является обязательным, если используется зона доступности (вместо набора доступности). Дополнительные сведения о различиях между типами подсистемы балансировки нагрузки, см. в разделе [Сравнение SKU Load Balancer](../../../load-balancer/load-balancer-overview.md#skus).
