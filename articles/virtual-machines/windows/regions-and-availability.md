---
title: Регионы Azure и функции доступности для виртуальных машин Windows | Документация Майкрософт
description: Узнайте о регионах и функциях доступности для запуска виртуальных машин Windows в Azure.
