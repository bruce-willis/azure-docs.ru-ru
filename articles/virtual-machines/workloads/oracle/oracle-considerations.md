...
Вы узнали о текущих решениях Oracle в Microsoft Azure. Теперь вы можете приступить к развертыванию вашей первой базы данных Oracle в Azure.
