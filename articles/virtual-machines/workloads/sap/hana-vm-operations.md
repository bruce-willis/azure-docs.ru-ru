...
- Включите действие чтения с пропускной способностью не менее 400 МБ/с для **/hana/data** для следующих размеров операции ввода-вывода: 16 и 64 МБ.
- Включите действие записи с пропускной способностью не менее 250 МБ/с для **/hana/data** со следующими размерами операций ввода-вывода: 16 и 64 МБ.
...
- Добавьте дополнительные рабочие узлы. Ознакомьтесь с командой <https://help.sap.com/viewer/6b94445c94ae495c83a19646e7c3fd56/2.0.00/en-US/0d9fe701e2214e98ad4f8721f6558c34.html>. Укажите внутреннюю сеть для межузловой связи SAP HANA во время установки или позже, используя, к примеру, локальный инструмент hdblcm. Дополнительные сведения см. в [примечании к SAP № 2183363](https://launchpad.support.sap.com/#/notes/2183363). 
