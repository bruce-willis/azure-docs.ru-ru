...
* Для пользовательских образов виртуальный диск VHD следует правильно подготовить перед отправкой. Дополнительные сведения см. в руководстве по [подготовке диска VHD или VHDX для Windows к отправке в Azure](../windows/prepare-for-upload-vhd-image.md).
...
Следуйте инструкциям в [этой статье](../windows/reset-rdp.md). В ней объясняется, как вернуть службу удаленного рабочего стола на виртуальной машине в исходное состояние.
