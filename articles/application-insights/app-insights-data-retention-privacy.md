...
|.NET | Поддерживается, конфигурация зависит от версии. | Подробную информацию о конфигурации для .NET 4.7 и более ранних версий см. в [этих инструкциях](https://docs.microsoft.com/en-us/dotnet/framework/network-programming/tls#support-for-tls-12).  |
|Монитор состояния | Поддерживается, требуется настройка | Монитор состояния зависит от [Конфигурации ОС](https://docs.microsoft.com/en-us/windows-server/security/tls/tls-registry-settings) + [Конфигурации .NET](https://docs.microsoft.com/en-us/dotnet/framework/network-programming/tls#support-for-tls-12) для поддержки протокола TLS 1.2.
...
| Windows Server 2008 с пакетом обновления 2 (SP2) | Поддержка протокола TLS 1.2 требует обновления. | См. раздел [Обновление для добавления поддержки TLS 1.2 в Windows Server 2008 SP2](https://support.microsoft.com/help/4019276/update-to-add-support-for-tls-1-1-and-tls-1-2-in-windows-server-2008-s). |
