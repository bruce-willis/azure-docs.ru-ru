...
В примерах в статьях о службе "Брандмауэр Azure" предполагается, что вы уже включили общедоступную предварительную версию этой службы. Дополнительные сведения см. в [этой статье](public-preview.md).
