...
Период хранения собранных данных в базе данных зависит от выбранного тарифного плана. На *бесплатном* уровне собранные данные доступны в течение 7 дней. На *платном* уровне собранные данные по умолчанию доступны в течение 31 дня, но этот период можно продлить до 730 дней. Для обеспечения конфиденциальности данные в службе хранилища Azure шифруются при хранении. Данные за последние две недели также хранятся в кэше на базе SSD. Сейчас этот кэш не шифруется.  Мы планируем реализовать это шифрование во второй половине 2018 года.  
