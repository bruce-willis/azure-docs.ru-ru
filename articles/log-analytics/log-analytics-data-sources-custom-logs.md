...
### <a name="step-1-enable-custom-logs-preview"></a>Шаг 1. Включение предварительной версии настраиваемых журналов
...
2. В области подписок Log Analytics выберите рабочую область, а затем выберите плитку **Портал OMS**.<br><br> ![Кнопка поиска по журналу](media/log-analytics-data-sources-custom-logs/azure-portal-01.png)<br><br> 
3. После перенаправления к порталу OMS щелкните плитку "Параметры" в правой верхней части страницы.<br><br> ![Вариант "Параметры" портала OMS](media/log-analytics-data-sources-custom-logs/oms-portal-settings-option.png)<br><br> 
4. На странице **Параметры** выберите **Предварительная версия функций**, затем на странице выберите **Включить** для настраиваемых журналов.    

### <a name="step-2-open-the-custom-log-wizard"></a>Шаг 2. Открытие мастера настраиваемого журнала
...
### <a name="step-3-upload-and-parse-a-sample-log"></a>Шаг 3. Загрузка и преобразование примера журнала
...
### <a name="step-4-add-log-collection-paths"></a>Шаг 4. Добавление пути к файлам журнала
...
### <a name="step-5-provide-a-name-and-description-for-the-log"></a>Шаг 5. Указание имени и описания журнала
...
### <a name="step-6-validate-that-the-custom-logs-are-being-collected"></a>Шаг 6. Проверка того, собираются ли данные настраиваемых журналов
...
### <a name="step-7-parse-the-custom-log-entries"></a>Шаг 7. Преобразование записей настраиваемого журнала
