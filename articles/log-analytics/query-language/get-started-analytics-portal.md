---
title: Начало работы с порталом аналитики в Azure Log Analytics | Документация Майкрософт
...
ms.locfileid: "39632909"
---
# <a name="get-started-with-the-analytics-portal"></a>Начало работы с порталом аналитики

В этом руководстве рассматривается использование портала аналитики для записи запросов Azure Log Analytics. Вы научитесь:
...
## <a name="meet-the-analytics-portal"></a>Знакомство с порталом аналитики
Портал аналитики — это веб-инструмент, используемый для записи и выполнения запросов Azure Log Analytics. 

![главная страница](media/get-started-analytics-portal/homepage.png)

Домашняя страница обеспечивает легкий доступ к полезным ресурсам, таким как недавние и сохраненные запросы и примеры. Откройте новую вкладку, чтобы начать писать собственные запросы.
...
Портал аналитики автоматически задает область результатов по следующим критериям:
...
Портал аналитики поддерживает несколько методов экспорта:
