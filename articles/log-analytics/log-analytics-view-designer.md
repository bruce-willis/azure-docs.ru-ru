...
| Analytics | Открывает [портал расширенной аналитики](log-analytics-log-search-portals.md#advanced-analytics-portal) для анализа данных с помощью запросов поиска по журналам. |
...
| диапазон дат; | Установите фильтр даты и диапазона времени для данных, включенных в представление. |
