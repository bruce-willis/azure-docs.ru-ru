...
| Analytics | Открывает [портал расширенной аналитики](log-analytics-log-search-portals.md) для анализа данных с помощью запросов по журналам. |
