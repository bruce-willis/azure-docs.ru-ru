...
Навигация по щелчку позволяет определить, какое действие будет выполнено, если щелкнуть заголовок или элемент списка в представлении.  При щелчке может открыться запрос на [портале поиска по журналам](log-analytics-log-search-portals.md) или запуститься другое представление.
