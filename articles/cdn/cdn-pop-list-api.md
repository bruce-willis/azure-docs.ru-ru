...
Дополнительные сведения о REST API см. в статье [Azure CDN REST API](https://docs.microsoft.com/en-us/rest/api/cdn/) (REST API сети доставки содержимого Azure).