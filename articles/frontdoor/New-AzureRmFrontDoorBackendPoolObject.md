...
ms.locfileid: "47046511"
---
# New-AzureRmFrontDoorBackendPoolObject

Создание объекта PSBackendPool для создания службы Front Door.
...
### -Backend
Набор внутренних серверов для данного пула.
...
Имя параметров пробы работоспособности для этого внутреннего пула.
...
Имя параметров балансировки нагрузки для этого внутреннего пула.
