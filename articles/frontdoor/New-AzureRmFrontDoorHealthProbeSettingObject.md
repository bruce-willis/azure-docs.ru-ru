...
ms.locfileid: "47046911"
---
# New-AzureRmFrontDoorHealthProbeSettingObject

Создание объекта PSHealthProbeSetting для создания службы Front Door.
...
### -Path
Путь для пробы работоспособности.
...
### -Protocol
Схема протокола для данной пробы. Значение по умолчанию — HTTP.
