...
ms.locfileid: "47047208"
---
# Set-AzureRmFrontDoor
Изменение подсистемы балансировки нагрузки Front Door.
...
## Описание
Командлет **Set-AzureRmFrontDoor** изменяет подсистему балансировки нагрузки Front Door. Если входные параметры не указаны, будут использованы прежние параметры из существующего экземпляра Front Door.

## Примеры

### Пример 1. Изменение существующего экземпляра Front Door с указанными значениями FrontDoorName и ResourceGroupName
```powershell
...
Изменение существующего экземпляра Front Door.

### Пример 2. Изменение существующего экземпляра Front Door с указанным объектом PSFrontDoor
```powershell
...
### Пример 3. Изменение существующего экземпляра Front Door с указанным значением ResourceId
```powershell
...
### -EnabledState
Рабочее состояние подсистемы балансировки нагрузки Front Door.
...
### -Name
Имя изменяемого объекта Front Door.
...
### -ResourceId
Идентификатор ресурса изменяемого объекта Front Door.
