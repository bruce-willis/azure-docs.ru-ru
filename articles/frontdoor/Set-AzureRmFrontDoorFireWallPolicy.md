...
ms.locfileid: "47046743"
---
# Set-AzureRmFrontDoorFireWallPolicy
Изменение политики WAF.
...
## Описание
Командлет **Set-AzureRmFrontDoor** изменяет существующую политику WAF. Если входные параметры не указаны, будут использованы прежние параметры из существующей политики WAF.

## Примеры

### Пример 1. Изменение существующей политики WAF
```powershell
...
Изменение существующей политики WAF.

### Пример 2. Изменение существующей политики WAF
```powershell
...
### Пример 3. Изменение существующей политики WAF
```powershell
...
### Пример 4. Изменение всех политик WAF в группе ресурсов $resourceGroup
```powershell
...
Изменение всех политик WAF в группе ресурсов $resourceGroup.
...
### -EnabledState
Позволяет указать, включена ли эта политика.
...
### -InputObject
Изменяемый объект FireWallPolicy.
...
### -ManagedRule
Управляемые правила в политике.
...
### -Name
Имя изменяемого объекта FireWallPolicy.
...
### -ResourceGroupName
Группа ресурсов, к которой принадлежит FireWallPolicy.
...
### -ResourceId
Идентификатор ресурса изменяемого объекта FireWallPolicy.
