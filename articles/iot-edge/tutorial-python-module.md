...
Портал Azure можно использовать для развертывания модуля Python на устройстве IoT Edge, как это было сделано в кратких руководствах. Также в Visual Studio Code можно развертывать модули и проводить их мониторинг. В следующих разделах используется расширение Azure IoT Edge для VS Code, указанное в предварительных требованиях. Если расширение не было установлено, то теперь это можно сделать. 
