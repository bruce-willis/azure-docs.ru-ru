...
3. Создайте B2C_1A_TokenSigningKeyContainer, если он не существует:<br>
    ...
    Е. Для параметра **Использование ключа** задайте значение **Подпись**.<br>
...
4. Выберите **Регистрация нового приложения**.
   ...
   * Для параметра **URL-адрес входа** используйте адрес `https://yourtenant.b2clogin.com/yourtenant.onmicrosoft.com`, где `yourtenant` — это доменное имя клиента Azure AD B2C.
...
1. Выберите **Регистрация нового приложения**.
   ...
   * Для параметра **URI перенаправления**, используйте адрес `https://yourtenant.b2clogin.com/yourtenant.onmicrosoft.com`, где `yourtenant` — это ваш клиент Azure AD B2C.
