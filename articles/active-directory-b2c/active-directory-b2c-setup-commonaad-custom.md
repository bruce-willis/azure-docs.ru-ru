---
title: Добавление мультитенантного поставщика удостоверений Azure AD с помощью пользовательских политик в Azure Active Directory B2C | Документация Майкрософт
