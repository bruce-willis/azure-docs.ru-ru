---
title: Защита веб-API с помощью Node.js в Azure Active Directory B2C | Документация Майкрософт
description: Сведения о создании веб-API Node.js, который принимает токены от клиента B2C
