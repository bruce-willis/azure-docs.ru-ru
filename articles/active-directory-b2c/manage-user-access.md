...
>[!Note] 
>Эта статья содержит сведения, которые вы можете использовать, чтобы выполнить все обязанности, установленные Общим регламентом по защите данных (GDRP). Если вы ищете общие сведения о GDPR, обратитесь к [разделу о GDPR на портале служб защиты данных](https://servicetrust.microsoft.com/ViewPage/GDPRGetStarted).
...
2. Если для элемента выбранной страны присутствует узел **MinorConsent**, то выполните следующие действия.
    ...
    Б. Сравните минимальную дату рождения с фактически указанной датой рождения. Если минимальная дата рождения наступает раньше даты рождения пользователя, результатом вычисления считается значение возрастной группы **Minor**.
...
- В систему входит пользователь, который ранее подтвердил согласие с актуальными или активными условиями соглашения. Условия использования не отображаются.
