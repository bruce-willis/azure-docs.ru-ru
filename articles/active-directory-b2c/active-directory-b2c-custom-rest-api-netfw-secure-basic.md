---
title: Защита служб RESTful с использованием обычной проверки подлинности HTTP в Azure Active Directory B2C | Документация Майкрософт
