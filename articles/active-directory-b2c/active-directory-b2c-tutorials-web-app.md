...
Для использования регистрации приложения в клиенте необходимо изменить настройки приложения, в частности идентификатор приложения и ключ, записанные ранее. Кроме того, необходимо также настроить созданные политики. Пример веб-приложения определяет значения конфигурации, такие как параметры приложения, в файле Web.config. Чтобы изменить параметры приложения:
