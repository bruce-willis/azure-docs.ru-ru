---
title: Создание приложения Node.js с помощью пакета SDK для JavaScript для управления данными API SQL для Azure Cosmos DB | Документация Майкрософт
