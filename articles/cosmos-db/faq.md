...
### <a name="how-can-i-apply-the-functionality-of-gremlin-api-to-azure-cosmos-db"></a>Как можно использовать функции API Gremlin в Azure Cosmos DB?
Чтобы использовать эти функции, можно применить библиотеку расширений API Gremlin. Эта библиотека называется Microsoft Azure Graphs. Она доступна в [NuGet](https://www.nuget.org/packages/Microsoft.Azure.Graphs). 
...
### <a name="how-can-i-use-the-new-gremlin-api-offering"></a>Как можно использовать новое предложение API Gremlin? 
Чтобы приступить к работе, перейдите к краткому руководству по [API Gremlin](../cosmos-db/create-graph-dotnet.md).
