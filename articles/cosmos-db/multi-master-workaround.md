---
title: Выполнение операций записи и чтения в нескольких регионах посредством выбора правильного ключа секционирования | Документация Майкрософт
description: Узнайте, как спроектировать архитектуру приложения с локальными операциями чтения и записи в Azure Cosmos DB в нескольких географических регионах, выбрав правильный ключ секционирования.
services: cosmos-db
author: SnehaGunda
manager: kfile
...
ms.locfileid: "34850367"
---
# <a name="perform-multi-region-writes-and-reads-by-choosing-the-right-partitioning-key"></a>Выполнение операций записи и чтения в нескольких регионах посредством выбора правильного ключа секционирования
...
![Архитектура с несколькими базами данных master на основе Azure Cosmos DB](./media/multi-master-workaround/multi-master.png)
