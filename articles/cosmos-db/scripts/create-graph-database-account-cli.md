---
title: Создание учетной записи, базы данных и коллекции API Gremlin для Azure Cosmos DB с помощью скрипта Azure CLI | Документация Майкрософт
description: Пример скрипта Azure CLI для создания учетной записи, базы данных и коллекции API Gremlin в Azure Cosmos DB
services: cosmos-db
...
С помощью этого примера скрипта CLI создается учетная запись, база данных и коллекция API Gremlin в Azure Cosmos DB. 
