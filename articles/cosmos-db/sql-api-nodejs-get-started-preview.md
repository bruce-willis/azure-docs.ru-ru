...
ms.locfileid: "43043022"
---
# <a name="nodejs-tutorial-create-a-nodejs-console-application-with-azure-cosmos-db-sql-api-and-javascript-sdk-20-preview"></a>Руководство по Node.js: создание консольного приложения Node.js с помощью API SQL Azure Cosmos DB и пакета SDK для JavaScript версии 2.0 (предварительная версия)

> [!div class="op_single_selector"]
> * [.NET](sql-api-get-started.md)
> * [.NET Core](sql-api-dotnetcore-get-started.md)
> * [Node.js](sql-api-nodejs-get-started.md)
> * [Node.js — предварительная версия 2.0](sql-api-nodejs-get-started-preview.md)
...
* Требуется более сложный пример Node.js? См. статью о [создании веб-приложения Node.js с использованием Azure Cosmos DB](sql-api-nodejs-application-preview.md).
