...
ms.locfileid: "34763686"
---
# <a name="set-up-azure-cosmos-db-global-distribution-using-the-graph-api"></a>Настройка глобального распределения Azure Cosmos DB с помощью API Graph
