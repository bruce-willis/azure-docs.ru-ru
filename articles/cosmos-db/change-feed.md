...
Вот и все! После выполнения этих шагов документы начнут поступать в метод **DocumentFeedObserver ProcessChangesAsync**. См. приведенный выше код в [репозитории GitHub](https://github.com/Azure/azure-documentdb-dotnet/tree/master/samples/code-samples/ChangeFeedProcessor).
