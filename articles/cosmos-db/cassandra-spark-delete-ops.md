...
Мы будем использовать этот фрагмент кода, чтобы создать пример данных.
...
### <a name="delete-rows-that-match-a-condition"></a>Удаление строк, соответствующих условию
...
### <a name="delete-all-the-rows-in-the-table"></a>Удаление всех строк в таблице
...
### <a name="delete-specific-columns"></a>Удаление определенных столбцов
