...
Чтобы помочь вам начать работу, руководитель программы Azure Cosmos DB Эндрю Лю (Andrew Liu) рассказывает в этом видео о единицах запросов. В примерах единиц запросов, рассматриваемых в видео, допущена опечатка. При выделении по 1 КБ данных для 100 000 записей, общий объем хранилища составляет 100 МБ, а не 100 ГБ). <br /><br />
