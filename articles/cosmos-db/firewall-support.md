...
В Azure такие службы PaaS, как Azure Stream Analytics и Функции Azure, используются в сочетании с Azure Cosmos DB. Чтобы разрешить приложениям из других служб Azure PaaS подключаться к вашим ресурсам Azure Cosmos DB, необходимо включить параметр брандмауэра. Чтобы включить этот параметр брандмауэра, добавьте IP-адрес 0.0.0.0 в список разрешенных IP-адресов. 0.0.0.0 позволяет подключаться к учетной записи Azure Cosmos DB только из диапазона IP-адресов центра обработки данных Azure. Этот параметр не позволяет получать доступ к учетной записи Azure Cosmos DB из других диапазонов IP-адресов.
