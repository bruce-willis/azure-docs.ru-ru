...
В этой статье описаны некоторые примеры SQL-запросов с использованием простых документов JSON. Дополнительные сведения о синтаксисе языка SQL Azure Cosmos DB см. в статье [Справочник по синтаксису SQL в Azure Cosmos DB](sql-api-sql-query-reference.md). 
