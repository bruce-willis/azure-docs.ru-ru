...
2. Укажите *узел*, *порт*, *пользователя*, *пароль*, *пул подключений* и *сериализатор*:
    ...
    ---|---|---
    Узлы|[*account-name*.gremlin.cosmosdb.azure.com] или [*account-name*.graphs.azure.com] для учетных записей, созданных до 20 декабря 2017 г.|Экран должен выглядеть следующим образом. Это значение Gremlin URI на странице обзора портала Azure, заключенное в квадратные скобки и без окончания 443/.<br><br>Его также можно получить на вкладке "Ключи" с помощью значения URI, удалив https://, изменив документы на графы или gremlin.cosmosdb и удалив окончание 443/.
