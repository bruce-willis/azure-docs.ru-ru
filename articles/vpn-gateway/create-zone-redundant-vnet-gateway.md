...
Да, вы можете использовать портал Azure для предварительной версии. Но вам все равно необходимо зарегистрироваться с помощью PowerShell или вы не сможете использовать портал для предварительной версии.
