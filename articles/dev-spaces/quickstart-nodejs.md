...
- Отладка кода, запущенного в кластере.
...
1. Создайте среду разработки в AKS. В окне консоли запустите следующую команду из **корневой папки кода**, webfrontend: `azds up`
