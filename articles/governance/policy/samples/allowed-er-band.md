...
description: Этот пример политики требует, чтобы каналы ExpressRoute использовали определенный набор значений пропускной способности.
