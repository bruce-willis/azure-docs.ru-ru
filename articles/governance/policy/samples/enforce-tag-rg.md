---
title: 'Пример политики Azure: принудительное применение тега и его значения для групп ресурсов'
description: Этот пример политики требует указать тег и его значение для группы ресурсов.
