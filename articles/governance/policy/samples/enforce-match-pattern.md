---
title: 'Пример политики Azure: принудительное применение шаблона MATCH'
description: В этом примере политики требуется, чтобы ресурсы соответствовали шаблону MATCH для соглашений об именовании.
