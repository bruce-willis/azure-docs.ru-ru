---
title: 'Пример политики Azure: требование SQL Server версии 12.0'
description: Этот пример политики требует наличия SQL Server версии 12.0.
