---
title: 'Пример политики Azure: допустимые номера SKU шлюзов виртуальной сети'
description: Этот пример политики требует, чтобы шлюзы виртуальной сети использовали утвержденный номер SKU и тип шлюза.
