---
title: 'Пример политики Azure: аудит состояния прозрачного шифрования данных'
description: Этот пример политики проверяет, включено ли прозрачное шифрование данных для базы данных SQL.
