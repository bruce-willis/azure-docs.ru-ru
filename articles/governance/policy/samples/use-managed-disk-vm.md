---
title: 'Пример политики Azure: создание виртуальной машины, использующей управляемый диск'
description: Пример политики требует, чтобы виртуальные машины использовали управляемые диски.
