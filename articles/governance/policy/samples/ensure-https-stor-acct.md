---
title: 'Пример Политики Azure: использование HTTPS-трафика для учетной записи хранения'
description: Пример политики требует, чтобы учетные записи хранения использовали HTTPS-трафик.
