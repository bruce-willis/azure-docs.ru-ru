...
| **Премиальный** | Yes | В реестрах уровня "Премиум" обеспечивается наивысший объем хранилища и количество параллельных операций, что делает возможными сценарии с большим объемом данных. Помимо повышенной пропускной способности образов, на уровне "Премиум" доступны дополнительные функции, такие как [георепликация][container-registry-geo-replication] для управления одним реестром в нескольких регионах и [доверие к содержимому (предварительная версия)](container-registry-content-trust.md) для подписания тега образа. |
| Классический<sup>1</sup> | Нет  | Этот номер SKU включил первоначальный выпуск службы "Реестр контейнеров Azure" в Azure. Реестры уровня "Классический" поддерживаются учетной записью хранения, которую создает Azure в подписке, из-за чего ACR предоставляет меньше возможностей более высокого уровня, таких как повышенная пропускная способность и георепликация. |

<sup>1</sup> Поддержка номера SKU уровня "Классический" **прекратится** в **марте 2019 года**. При создании реестров контейнеров используйте уровни "Базовый", "Стандартный" или "Премиум".
...
> [!IMPORTANT]
> Поддержка номера SKU уровня "Классический" прекращается с марта 2019 года. При создании реестров используйте уровни "Базовый", "Стандартный" или "Премиум".
