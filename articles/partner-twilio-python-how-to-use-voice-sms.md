...
* Скачайте библиотеку Twilio для Python из GitHub ([https://github.com/twilio/twilio-python][twilio_python]) и установите ее, как показано ниже:
...
Дополнительные сведения см. на странице [https://github.com/twilio/twilio-python/blob/master/README.md][twilio_github_readme].
