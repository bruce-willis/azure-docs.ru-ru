---
title: Новые возможности Каталога данных Azure
...
## <a name="whats-new-for-november-2017"></a>Новые возможности по состоянию на сентябрь 2017 г. 
По состоянию на ноябрь 2017 г. в каталог данных Azure добавлены следующие возможности:

* Поддержка прямых ссылок на конкретные термины в бизнес-глоссарии на портале каталога данных. Пользователи могут копировать ссылки из бизнес-глоссария и внедрять их в документы, сообщения электронной почты, отчеты и другие расположения, тем самым создавая прямые ссылки на определения терминов в глоссарии.
* Поддержка субъектов-служб Azure Active Directory. Администраторы каталога данных могут предоставлять доступ к каталогу клиентским приложениям, использующим субъекты-службы (похоже на предоставление разрешений пользователям и группам безопасности). Дополнительные сведения см. в статье [Объекты приложения и субъекта-службы в Azure Active Directory (Azure AD)](../active-directory/develop/app-objects-and-service-principals.md).
* Поддержка аутентификации Azure Active Directory при подключении к источникам данных в базе данных SQL Azure и хранилище данных SQL Azure с помощью средства регистрации источника данных каталога данных. Дополнительные сведения см. в статье [Использование аутентификации Azure Active Directory для аутентификации с помощью базы данных SQL или хранилища данных SQL](../sql-database/sql-database-aad-authentication.md).
...
*   Каталог данных Azure теперь совместим с [HIPAA](https://www.microsoft.com/en-us/TrustCenter/Compliance/hipaa) и [Предложениями по модели ЕС](https://www.microsoft.com/en-us/TrustCenter/Compliance/EU-Model-Clauses).
...
* Поддержка регистрации и обнаружения объектов SQL Server Analysis Services через протокол HTTP или HTTPS. Теперь пользователи могут подключаться к серверам SQL Server Analysis Services, используя URL-адрес (например, https://servername/olap/msmdpump.dll)), а не имя сервера, и в дополнение к аутентификации Windows использовать обычную проверку подлинности и анонимные подключения. Дополнительные сведения о подключениях к SSAS по протоколу HTTP или HTTPS см. в статье [Настройка HTTP-доступа к службам Analysis Services](https://msdn.microsoft.com/library/gg492140.aspx).
* Поддержка источников данных Hive в HDInsight. Теперь пользователи могут регистрировать и обнаруживать таблицы Hive для Apache Hive в Hadoop в источниках данных HDInsight. Дополнительные сведения о Hive в HDInsight см. в [Центре документации по HDInsight](../hdinsight/hadoop/hdinsight-use-hive.md).
