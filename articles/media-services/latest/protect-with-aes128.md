...
Ключ содержимого обеспечивает безопасность доступа к вашим ресурсам. Необходимо создать политику **ContentKeyPolicy**, которая настраивает доставку ключа содержимого конечным клиентам. Ключ содержимого связан со **StreamingLocator**. Они также включают в себя службу доставки ключей, которая доставляет ключи шифрования авторизованным пользователям. 
