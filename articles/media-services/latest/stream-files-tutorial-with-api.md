...
4. Отправляет задание кодирования с помощью ввода и вывода, которые были созданы.
5. Проверяет состояние задания.
6. Создает указатель потоковой передачи.
7. Компилирует URL-адреса потоковой передачи.
