...
1. Подключите видеокамеру к компьютеру. Запустите и настройте локальный динамический кодировщик, который может выводить **односкоростной** поток по одному из следующих протоколов: RTMP или Smooth Streaming. 
