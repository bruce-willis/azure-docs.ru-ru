...
Чтобы выполнить действия, описанные в этой статье, необходимо использовать [API Azure Resource Manager](https://docs.microsoft.com/rest/api/media/mediaservice) и [PowerShell](https://docs.microsoft.com/powershell/module/azurerm.media).  Дополнительные сведения см. в статье [об управлении ресурсами Azure с помощью PowerShell при использовании Resource Manager](../../azure-resource-manager/powershell-azure-resource-manager.md).
