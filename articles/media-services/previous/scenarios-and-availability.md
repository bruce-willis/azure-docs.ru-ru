...
description: В этой статье приводятся обзор сценариев Служб мультимедиа Microsoft Azure и сведения о доступности функций и служб в центрах обработки данных.
