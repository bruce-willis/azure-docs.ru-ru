...
Хотя фабрика данных доступна только в определенных регионах, служба для поддержки перемещения данных в фабрике данных доступна глобально в нескольких регионах. Если хранилище данных находится за брандмауэром, данные перемещает локальная среда выполнения интеграции, установленная в локальной среде.
