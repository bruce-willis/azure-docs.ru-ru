...
ms.locfileid: "37054608"
---
# <a name="data-factory-scheduling-and-execution"></a>Планирование и исполнение с использованием фабрики данных
> [!NOTE]
> В этой статье рассматривается служба "Фабрика данных Azure" версии 1. Если вы используете текущую версию Фабрики данных, ознакомьтесь со статьей о [выполнении конвейеров и триггерах](../concepts-pipeline-execution-triggers.md).
