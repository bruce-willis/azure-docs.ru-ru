...
>[!NOTE]
>Когда вы используете средство копирования данных для конвейера копирования авторских копий или пользовательский интерфейс ADF для выполнения тестирования подключения и навигации по папкам во время разработки, для этого требуется разрешение главного администратора или MSI на корневом уровне. Выполнение действия копирования может работать до тех пор, пока копируемым данным предоставляется разрешение. Вы можете пропустить авторизованные операции, если необходимо ограничить разрешение.
