...
5. Щелкните вкладку **Подключение** в окне "Свойства", а затем выберите **AzureSqlLinkedService** для **связанной службы**. Для свойства **таблицы** щелкните **Добавить динамическое содержимое**. 
...
6. Выберите **SinkTableName** в разделе **Параметры**.
...
19. Перейдите на вкладку **Хранимая процедура** и выполните здесь следующие действия:
    ...
    1. В качестве **имени хранимой процедуры** укажите `sp_write_watermark`. 
...
2. Щелкните ссылку **View Activity Runs** (Просмотр выполнений действий) в столбце **Actions** (Действия). Вы увидите все запуски действия, связанные с выбранным запуском конвейера. 
