...
| authenticationType | Тип проверки подлинности, используемый для подключения к источнику OData.<br/>Возможными значениями являются: **Anonymous**, **Basic** и **Windows**. OAuth не поддерживается. | Yes |
