...
> [!NOTE]
> Веб-сайты Azure уже обеспечивают балансировку нагрузки с циклическим перебором для веб-сайтов в любом регионе Azure (с несколькими центрами обработки данных). Диспетчер трафика позволяет использовать метод циклического перебора при маршрутизации трафика для веб-сайтов в разных центрах данных.
