...
7. Теперь вы можете выполнять развертывание в имеющейся виртуальной сети, как это описано в [здесь](azure-stack-app-service-before-you-get-started.md#virtual-network), или разрешить установщику Службы приложений создавать виртуальную сеть и связанные подсети.
...
8. Введите данные для общего файлового ресурса и нажмите кнопку **Далее**. В адресе файлового ресурса нужно использовать полное доменное имя файлового сервера или IP-адрес. Например, \\\appservicefileserver.local.cloudapp.azurestack.external\websites или \\\10.0.0.1\websites.
...
10. В каждом из трех полей файла сертификата щелкните **Обзор** и перейдите к нужному файлу сертификата. Необходимо указать пароль для каждого сертификата. Это те сертификаты, которые вы создали на шаге [создания требуемых сертификатов](azure-stack-app-service-before-you-get-started.md#get-certificates). Когда вы введете всю информацию, нажмите кнопку **Далее**.
...
13. В поле **Select Platform Image** (Выбор образа платформы) выберите развертываемый образ виртуальной машины Windows Server 2016 из доступных в поставщике вычислительных ресурсов для облачной Службы приложений. Нажмите кнопку **Далее**.
