...
- Для активации портала администрирования перейдите по адресу https://adminportal.local.azurestack.external/guest/signup, прочтите информацию и щелкните Accept (Принять). После этого вы можете добавить администраторов служб, не являющихся также администраторами каталога клиента.
- Для активации портала клиента перейдите по адресу https://portal.local.azurestack.external/guest/signup,прочтите информацию и щелкните Accept (Принять). После этого пользователи в каталоге смогут войти на портал клиента. 
