---
title: Сведения о VPN-шлюзе для Azure Stack | Документы Майкрософт
...
Перед созданием и настройкой VPN-шлюзов для Azure Stack просмотрите [рекомендации для сетевых возможностях Azure Stack](/azure/azure-stack/user/azure-stack-network-differences), чтобы понять отличие конфигураций для Azure Stack от Azure.
...
## <a name="gateway-skus"></a>Номера SKU шлюзов
...
Azure Stack не поддерживает номер SKU UltraPerformance шлюза, который используется исключительно с ExpressRoute.

При выборе номера SKU учитывайте приведенные далее факторы.
...
* Активно-активные подключения типа "сеть — сеть" через VPN-шлюз можно настроить только в SKU HighPerformance.
