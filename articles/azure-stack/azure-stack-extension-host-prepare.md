...
description: Сведения о подготовке хост-процесса для расширений с автоматическим включением с помощью пакета обновления Azure Stack.
...
> [!Note]  
> Вы можете пропустить этот шаг в зависимости от вашего запроса SSL-сертификатов.
...
5. Импортируйте сертификат для конечной точки размещения администратора.
