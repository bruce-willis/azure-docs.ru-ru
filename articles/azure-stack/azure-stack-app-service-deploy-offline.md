...
13. Просмотрите параметры номера SKU и экземпляра роли. По умолчанию указывается минимальное количество экземпляров и минимальный номер SKU для каждой роли в развертывании ASDK. Ниже приведена сводка требований к виртуальным ЦП и памяти, чтобы помочь вам спланировать развертывание. Выбрав необходимые значения, нажмите кнопку **Далее**.
    ...
    > [!NOTE]
    > **Служба приложений Azure в Azure Stack не поддерживает образ платформы Windows Server 2016 Core.  Не используйте образы вычисления при развертывании в рабочей среде.  Для Службы приложений Azure в Azure Stack требуется, чтобы Microsoft.Net 3.5.1 с пакетом обновления 1 был активирован на образе, который используется для развертывания.   Синдицированные в Marketplace образы Windows Server 2016 не поддерживают эту функцию.**
