---
title: Средства для хранилища Azure Stack | Документы Майкрософт
...
Для работы с Azure Stack требуется Azure CLI версии 2.0. Дополнительные сведения об установке и настройке Azure CLI для работы с Azure Stack см. в статье [Установка и настройка интерфейса командной строки для использования с Azure Stack](azure-stack-version-profiles-azurecli2.md). Дополнительные сведения о том, как использовать Azure CLI 2.0 для выполнения нескольких задач с ресурсами в учетной записи хранения Azure Stack, см. в статье [Использование Azure CLI 2.0 со службой хранилища Azure](../../storage/storage-azure-cli.md)
