...
1. В колонке **Создать план** заполните поля **Отображаемое имя** и **Имя ресурса**. Отображаемое имя — это понятное имя плана, которое отображается для пользователей. Имя ресурса отображается только для оператора облака. Это имя, которое операторы облака используют для работы с планом в качестве ресурса Azure Resource Manager.
...
1. **Подготовка виртуальной машины**
   ...
   b.  На панели мониторинга последовательно выберите **Создать** > **Вычисления** > **Windows Server 2016 Datacenter Eval**, а затем **Создать**.
