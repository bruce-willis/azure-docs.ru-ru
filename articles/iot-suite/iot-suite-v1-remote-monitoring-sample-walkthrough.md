...
Задания ASA **Сведения об устройстве** и **Правила** выводят данные в Центры событий, чтобы надежно перенаправить их в **обработчик событий**, запущенный в веб-задании.
