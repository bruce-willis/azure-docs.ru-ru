...
Экспериментальная поддержка PowerShell доступна только в версии 5.1, так как именно эта версия устанавливается по умолчанию на виртуальных машинах с выполняемыми приложениями-функциями. Для выполнения скриптов PowerShell используйте [службу автоматизации Azure](https://azure.microsoft.com/services/automation/).
