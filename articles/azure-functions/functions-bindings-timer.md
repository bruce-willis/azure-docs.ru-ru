...
Чтобы указать дни или месяцы, вместо числовых значений используйте трехбуквенные сокращения, например янв (январь) или вос (воскресенье).
