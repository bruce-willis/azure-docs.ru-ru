...
> [!NOTE]
> Устойчивые функции доступны в JavaScript только для среды выполнения функций версии 2.
