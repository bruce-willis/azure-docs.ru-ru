---
title: 'Пример политики Azure в формате JSON: разрешенные номера SKU для шлюзов виртуальной сети | Документация Майкрософт'
description: Этот пример политики в формате JSON требует, чтобы шлюзы виртуальной сети использовали утвержденный номер SKU и тип шлюза.
...
ms.locfileid: "34602056"
---
# <a name="allowed-virtual-network-gateway-skus"></a>Допустимые номера SKU шлюзов виртуальной сети

Эта политика требует, чтобы шлюзы виртуальной сети использовали утвержденный номер SKU и тип шлюза. Вы можете указать массив утвержденных номеров SKU и типов шлюза.
