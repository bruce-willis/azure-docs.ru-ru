---
title: 'Пример политики Azure в формате JSON: разрешенные номера SKU для Базы данных SQL | Документация Майкрософт'
description: Этот пример политики в формате JSON требует применения утвержденного номера SKU для баз данных SQL.
