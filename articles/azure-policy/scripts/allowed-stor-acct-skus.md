---
title: 'Пример политики Azure в формате JSON: разрешенные номера SKU для учетных записей хранения | Документация Майкрософт'
description: Этот пример политики в формате JSON требует, чтобы учетные записи хранения использовали допустимый номер SKU.
