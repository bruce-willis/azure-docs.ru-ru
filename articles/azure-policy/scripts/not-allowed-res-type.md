---
title: 'Пример политики Azure в формате JSON: неразрешенные типы ресурсов | Документация Майкрософт'
description: В примере шаблона JSON политики запрещено развертывание определенных типов ресурсов.
