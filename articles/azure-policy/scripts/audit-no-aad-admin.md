---
title: 'Пример политики Azure в формате JSON: проверка назначения роли администратора Azure AD | Документация Майкрософт'
description: Этот пример политики в формате JSON проверяет, назначена ли роль администратора Azure Active Directory в настройках сервера SQL.
