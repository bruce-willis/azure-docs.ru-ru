---
title: 'Пример политики Azure в формате JSON: требование SQL Server версии 12.0 | Документация Майкрософт'
description: Этот пример политики в формате JSON требует наличие SQL Server версии 12.0.
...
ms.locfileid: "34603363"
---
# <a name="require-sql-server-version-120"></a>Require SQL Server version 12.0;

Эта политика требует наличия серверов SQL Server версии 12.0.
