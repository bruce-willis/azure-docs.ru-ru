---
title: 'Пример политики Azure в формате JSON: принудительное применение шаблона MATCH | Документация Майкрософт'
description: В этом примере политики в формате JSON требуется, чтобы ресурсы соответствовали шаблону MATCH для соглашения об именовании.
...
ms.locfileid: "34602953"
---
# <a name="enforce-match-pattern-for-naming-conventions"></a>Принудительное применение шаблона MATCH для соглашения об именовании

Имена ресурсов должны соответствовать шаблону LIKE для соглашения об именовании. Укажите допустимый шаблон MATCH в качестве параметра.
