---
title: 'Пример политики Azure в формате JSON: обеспечение шифрования файлов хранилища | Документация Майкрософт'
description: Этот пример политики в формате JSON требует, чтобы для учетных записей хранения было включено шифрование файлов.
