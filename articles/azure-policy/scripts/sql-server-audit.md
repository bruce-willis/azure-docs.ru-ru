---
title: Пример политики Azure в формате JSON. Проверка параметров аудита SQL Server | Документация Майкрософт
description: Этот пример политики в формате JSON проверяет параметры аудита SQL Server.
