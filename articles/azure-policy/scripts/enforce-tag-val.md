---
title: 'Пример политики Azure в формате JSON: принудительное применение тега и его значения | Документация Майкрософт'
description: Этот пример политики в формате JSON требует имя и значение указанного тега.
