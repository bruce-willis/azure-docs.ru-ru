---
title: 'Пример политики Azure в формате JSON: допустимые расположения | Документация Майкрософт'
description: Этот пример политики в формате JSON требует, чтобы все ресурсы развертывались в допустимых расположениях.
...
ms.locfileid: "34600992"
---
# <a name="allowed-locations"></a>Allowed locations;

Эта политика требует, чтобы все ресурсы развертывались в допустимых расположениях. Нужно указать массив утвержденных расположений.
