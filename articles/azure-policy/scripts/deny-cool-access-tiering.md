---
title: 'Пример политики Azure в формате JSON: запрет на распределение по холодным уровням доступа для учетных записей хранения | Документация Майкрософт'
description: В примере шаблона JSON политики запрещено распределение по холодным уровням доступа для учетных записей хранения больших двоичных объектов.
