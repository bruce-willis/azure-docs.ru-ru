---
title: 'Пример политики Azure в формате JSON: аудит параметров аудита уровня SQL Server | Документация Майкрософт'
description: Этот пример политики в формате JSON проверяет, соответствуют ли параметры аудита SQL Server указанному значению.
