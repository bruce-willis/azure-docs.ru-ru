---
title: 'Пример политики Azure в формате JSON: запрет пиринга сетей для сети ExpressRoute | Документация Майкрософт'
description: Этот пример политики в формате JSON запрещает привязку пиринга сетей к сети в указанной группе ресурсов.
...
ms.locfileid: "34602539"
---
# <a name="no-network-peering-to-er-network"></a>Запрет пиринга сетей для сети ExpressRoute
