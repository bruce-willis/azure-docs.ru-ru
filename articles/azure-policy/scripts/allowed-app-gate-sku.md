---
title: 'Пример политики Azure в формате JSON: разрешенные SKU для шлюзов приложений | Документация Майкрософт'
description: Пример JSON политики требует, чтобы шлюзы приложений использовали утвержденные номера SKU.
