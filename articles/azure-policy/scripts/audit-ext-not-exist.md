---
title: 'Пример политики Azure в формате JSON: аудит наличия расширения | Документация Майкрософт'
description: Этот пример политики в формате JSON проверяет, развернуто ли расширение на виртуальной машине.
