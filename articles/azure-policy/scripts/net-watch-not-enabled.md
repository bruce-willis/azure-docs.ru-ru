---
title: 'Пример политики Azure в формате JSON: аудит отключения службы "Наблюдатель за сетями" для региона | Документация Майкрософт'
description: Этот пример политики в формате JSON проверяет, отключена ли для указанного региона служба "Наблюдатель за сетью".
