---
title: 'Пример политики Azure в формате JSON: требование шифрования учетной записи хранения | Документация Майкрософт'
description: Этот пример политики в формате JSON требует, чтобы в учетной записи хранения использовалось шифрование больших двоичных объектов.
