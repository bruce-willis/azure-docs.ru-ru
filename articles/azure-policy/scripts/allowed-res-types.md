---
title: 'Пример политики Azure в формате JSON: разрешенные типы ресурсов | Документация Майкрософт'
description: Этот пример политики в формате JSON обеспечивает развертывание только утвержденных типов ресурсов.
