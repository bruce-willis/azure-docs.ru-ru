---
title: Примеры для Политики Azure
...
ms.locfileid: "34602617"
---
# <a name="azure-policy-samples"></a>Примеры для Политики Azure

В таблице ниже указаны ссылки на шаблоны JSON для службы "Политика Azure". Эти примеры можно также найти в [репозитории примеров для Политики Azure](https://github.com/Azure/azure-policy).
...
- Изучите [структуру определения службы "Политика Azure"](policy-definition.md).
- Изучите [сведения о действии политик](policy-effects.md).