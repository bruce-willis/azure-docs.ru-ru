...
Теперь управляемое удостоверение службы для веб-приложения имеет доступ к пространству имен концентраторов событий и к ранее созданному концентратору событий. 
