---
title: Географическое аварийное восстановление в Центрах событий Azure | Документация Майкрософт
...
ms.locfileid: "42747177"
---
# <a name="azure-event-hubs-geo-disaster-recovery"></a>Географическое аварийное восстановление в Центрах событий Azure
...
Номер SKU уровня "Премиум" для Центров событий также поддерживает функцию [Зоны доступности](../availability-zones/az-overview.md), предоставляя изолированные от сбоев расположения в регионе Azure. 
