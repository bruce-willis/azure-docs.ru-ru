---
title: Использование Apache Flink с концентраторами событий Azure для экосистемы Kafka | Документация Майкрософт
...
ms.locfileid: "35303187"
---
# <a name="apache-flink-with-event-hubs-for-the-kafka-ecosystem"></a>Apache Flink с концентраторами событий для экосистемы Kafka
