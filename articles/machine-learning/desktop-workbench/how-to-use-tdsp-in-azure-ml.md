...
В этом документе содержатся инструкции по созданию проектов по обработке и анализу данных в более ранней версии службы "Машинное обучение Azure" c помощью шаблонов процесса обработки и анализа данных группы (TDSP). Эти шаблоны позволяют структурировать проекты для совместной работы и для возможности воспроизводиться. 
...
* Хранение файлов, таких как Word и PowerPoint, может существенно увеличить размер папки docs. Для хранения этих файлов мы советуем вам найти вики-сайт, [SharePoint](https://products.office.com/sharepoint/collaboration) или другой ресурс для совместной работы.
