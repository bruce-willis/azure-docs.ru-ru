...
Создайте учетную запись управления моделями для выставления счетов, используя следующую команду:
...
При помощи этой команды создается файл манифеста для модели. 
