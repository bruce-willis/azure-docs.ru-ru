...
Библиотека ведения журнала службы "Машинное обучение Azure" позволяет программе выдавать значения метрик и файлы, отслеживаемые службой истории для последующего анализа. 
