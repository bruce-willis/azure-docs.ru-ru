...
>[!Note]
> Максимальный размер отслеживаемого файла в папке результатов после выполнения составляет 512 МБ. Это означает, что, если скрипт создает файл размером больше 512 МБ в папке выходных данных, данные не будут собраны в этой папке. 
