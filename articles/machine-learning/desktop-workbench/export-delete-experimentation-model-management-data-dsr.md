...
>[!Note]
>**Эта статья считается устаревшей.** Поддержка более ранних версий этой службы будет прекращаться постепенно. [Просмотрите сроки поддержки](../service/overview-what-happened-to-workbench.md#timeline). Ознакомьтесь с [последней статьей](../service/how-to-export-delete-data.md) по этой теме.
