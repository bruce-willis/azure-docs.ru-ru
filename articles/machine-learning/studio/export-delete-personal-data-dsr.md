...
Документацию о веб-службах и выставлении счетов плана предложения см. в статье [Azure Machine Learning Studio Management REST APIs](https://docs.microsoft.com/en-us/rest/api/machinelearning/) (REST API управления службой "Машинное обучение Azure"). 
