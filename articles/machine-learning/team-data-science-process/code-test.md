...
1. Передайте код проекта в репозиторий кода проекта VSTS: 
...
1. Зарегистрируйте код в репозитории проекта с помощью команд Git. Новейшая версия вскоре появится в VSTS.
...
1. Настройте автоматическую сборку и тестирование в VSTS:
