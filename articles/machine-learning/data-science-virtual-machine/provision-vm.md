...
Anaconda Python 3.6 устанавливается в каталог **C:\Anaconda**. Anaconda Python 2.7 устанавливается в каталог **C:\Anaconda\envs\python2**. Подробные инструкции есть в [документации по PTVS](/visualstudio/python/installing-python-interpreters.md). 
