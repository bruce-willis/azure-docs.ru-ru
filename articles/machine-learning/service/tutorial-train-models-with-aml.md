...
Для удобства это руководство доступно в виде Jupyter Notebook. Используйте любой из двух указанных ниже методов, чтобы клонировать [репозиторий GitHub для машинного обучения для Notebook](https://github.com/Azure/MachineLearningNotebooks) и запустить Notebook `tutorials/01.train-models.ipynb`.
