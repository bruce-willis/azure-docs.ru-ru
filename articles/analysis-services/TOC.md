...
## [Что такое Analysis Services?](analysis-services-overview.md)

# Быстрое начало работы

## [Создание сервера с помощью портала](analysis-services-create-server.md)
## [Создание сервера (PowerShell)](analysis-services-create-powershell.md)
## [Настройка брандмауэра сервера с помощью портала](analysis-services-qs-firewall.md)

# Учебники

## [1. Добавление примера модели с портала.](analysis-services-create-sample-model.md) 
## [2. Настройка ролей администратора и пользователя сервера.](tutorials/analysis-services-tutorial-roles.md)
## [3. Подключение с помощью Power BI Desktop.](tutorials/analysis-services-tutorial-pbid.md)
...
## [Табличная объектная модель (TOM)](https://docs.microsoft.com/sql/analysis-services/tabular-model-programming-compatibility-level-1200/introduction-to-the-tabular-object-model-tom-in-analysis-services-amo)
## [Ограничения ресурсов и объектов](analysis-services-capacity-limits.md)
