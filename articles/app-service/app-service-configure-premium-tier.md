...
Если ваше приложение выполняется в регионе, где категория **Премиум V2** пока недоступна, вы можете переместить приложение в другой регион, чтобы воспользоваться преимуществами **этой категории**. Существует два варианта.
