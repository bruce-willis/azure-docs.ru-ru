...
* Создать подсеть в этой виртуальной сети. Рекомендуемый размер подсети ASE — `/24` с 256 адресами для расширения в будущем. Ее размер невозможно изменить после создания ASE.
