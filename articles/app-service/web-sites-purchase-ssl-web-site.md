...
Чтобы включить автоматическое обновление сертификата в любое время, на странице управления сертификатами нажмите **Параметры автовозобновления**. Выберите **Вкл.** и нажмите кнопку **Сохранить**.

![](./media/app-service-web-purchase-ssl-web-site/auto-renew.png)

Чтобы вручную обновить сертификат, нажмите **Обновление вручную**.
