...
Сертификаты службы приложений поддерживают три типа проверки домена: проверка через службу приложений, через домен и вручную. Типы проверки подробно описаны в разделе [Дополнительно](#advanced).
...
В разделе **Параметры** щелкните **Параметры SSL**.
...
Сертификаты службы приложений поддерживают еще два типа проверки домена: проверка через домен и вручную.
...
Чтобы включить автоматическое обновление сертификата в любое время, на странице управления сертификатами нажмите **Параметры автовозобновления**. Выберите **Вкл.** и нажмите кнопку **Сохранить**. Если автоматическое обновление включено, сертификаты начнут автоматически обновляться за 90 дней до истечения их срока действия.

![](./media/app-service-web-purchase-ssl-web-site/auto-renew.png)

Чтобы вручную обновить сертификат, нажмите **Обновление вручную**. Вы можете запросить обновление сертификата вручную за 60 дней до истечения срока действия.
...
<a name="notrenewed"></a>
## <a name="why-is-my-certificate-not-auto-renewed"></a>Почему сертификат не продлился автоматически?
...
- Служба GoDaddy, которая создает сертификаты службы приложений, требует проверять домен каждые два года. Администратор домена раз в три года получает сообщение электронной почты для подтверждения домена. Если вы пропустите это сообщение или не подтвердите домен, сертификат службы приложений не будет обновлен автоматически. 
- Из-за изменения политики службы GoDaddy для всех сертификатов службы приложений, выпущенных до 1 марта 2018 г., требуется повторная проверка домена при очередном обновлении (даже если для них настроено автоматическое продление). Проверьте электронную почту и выполните однократный процесс подтверждения домена, чтобы и далее использовать автоматическое продление сертификата службы приложений. 

## <a name="more-resources"></a>Дополнительные ресурсы

* [Принудительное использование HTTPS](app-service-web-tutorial-custom-ssl.md#enforce-https)
* [Принудительное применение TLS 1.1/1.2](app-service-web-tutorial-custom-ssl.md#enforce-tls-1112)
