...
* Во время публикации изменений в веб-приложении с помощью любого механизма эти же изменения публикуются в общем надежном хранилище содержимого. Чтобы обновить локальный кэш веб-приложения, его необходимо перезапустить. Чтобы организовать эффективный жизненный цикл, см. инструкции далее в этой статье.
