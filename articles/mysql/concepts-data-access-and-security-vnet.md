...
> [!NOTE]
> В службе "База данных Azure для MySQL" эта функция доступна в общедоступной предварительной версии во всех регионах, где представлено общедоступное облако Azure, в котором развернута база данных Azure для MySQL.
...
Однако к маю 2018 года служба базы данных Azure для MySQL еще не вошла в список служб, которые могут быть назначены напрямую в подсеть.
