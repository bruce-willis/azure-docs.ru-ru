...
Из этой статьи вы узнаете о том, как настроить репликацию входных данных в Базе данных Azure для MySQL, настроив основной сервер и сервер-реплику.
...
1. Создайте новый сервер Базы данных Azure для MySQL.
   ...
   > [!IMPORTANT]
   > Этот сервер необходимо создать в ценовой категории "Общего назначения" или "Оптимизировано для памяти".
   > 
