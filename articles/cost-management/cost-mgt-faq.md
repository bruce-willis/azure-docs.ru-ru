...
> Администратор1 может быть поставщиком решений Microsoft Cloud или пользователем Соглашения Enterprise. Его организация готова к использованию службы "Управление затратами".  Администратор регистрируется на портале Azure и выполняет вход на портал Cloudyn. Пользователь, выполняющий регистрацию в службе "Управление затратами" и вход на портал Cloudyn, становится *главным администратором*. Администратор1 не создает какие-либо пользовательские учетные записи. Тем не менее, используя портал Cloudyn, он создает учетные записи Azure и настраивает иерархию сущностей. Администратор1 информирует администратора2 (администратора клиента) о необходимости регистрации в службе "Управление затратами" и входа на портал Cloudyn.
