...
- Дополнительные сведения об отчетах, входящих в состав Cloudyn, см. в статье [Использование отчетов службы "Управление затратами"](use-reports.md).
