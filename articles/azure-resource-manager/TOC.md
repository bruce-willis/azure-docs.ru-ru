...
## [Создание шаблонов — портал](resource-manager-quickstart-create-templates-use-the-portal.md)
## [Создание шаблонов — VS Code](resource-manager-quickstart-create-templates-use-visual-studio-code.md)
## [Создание шаблонов — Visual Studio](vs-azure-tools-resource-groups-deployment-projects-create-deploy.md)
...
## [Управление персональными данными](resource-manager-personal-data.md)
