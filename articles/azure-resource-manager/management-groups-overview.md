...
На схеме ниже показан пример иерархии, состоящий из групп управления и подписок, упорядоченных по отделам.
...
### <a name="cloud-solution-provider-csp-limitation-during-preview"></a>Ограничение поставщиков облачных решений (CSP) на этапе предварительной версии
