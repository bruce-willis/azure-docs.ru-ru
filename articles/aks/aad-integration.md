...
В этом руководстве описывается создание всех необходимых предварительных условий, необходимых службам AKS и Azure AD, развертывание кластера с поддержкой Azure AD и создание простой роли RBAC в кластере AKS. Обратите внимание на то, что для существующих кластеров AKS без поддержки RBAC сейчас невозможно включить поддержку RBAC.
...
Привязку роли также можно создать для всех членов группы Azure AD. Группы Azure AD указываются с помощью идентификатора объекта группы.
