...
Это максимальные значения *по умолчанию* при развертывании кластера AKS без указания максимального количества контейнеров pod:

| Метод развертывания | базовая; | Расширенная | Настройка при развертывании |
| -- | :--: | :--: | -- |
| Инфраструктура CLI Azure | 110 | 30 | Yes |
| Шаблон Resource Manager | 110 | 30 | Yes |
| Microsoft Azure | 110 | 30 | Нет  |

### <a name="configure-maximum---new-clusters"></a>Настройка максимального числа. Новые кластеры

Чтобы указать другое максимальное количество контейнеров pod на узле при развертывании кластера AKS:
