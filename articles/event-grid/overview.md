...
Ссылки на статьи, в которых показано, как использовать каждый источник событий см. в разделе об [источниках событий в службе "Сетка событий Azure"](event-sources.md).
...
Ссылки на статьи, в которых показано, как использовать каждый источник событий, см. в разделе об [источниках событий в службе "Сетка событий Azure"](event-handlers.md).
