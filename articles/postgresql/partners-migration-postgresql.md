---
title: Партнеры по миграции для базы данных Azure для PostgreSQL | Документы Майкрософт
...
| ![Pragmatic Works][3] |**Pragmatic Works**<br>Компания Pragmatic Works предоставляет услуги по обучению и консультированию и обладает обширным опытом в таких сферах, как управление данными и эффективное использование данных, бизнес-аналитика, большие данные, Power BI и Azure. Основные направления деятельности Pragmatic Works связаны с оптимизацией данных, повышением эффективности SQL Server и управлением облачными ресурсами.|[Веб-сайт][pragmatic-works_website]<br>[Twitter][pragmatic-works_twitter]<br>[YouTube][pragmatic-works_youtube]<br>[Контактные данные][pragmatic-works_contact] | |
...
| ![credativ][5] |**credativ**<br>credativ представляет собой независимую компанию, оказывающую консалтинговые услуги и услуги технической поддержки. Основанная в 1999 году, credativ предоставляет комплексные консалтинговые услуги и техническую поддержку по внедрению и использованию программного обеспечения с открытым исходным кодом в бизнес-приложениях. Ее широкий спектр услуг включает стратегический консалтинг, экспертные технические рекомендации, квалифицированное обучение и индивидуальную поддержку всех ИТ-нужд предприятия, в том числе круглосуточно.|[Marketplace][credativ_marketplace]<br>[Веб-сайт][credativ_website]<br>[Twitter][credative_twitter]<br>[YouTube][credativ_youtube]<br>[Контактные данные][credativ_contact] | |
