...
> [!NOTE]
> В службе "База данных Azure для PostgreSQL" эта функция доступна в общедоступной предварительной версии во всех регионах, где представлено общедоступное облако Azure, в котором развернута база данных Azure для PostgreSQL.
...
Однако к маю 2018 года служба Базы данных Azure для PostgreSQL еще не вошла в список служб, которые могут быть назначены напрямую в подсеть.
...
- Во время общедоступной предварительной версии поддержка операций перемещения в виртуальной сети отсутствует. Чтобы переместить правило виртуальной сети, удалите и создайте его заново.
