...
3. В разделе **Правила брандмауэра** в столбце **Имя правила** щелкните пустое текстовое поле, чтобы создать правило брандмауэра. 
    ...
    AllowAllIps | 0.0.0.0 | 255.255.255.255
     ...
     ![Настройка правил брандмауэра](./media/quickstart-create-database-portal/5-firewall-2.png)
      ...
      > [!NOTE]
      > Для экземпляров, выполняемых в рабочей среде, следует задать свои правила брандмауэра, чтобы принимать входящие запросы с известных IP-адресов.  Параметры на изображении выше приведены только в качестве примера.
      >
