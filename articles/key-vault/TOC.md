...
## Node.js
### [Управление хранилищем](https://docs.microsoft.com/en-us/javascript/api/overview/azure/keyvault/client?view=azure-node-latest)
### [Управление содержимым хранилища](https://docs.microsoft.com/en-us/javascript/api/azure-arm-keyvault/index?view=azure-node-latest)
...
## [Функции данных клиентов](key-vault-customer-data.md)
...
## [Примеры кода](https://github.com/Azure-Samples?utf8=%E2%9C%93&q=key+vault&type=&language=)
