...
## [Считывание данных из Key Vault с использованием Node.js](quick-create-node.md)
# Учебники
...
## Node.js
### [Управление хранилищем](https://docs.microsoft.com/javascript/api/azure-arm-keyvault/)
### [Клиентская библиотека хранилища](https://docs.microsoft.com/javascript/api/azure-keyvault/)
## Разработка
