...
Дополнительные сведения см. в разделе [Azure Key Vault REST API reference](/rest/api/keyvault) (Справочник по API-интерфейсу REST службы Azure Key Vault).  
...
Дополнительные сведения о работе с секретами см. в разделе [Azure Key Vault REST API reference](/rest/api/keyvault) (Справочник по API-интерфейсу REST службы Azure Key Vault).  
