...
## <a name="copy-your-data-warehouse-with-user-defined-restore-points"></a>Копирование хранилища данных с точками восстановления, определенными пользователем
...
5. Получите последнюю точку восстановления с помощью указанной метки RestorePointLabel.
6. Получите идентификатор ресурса базы данных для запуска восстановления.
6. Восстановите базу данных в желаемой точке восстановления.
7. Убедитесь, что восстановленная база данных подключена к сети.
...
## <a name="create-a-user-defined-restore-point"></a>Создание определенной пользователем точки восстановления
