---
title: Руководство по DevOps на портале Azure | Документация Майкрософт
...
6. Далее, чтобы включить для приложения непрерывное развертывание, необходимо настроить некоторые параметры. Щелкните "Источник развертывания", а затем выберите "Выбор источника". Обратите внимание на доступные источники репозиториев.
   ...
   ![рисунок 6][image6]
7. Для этого примера выберите GitHub. При необходимости можно выбрать другой репозиторий и настроить для него учетные данные авторизации.
...
12. После применения изменений в репозитории на портале в области уведомлений отобразится новое уведомление о развертывании. Если изменения не отображаются, нажмите кнопку "Синхронизировать".
    ...
    ![image12][image12]
13. На этом этапе при загрузке страницы для службы приложений может появиться ошибка 403. Это происходит из-за того, что для страницы не задан документ по умолчанию (например, index.htm или default.html). Используйте инструменты на портале Azure, чтобы быстро исправить это.  На портале Azure выберите "Параметры" &gt; "Параметры приложения".
...
1. В области навигации портала Azure щелкните "Службы приложений" и найдите службу приложений.
...
12. Вернитесь к разделу "Инструменты" для приложения на портале Azure. Прокрутите вниз к разделу "Инструменты" и выберите "Обозреватель процессов".
    ...
    ![рисунок 50][image50]
13. Параметр "Обозреватель процессов" позволяет просматривать сведения о запущенных процессах. На снимке экрана ниже видно, что можно просмотреть более подробные сведения о процессе и даже завершить все процессы с портала Azure.
...
14. Вернитесь к колонке "Параметры" в левой части окна. Щелкните "Новый запрос в службу поддержки".
    ...
    ![рисунок 53][image53]
15. В колонке справа можно добавить сведения о неполадках, контактную информацию и даже загрузить данные диагностики. Портал Azure поддерживает работу со службой поддержки Майкрософт.
    
    ![рисунок 54][image54]
    
    ![рисунок 55][image55]
    
    На портале Azure предоставляются эффективные привычные инструменты для мониторинга и устранения неполадок работающих приложений. Кроме того, здесь можно быстро принимать меры по устранению неполадок, выполняя такие задачи, как перезапуск процессов, включение и отключение разных наборов данных и даже интеграцию со службой поддержки Microsoft.
...
5. Затем создайте и выберите контейнер хранилища для хранения резервных копий. Щелкните кнопку "Создать" в нижней части колонки, а затем выберите контейнер.
   ...
   ![рисунок 60][image60]
6. После выбора контейнера можно настроить расписания, а также резервное копирование для баз данных. В данном случае щелкните значок "Сохранить".
...
11. В колонке справа выберите "Проверка подлинности службы приложений". Обратите внимание на различные параметры, которые можно настроить с помощью популярных поставщиков.
     ...
     ![рисунок 66][image66]
12. Выберите необходимого поставщика и просмотрите параметры, которые можно для него настроить. Указав идентификатор и секрет для приложения, можно быстро активировать проверку подлинности для него в Facebook. Портал Azure предоставляет готовое решение для аутентификации приложений.
