...
Скачайте пример имитации устройства в виде проекта Node.js по адресу https://github.com/Azure-Samples/iot-hub-tutorials-node/archive/master.zip и разверните этот ZIP-архив.
