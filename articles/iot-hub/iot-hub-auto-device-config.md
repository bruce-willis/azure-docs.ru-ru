...
> [!Note]
> В предварительной версии эта функция недоступна для Центров Интернета вещей в регионах "Восточная часть США", "Западная часть США", "Северная Европа" и "Западная Европа".
...
1. Выберите **IoT device configuration (preview)** (Конфигурация устройства Интернета вещей (предварительная версия)).
