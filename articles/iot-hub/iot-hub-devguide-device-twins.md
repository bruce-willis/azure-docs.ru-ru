...
* **Свойства удостоверений устройств**. Корень документа JSON двойника устройства содержит свойства только для чтения из соответствующего удостоверения устройства, хранимые в [реестре удостоверений](iot-hub-devguide-identity-registry.md).
...
* [Начало работы с двойниками устройств (Node)](iot-hub-node-node-twin-getstarted.md)
