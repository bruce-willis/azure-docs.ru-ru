...
> [!NOTE]
> Если не видите раздел с MXCHIP AZ3166, проверьте правильность подключения устройства и перезапустите Visual Studio Code.  
...
> [!NOTE]
> Если страница зависает в состоянии загрузки на этапе входа в Azure, см. раздел с [вопросами и ответами](https://microsoft.github.io/azure-iot-developer-kit/docs/faq/#page-hangs-when-log-in-azure).
