...
### [Защита центра с использованием сертификата X.509](iot-hub-security-x509-get-started.md)
...
## [REST (устройство)](https://docs.microsoft.com/rest/api/iothub/device)
## [REST (служба)](https://docs.microsoft.com/rest/api/iothub/service)
## [REST (ресурсы Центра Интернета вещей)](https://docs.microsoft.com/rest/api/iothub/iothubresource)
## [REST (сертификаты)](https://docs.microsoft.com/rest/api/iothub/certificates)

# Сопутствующие материалы
## Решения 
### [акселераторы решений Интернета вещей](/azure/iot-accelerators); 
