...
description: В статье описываются и сравниваются различные типы лабораторий, которые вы можете создать, используя Службы лабораторий Azure.
...
ms.locfileid: "34637879"
---
# <a name="compare-managed-labs-in-azure-lab-services-and-devtest-labs"></a>Сравнение управляемых лабораторий и лабораторий в Службах лабораторий Azure и DevTest Labs
...
## <a name="managed-labs-vs-devtest-labs"></a>Управляемые лаборатории и DevTest Labs
В следующей таблице приведены два типа лабораторий, которые поддерживаются Службами лабораторий Azure: 

| Функции | Управляемые лаборатории. | DevTest Labs |
| -------- | ----------------  | ---------- |
...
- [Руководство по настройке лаборатории для аудитории](classroom-labs/tutorial-setup-classroom-lab.md)
