...
1. Нажмите клавишу F5, чтобы запустить сценарий и генератор нагрузки. Оставьте значения параметров по умолчанию.
1. Войдите с учетной записью Azure и, при необходимости, выберите подписку, которую вы хотите использовать.
...
1. Нажмите клавишу F5 для запуска сценария. Не изменяйте значения по умолчанию.
...
1. Вернитесь к списку серверов SQL.

1. Откройте сервер **tenants1-dpt-&lt;пользователь&gt;**, который содержит клиентские базы данных.

1. Обратите внимание на следующие элементы:
