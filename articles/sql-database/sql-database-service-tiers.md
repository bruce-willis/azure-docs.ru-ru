...
> [!IMPORTANT]
> [Базы данных уровня "Гипермасштабирование" (предварительная версия)](sql-database-hyperscale.md) доступны только в модели приобретения на основе виртуальных ядер для отдельных баз данных с логическим сервером или в рамках Управляемого экземпляра. 
