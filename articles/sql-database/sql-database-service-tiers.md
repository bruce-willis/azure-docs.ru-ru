...
ms.locfileid: "39091921"
---
# <a name="azure-sql-database-purchasing-models-and-resources"></a>Ресурсы и модели приобретения для базы данных SQL Azure 

Логические серверы в [Базе данных SQL Azure](sql-database-technical-overview.md) предлагают две модели приобретения для ресурсов вычисления, хранения и операций ввода-вывода: на основе единиц DTU и на основе виртуальных ядер. 
