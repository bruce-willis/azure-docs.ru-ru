...
## <a name="create-a-log-analytics-reader-alert-for-email-notifications"></a>Создание оповещения читателя Log Analytics для уведомлений по почте
