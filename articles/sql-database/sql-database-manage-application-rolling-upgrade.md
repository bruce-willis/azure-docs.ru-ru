...
2. Создайте профиль отработки отказов в ATM, используя <i>contoso-1.azurewebsites.net</i> в качестве рабочей конечной точки и <i>contoso-2.azurewebsites.net</i> в качестве автономной. 
...
1. Переключите рабочую конечную точку в профиле ATM на <i>contoso-2.azurewebsites.net</i>, которая указывает на версию V2 веб-сайта (6). Теперь она становится рабочим слотом с приложением V2, куда направляется трафик пользователей.  
...
> [!NOTE]
> Откат не требует изменения профиля ATM, так как уже указывает на <i>contoso-1.azurewebsites.net</i> как активную конечную точку.
> 
> 
...
4. Добавьте дополнительные конечные точки <i>contoso-2.azurewebsites.net</i> и <i>contoso-3.azurewebsites.net</i> в профиль отработки отказа в ATM как автономные конечные точки (5). 
...
1. Переключите активную конечную точку в профиле ATM на <i>contoso-2.azurewebsites.net</i>, которая теперь указывает на версию V2 веб-сайта (9). Теперь она становится рабочим слотом с приложением V2, куда направляется трафик конечных пользователей. 
