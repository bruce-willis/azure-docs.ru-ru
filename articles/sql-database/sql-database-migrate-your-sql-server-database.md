...
2. Чтобы задать уровень служб **Стандартный** и объем вычислительных ресурсов **S1**, выполните приведенную ниже команду.
