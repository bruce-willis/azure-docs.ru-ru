...
- в качестве части коллекции баз данных, известных как [управляемый экземпляр](sql-database-managed-instance.md) (в общедоступной предварительной версии), которая содержит базы данных системы и пользователей и общий набор ресурсов.
