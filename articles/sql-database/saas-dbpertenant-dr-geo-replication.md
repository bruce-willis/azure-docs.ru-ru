...
* Настройка
    * Устанавливать и поддерживать среду зеркального отображения в регионе восстановления. При создании эластичных пулов и репликации отдельных баз данных в этой среде резервируется емкость в регионе восстановления. Обслуживание этой среды включает в себя репликацию новых баз данных клиентов по мере их создания.  
* Восстановление
    * Если для минимизации ежедневных затрат используется свернутая среда восстановления, пулы и отдельные базы данных должны быть расширены, чтобы получить полную работоспособность в регионе восстановления.
