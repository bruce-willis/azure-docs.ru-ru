...
> [!NOTE]
> Пока действует предварительная версия, мы не будем выполнять циклический перебор или любую другую маршрутизацию с балансировкой нагрузки между локальными репликами базы данных-получателя. 
