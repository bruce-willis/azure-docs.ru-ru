...
| Максимальная | Логический сервер | Управляемый экземпляр |
| :--- | :--- | :--- |
| Баз данных на сервер или экземпляр | 5000 | 100 |
| Количество серверов по умолчанию на одну подписку в любом регионе | 20 | Недоступно |
| Максимальное количество серверов на одну подписку в любом регионе | 200 | Недоступно | 
| Квота DTU или eDTU на сервер | 54 000 | Недоступно |  
| Квота виртуальных ядер на сервер или экземпляр | 540 | 80 |
| Максимальное число пулов на сервер | ограничено числом DTU или виртуальных ядер | Недоступно |
||||
