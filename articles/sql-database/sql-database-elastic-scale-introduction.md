...
* [Запрос к эластичной базе данных](sql-database-elastic-query-overview.md) (предварительная версия) позволяет выполнять запросы Transact-SQL, охватывающие несколько баз данных. Это позволяет подключить средства создания отчетов, например Excel, Power BI, Tableau и т. д.
