...
* [База данных SQL Azure](https://azure.microsoft.com/services/sql-database/). Ядро базы данных SQL на основе SQL Server Enterprise Edition, оптимизированное для разработки современных приложений. База данных SQL Azure предлагает две версии SQL в качестве размещенной службы: логические серверы и [Управляемые экземпляры базы данных SQL Azure (предварительная версия)](sql-database-managed-instance.md). В обоих версиях база данных SQL Azure предоставляет дополнительные функции, недоступные в SQL Server, например встроенная аналитика и управление. С первой версией у вас может быть логический сервер, содержащий [отдельные базы данных](sql-database-servers-databases.md), и вы можете сгруппировать серверы в [эластичный пул](sql-database-elastic-pool.md), чтобы совместно использовать ресурсы и снизить затраты. Логический сервер базы данных SQL Azure с отдельными базами данных в пуле обеспечивает большую часть возможностей уровня базы данных в SQL Server. С управляемым экземпляром базы данных SQL Azure база данных SQL Azure предлагает совместные ресурсы для баз данных и дополнительные возможности уровня экземпляра. Управляемый экземпляр базы данных SQL Azure поддерживает миграцию базы данных с минимальными изменениями базы данных или вовсе без них.
