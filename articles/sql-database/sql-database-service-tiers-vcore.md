...
|служба хранилища.|[Удаленное хранилище уровня "Премиум"](../virtual-machines/windows/premium-storage.md),<br/>Отдельная база данных: 5 ГБ – 4 ТБ<br/>Управляемый экземпляр: 32 ГБ — 8 ТБ |Локальное хранилище на SSD-накопителях,<br/>Отдельная база данных: 5 ГБ – 4 ТБ<br/>Управляемый экземпляр: 32 ГБ — 4 ТБ |
...
- Можно выбрать любой размер отдельной базы данных: от 10 ГБ до максимально допустимого значения
