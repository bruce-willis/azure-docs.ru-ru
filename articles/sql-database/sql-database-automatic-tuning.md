...
Параметры автоматической настройки, доступные в базе данных SQL Azure:
 ...
 2. **Удалить индекс** — определяет избыточные и повторяющиеся индексы, а также индексы, которые не использовались долгое время. Обратите внимание, что эта функция несовместима с приложениями, которые используют переключения секций и подсказки индекса.
