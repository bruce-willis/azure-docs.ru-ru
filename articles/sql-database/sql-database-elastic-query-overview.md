...
Эластичные запросы поддерживаются для хранилища с уровнями производительности "Стандартный" и "Премиум". Сведения об ограничениях производительности для нижних уровней производительности см. в разделе "Ограничения предварительной версии" ниже.
...
> Независимо от выбранной конфигурации убедитесь, что уровень службы и производительности достаточно высок для обработки ожидаемого количества запросов и запросов на вход.
