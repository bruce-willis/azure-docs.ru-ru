...
Установите последнюю версию модуля **AzureRM.Sql**, чтобы получить командлеты задания обработки эластичных баз данных. Выполните следующие команды в командной строке с повышенными привилегиями (от имени администратора):
