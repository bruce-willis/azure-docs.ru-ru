...
В этой статье описаны альтернативные клиентские модели.

## <a name="a-saas-concepts-and-terminology"></a>О. Понятия и терминология SaaS
...
- *Однопользовательская модель.*&nbsp; В каждой базе данных хранятся данные только от одного клиента.
- *Многопользовательская модель.*&nbsp; В каждой базе данных хранятся данные нескольких отдельных клиентов (с механизмами защиты конфиденциальности данных).
- Доступны также гибридные клиентские модели.

## <a name="b-how-to-choose-the-appropriate-tenancy-model"></a>B. Как выбрать соответствующую клиентскую модель
...
## <a name="c-standalone-single-tenant-app-with-single-tenant-database"></a>C. Изолированное однотенантное приложение с однотенантной базой данных
...
## <a name="d-multi-tenant-app-with-database-per-tenant"></a>D. Мультитенантное приложение с однотенантной базой данных
...
## <a name="f-multi-tenant-app-with-a-single-multi-tenant-database"></a>F. Мультитенантное приложение с отдельной мультитенантной базой данных
...
## <a name="i-tenancy-models-compared"></a>1. Сравнение клиентских моделей
