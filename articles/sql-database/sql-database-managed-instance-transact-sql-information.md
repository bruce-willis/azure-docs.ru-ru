...
Например, если Управляемый экземпляр использует один файл размером 1,2 ТБ, размещенный на диске емкостью 4 ТБ, и 248 файлов по 1 ГБ каждый, размещенные на отдельных дисках емкостью по 128 ГБ. В этом примере 
