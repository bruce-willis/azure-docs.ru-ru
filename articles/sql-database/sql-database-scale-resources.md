...
> [!IMPORTANT]
> Переходить с уровня служб общего назначения или "Критически важный для бизнеса" на уровень "Гипермасштабирование" нельзя. Однако вы можете менять уровни производительности на уровне "Гипермасштабирование".
