...
Установите модуль **AzureRM.Sql** 4.8.1-preview, чтобы получить актуальные командлеты эластичных заданий. Выполните приведенные ниже команды в PowerShell с правами администратора.
