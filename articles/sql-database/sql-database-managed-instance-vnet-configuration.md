...
## <a name="create-a-new-virtual-network-for-managed-instances-using-portal"></a>Создание виртуальной сети для управляемых экземпляров с помощью портала
