...
| 40860 |EX_USER |Недопустимая комбинация эластичного пула '%ls' и цели службы '%ls'. |имя эластичного пула, уровень служб |Эластичный пул и уровень служб можно указать вместе только в том случае, если тип ресурса задан как ElasticPool. |Укажите правильную комбинацию эластичного пула и уровня службы. |
