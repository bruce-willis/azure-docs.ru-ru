---
title: Изменение параметров ReliableDictionaryActorStateProvider в микрослужбах Azure | Документация Майкрософт
...
Конфигурации репликатора используются для настройки репликатора, отвечающего за надежность состояния поставщика состояний субъекта путем репликации и локального сохранения состояния.
