---
title: Сложные типы в схеме XML модели службы Azure Service Fabric | Документация Майкрософт
description: Эта статья содержит сведения о сложных типах в схеме XML модели службы Service Fabric.
...
ms.locfileid: "35248509"
---
<!-- This article was generated by the Python script found in the service-fabric-service-model-schema.md file -->

# <a name="service-model-xml-schema-complex-types"></a>Сложные типы в схеме XML модели службы 
...
#### <a name="name"></a>ИМЯ
Имя приложения, которое необходимо создать.
|Атрибут|Значение|
|---|---|
|name|ИМЯ|
|Тип|xs:string|
...
Указывает, следует ли при оценке работоспособности обрабатывать предупреждения как ошибки. По умолчанию: false.
|Атрибут|Значение|
|---|---|
...
Указывает максимально допустимый процент неработоспособных приложений, превышение которого вызывает состояние Error при оценке приложения. Это выраженное частное от деления количества неработоспособных развернутых приложений на количество узлов в кластере, на которых сейчас развернуты приложения. Расчет округляется: на небольшом количестве узлов допускается один сбой. Значение в процентах по умолчанию: 0.
|Атрибут|Значение|
|---|---|
...
|Тип|[ServiceTypeHealthPolicyType](#servicetypehealthpolicytype-complextype)|
|minOccurs|0|
...
|Тип|[ServiceTemplatesType](#servicetemplatestype-complextype)|

#### <a name="defaultservices"></a>DefaultServices
|Атрибут|Значение|
|---|---|
|name|DefaultServices|
|Тип|[DefaultServicesType](#defaultservicestype-complextype)|
...
|---|---|
|name|Principals|
|Тип|[SecurityPrincipalsType](#securityprincipalstype-complextype)|
|minOccurs|0|
...
|---|---|
|name|Политики|
|Тип|[ApplicationPoliciesType](#applicationpoliciestype-complextype)|
|minOccurs|0|
...
|---|---|
|name|Диагностика|
|Тип|[DiagnosticsType](#diagnosticstype-complextype)|
|minOccurs|0|
...
Значение контрольной суммы содержимого ApplicationPackage
|Атрибут|Значение|
|---|---|
...
|Тип|[EnvironmentType](#environmenttype-complextype)|
...
Определяет учетную запись пользователя по умолчанию для всех пакетов кода службы, для которых не определен атрибут RunAsPolicy в разделе ServiceManifestImport.
|Атрибут|Значение|
|---|---|
...
|---|---|
|name|HealthPolicy|
|Тип|[ApplicationHealthPolicyType](#applicationhealthpolicytype-complextype)|
|minOccurs|0|
...
|Тип|[FabricCertificateType](#fabriccertificatetype-complextype)|
|minOccurs|0|
...
|---|---|
|name|FabricSettings|
|Тип|[SettingsOverridesType](#settingsoverridestype-complextype)|
|minOccurs|0|
...
Указывает, является ли содержимое этого пакета кода общим для других пакетов кода. Если значение равно True, то при обновлении этого пакета будут перезапущены все пакеты кода. Этот атрибут сейчас не поддерживается, и его значение будет пропущено.
|Атрибут|Значение|
|---|---|
|name|IsShared|
|Тип|xs:boolean|
...
|---|---|
|name|EntryPoint|
|Тип|[EntryPointDescriptionType](#entrypointdescriptiontype-complextype)|
|minOccurs|1|
...
|Тип|[EnvironmentVariablesType](#environmentvariablestype-complextype)|
|minOccurs|0|
|maxOccurs|1|
...
#### <a name="name"></a>ИМЯ
Имя пакета конфигурации в манифесте служб, который содержит параметры для переопределения.
|Атрибут|Значение|
|---|---|
|name|ИМЯ|
|use|обязательно|
...
Имя хранилища сертификата X509.
|Атрибут|Значение|
|---|---|
|name|X509StoreName|
|Тип|xs:string|
...
Имя пакета данных с файлами сертификата.
|Атрибут|Значение|
|---|---|
|name|DataPackageRef|
|Тип|xs:string|
...
Версия пакета данных с файлами сертификата.
|Атрибут|Значение|
|---|---|
...
Относительный путь к файлу сертификата в пакете данных.
|Атрибут|Значение|
|---|---|
|name|RelativePath|
|Тип|xs:string|
...
Пароль или закрытый ключ сертификата.
|Атрибут|Значение|
|---|---|
|name|Пароль|
|Тип|xs:string|
...
Если значение равно True, пароль шифруется.
|Атрибут|Значение|
|---|---|
...
#### <a name="name"></a>ИМЯ
Идентификатор сведений о конкретном сертификате. Это имя позволяет задать переменную среду в контейнере.
|Атрибут|Значение|
|---|---|
|name|ИМЯ|
|Тип|xs:string|
...
Если у контейнера включен параметр HEALTHCHECK и Docker сообщает о событии health_status для этого контейнера, Service Fabric включит его в сообщение о работоспособности системы. Если событие health_status связано с неработоспособностью, Service Fabric отправит соответствующее предупреждение. По умолчанию установлено значение true.
|Атрибут|Значение|
|---|---|
...
Если у контейнера включен параметр HEALTHCHECK и Docker сообщает о событии health_status для этого контейнера, Service Fabric перезапустит контейнер после сообщения Docker о неработоспособности.
...
Репозиторий и образ на https://hub.docker.com или реестр контейнеров Azure.
|Атрибут|Значение|
|---|---|
|name|ImageName|
|Тип|xs:string|
...
|Атрибут|Значение|
|---|---|
|Содержимое|9 элементов, 5 атрибутов|
|defined|globally|
...
Режим изоляции контейнера. Допустимые значения – это default, process или hyperv (поддерживается только для контейнеров Windows). На узлах Windows 10 поддерживается только режим изоляции Hyper-V, поэтому контейнер работает в режиме изоляции Hyper-V независимо от параметра режима изоляции.
|Атрибут|Значение|
|---|---|
|name|Изоляция|
|use|необязательный|
...
Число контейнеров, которое необходимо оставить, если контейнер многократно выходит из строя. Значение по умолчанию: 0 (контейнеры не остаются).
|Атрибут|Значение|
|---|---|
...
Запускает контейнер со включенным интерактивным флагом. Допустимые значения: True и False. Значение по умолчанию: False.
|Атрибут|Значение|
|---|---|
|name|RunInteractive|
|use|необязательный|
...
|Тип|[RepositoryCredentialsType](#repositorycredentialstype-complextype)|
|minOccurs|0|
|maxOccurs|1|
...
|---|---|
|name|HealthConfig|
|Тип|[ContainerHealthConfigType](#containerhealthconfigtype-complextype)|
|minOccurs|0|
|maxOccurs|1|
...
|---|---|
|name|PortBinding|
|Тип|[PortBindingType](#portbindingtype-complextype)|
|minOccurs|0|
|maxOccurs|unbounded|
...
|---|---|
|name|CertificateRef|
|Тип|[ContainerCertificateType](#containercertificatetype-complextype)|
|minOccurs|0|
|maxOccurs|unbounded|
...
|---|---|
|name|LogConfig|
|Тип|[ContainerLoggingDriverType](#containerloggingdrivertype-complextype)|
|minOccurs|0|
|maxOccurs|1|
...
|---|---|
|name|NetworkConfig|
|Тип|[ContainerNetworkConfigType](#containernetworkconfigtype-complextype)|
|minOccurs|0|
|maxOccurs|1|
...
|---|---|
|name|Том|
|Тип|[ContainerVolumeType](#containervolumetype-complextype)|
|minOccurs|0|
|maxOccurs|unbounded|
...
|Тип|[SecurityOptionsType](#securityoptionstype-complextype)|
|minOccurs|0|
|maxOccurs|unbounded|
...
|---|---|
|name|ImageOverrides|
|Тип|[ImageOverridesType](#imageoverridestype-complextype)|
|minOccurs|0|
|maxOccurs|1|
...
|---|---|
|name|DriverOption|
|Тип|[DriverOptionType](#driveroptiontype-complextype)|
|minOccurs|0|
|maxOccurs|unbounded|
...
NetworkType. Сейчас поддерживается только тип Open.
|Атрибут|Значение|
|---|---|
|name|NetworkType|
|use|обязательно|
...
Исходной папкой может быть папка в виртуальной машине, в которой размещаются контейнеры, или постоянное удаленное хранилище.
|Атрибут|Значение|
|---|---|
|name|Источник|
|use|обязательно|
...
Расположение, с которым сопоставляется источник в работающем контейнере. Таким образом, конечной папкой не может быть существующее в контейнере расположение.
|Атрибут|Значение|
|---|---|
...
#### <a name="driver"></a>Драйвер
Имя драйвера для подключаемого модуля тома службы файлов Azure – sfazurefile.
|Атрибут|Значение|
|---|---|
|name|Драйвер|
|use|необязательный|
...
Не поддерживается, не следует использовать. Определяет политику изоляции неуправляемых библиотек DLL и управляемых сборок, загружаемых в DllHost. 
|Атрибут|Значение|
|---|---|
...
|---|---|
|name|UnmanagedDll|
|Тип|[UnmanagedDllType](#unmanageddlltype-complextype)|

#### <a name="managedassembly"></a>ManagedAssembly
|Атрибут|Значение|
|---|---|
|name|ManagedAssembly|
|Тип|[ManagedAssemblyType](#managedassemblytype-complextype)|
## <a name="driveroptiontype-complextype"></a>complexType: DriverOptionType
Параметры драйвера, которые необходимо передать. Подключаемый модуль тома службы файлов Azure поддерживает следующие параметры драйвера: shareName (файловый ресурс службы файлов Azure, предоставляющий том для контейнера), storageAccountName (учетная запись хранения Azure, содержащая файловый ресурс службы файлов Azure), storageAccountKey (ключ доступа для учетной записи хранения Azure, которая содержит файловый ресурс службы файлов Azure).
Три эти параметра драйвера являются обязательными.
...
Имя конечной точки, которое должно быть объявлено в разделе ресурсов манифеста службы.  При использовании HTTPS не используйте тот же порт и сертификат для разных экземпляров службы (независимо от приложения), развернутых на одном узле. Обновление двух разных служб, использующих один порт в разных экземплярах приложения, приведет к сбою обновления.
|Атрибут|Значение|
|---|---|
|name|EndpointRef|

#### <a name="certificateref"></a>CertificateRef
Имя сертификата конечной точки, объявленное в разделе сертификатов, которое возвращается клиенту. 
|Атрибут|Значение|
|---|---|
|name|CertificateRef|
|use|обязательно|
...
#### <a name="port"></a>Порт
Порт будет переопределен в манифесте службы
|Атрибут|Значение|
|---|---|
|name|Порт|
|Тип|xs:string|
...
Протокол конечной точки. Конечные точки HTTPS также должны иметь EndpointCertificate и EndpointBindingPolicy, объявленные в манифесте приложения. Позже протокол невозможно будет изменить при обновлении приложения. 
|Атрибут|Значение|
|---|---|
|name|Протокол|
|Тип|xs:string|
...
#### <a name="type"></a>type
Тип конечной точки.  Входная конечная точка используется, когда необходимо предоставить порт вовне. Внутренние конечные точки используются для передачи данных внутри приложения.
|Атрибут|Значение|
|---|---|
|name|type|
|Тип|xs:string|
...
#### <a name="codepackageref"></a>CodePackageRef
Имя пакета кода, который будет использовать эта конечная точка.
|Атрибут|Значение|
|---|---|
|name|CodePackageRef|
|use|необязательный|
...
#### <a name="certificateref"></a>CertificateRef
Не используйте. Этот атрибут не поддерживается.
|Атрибут|Значение|
|---|---|
|name|CertificateRef|

#### <a name="port"></a>Порт
Порт будет заменен портом, определенным службой Microsoft Azure Service Fabric после регистрации в Http.sys или BFE.
|Атрибут|Значение|
|---|---|
|name|Порт|
...
|---|---|
|name|DllHost|
|Тип|[DllHostEntryPointType](#dllhostentrypointtype-complextype)|

#### <a name="containerhost"></a>ContainerHost
|Атрибут|Значение|
|---|---|
|name|ContainerHost|
|Тип|[ContainerHostEntryPointType](#containerhostentrypointtype-complextype)|
...
|Тип|[EnvironmentVariableType](#environmentvariabletype-complextype)|
|minOccurs|0|
|maxOccurs|unbounded|
...
Значение True, если исполняемый файл находится за пределами пакета приложения. Проверка существования программы в пакете приложения пропускается.
|Атрибут|Значение|
|---|---|
...
Используется только в случае, если учетные данные являются объектами X509. Указывает способ поиска сертификата: по имени или по отпечатку 
|Атрибут|Значение|
|---|---|
|name|X509FindType|
...
#### <a name="x509findvalue"></a>X509FindValue
Используется только в случае, если учетные данные являются объектами X509. Это фактическое имя или отпечаток сертификата.
|Атрибут|Значение|
|---|---|
|name|X509FindValue|
|use|обязательно|
...
|Тип|[InputEndpointType](#inputendpointtype-complextype)|

#### <a name="leasedriverendpoint"></a>LeaseDriverEndpoint
|Атрибут|Значение|
|---|---|
|name|LeaseDriverEndpoint|
|Тип|[InternalEndpointType](#internalendpointtype-complextype)|
...
IP-адрес или полное доменное имя (FQDN) компьютера, на котором следует разместить этот узел.
|Атрибут|Значение|
|---|---|
...
Указывает, является ли пароль зашифрованным или обычным текстом.
|Атрибут|Значение|
|---|---|
...
Образ контейнера соответствует номеру версии сборки ОС, которая будет запущена. Если атрибут Os не указан, предполагается, что образ контейнера работает во всех версиях операционной системы и он имеет приоритет над образом, указанным в манифесте службы.
|Атрибут|Значение|
|---|---|
|name|Образ —|
|Тип|[ImageType](#imagetype-complextype)|
|minOccurs|0|
|maxOccurs|unbounded|
...
#### <a name="os"></a>Os
Версия сборки операционной системы. Например, версия сборки версии Windows Server 1709 – 16299.
|Атрибут|Значение|
|---|---|
|name|Os|
|Тип|xs:string|
...
Имя роли, связанное со ссылкой на тип узла, определенный в разделе NodeTypes.
|Атрибут|Значение|
|---|---|
|name|RoleOrTierName|
|Тип|xs:string|
...
|---|---|
|name|Конечные точки|
|Тип|[FabricEndpointsType](#fabricendpointstype-complextype)|
|minOccurs|0|
...
|---|---|
|name|Сертификаты|
|Тип|[CertificatesType](#certificatestype-complextype)|
|minOccurs|0|
...
#### <a name="name"></a>ИМЯ
Уникальный идентификатор метрики в кластере с точки зрения диспетчера кластерных ресурсов.
|Атрибут|Значение|
|---|---|
|name|ИМЯ|
|use|обязательно|
...
Объем нагрузки по умолчанию, который служба без отслеживания состояния создает для этой метрики.
|Атрибут|Значение|
|---|---|
|name|DefaultLoad|
|Тип|xs:long|
...
Объем нагрузки по умолчанию, которую служба будет производить для этой метрики (если это первичная метрика).
|Атрибут|Значение|
|---|---|
...
Объем нагрузки по умолчанию, которую служба будет производить для этой метрики (если это вторичная метрика).
|Атрибут|Значение|
|---|---|
...
#### <a name="weight"></a>Вес
Указывает вес метрики по сравнению с другими метриками, настроенными для этой службы. Если выполнение двух метрик завершается конфликтом, диспетчер кластерных ресурсов выбирает метрику с более высоким весом. Значение ноль отключает балансировку нагрузки для этой метрики.
|Атрибут|Значение|
|---|---|
|name|Вес|
...
Имя пакета кода, конфигурации и данных для общего использования. Должно соответствовать имени пакета, определенном в манифесте службы.
|Атрибут|Значение|
|---|---|
|name|PackageRef|
...
|---|---|
|name|Параметр|
|Тип|[ParameterType](#parametertype-complextype)|
|minOccurs|1|
|maxOccurs|unbounded|
...
Ограничивает ресурсы, которые могут использоваться на узле и объявляет ограничения для ресурсов для пакета кода службы.
...
Ограничения памяти (в МБ). Принимаются только положительные целые числа. Пакеты кода (контейнеры или процессы) не могут выделить больше памяти, чем задано ограничением, а при попытке сделать это возникнет проблема нехватки памяти.
|Атрибут|Значение|
|---|---|
|name|MemoryInMB|
|Тип|xs:string|
...
Общий объем используемой памяти подкачки, в МБ. Принимаются только положительные целые числа.
|Атрибут|Значение|
|---|---|
|name|MemorySwapInMB|
|Тип|xs:string|
...
Мягкое ограничение (в МБ) для управления памятью, которое применяется, только когда на узле обнаруживается состязание за память. Принимаются только положительные целые числа.
|Атрибут|Значение|
|---|---|
...
Относительный вес ЦП. Принимаются только положительные целые числа.
|Атрибут|Значение|
|---|---|
|name|CpuShares|
|Тип|xs:string|
...
Процент доступных используемых ЦП (только для Windows). Принимаются только положительные целые числа. Если ограничения ресурсов ЦП указаны для пакета службы, этот параметр игнорируется.
|Атрибут|Значение|
|---|---|
|name|CpuPercent|
|Тип|xs:string|
...
Максимальная скорость ввода-вывода (чтение и запись) с точки зрения операций ввода-вывода, которые могут использоваться. Принимаются только положительные целые числа.
|Атрибут|Значение|
|---|---|
|name|MaximumIOps|
|Тип|xs:string|
...
Максимальная скорость ввода-вывода (в байтах в секунду), которую можно использовать (чтение и запись). Принимаются только положительные целые числа.
|Атрибут|Значение|
|---|---|
...
Вес блока ввода-вывода, относительно других пакетов кода. Принимается только целочисленное значение в диапазоне от 10 до 1000.
|Атрибут|Значение|
|---|---|
|name|BlockIOWeight|
|Тип|xs:string|
...
#### <a name="codepackageref"></a>CodePackageRef
Имя пакета кода. Должно соответствовать имени CodePackage, указанном в манифесте службы.
|Атрибут|Значение|
|---|---|
|name|CodePackageRef|
|use|обязательно|
...
Учетная запись пользователя, от имени которого будет выполняться пакет служебного кода.  Учетная запись пользователя должна быть объявлена в разделе Principals. Для запуска точки входа установки обычно лучше использовать учетную запись локальной системы, а не учетную запись администратора.
|Атрибут|Значение|
|---|---|
|name|UserRef|
|use|обязательно|
...
#### <a name="entrypointtype"></a>EntryPointType
Значение Setup относится к точке входа SetupEntryPoint, объявленной в манифесте службы (привилегированная точка входа, которая запускается перед любой другой точкой входа).  Значение Main относится к точке входа EntryPoint, объявленной в манифесте службы. Обычно это является узлом, запускаемым на длительный срок. Все это точки входа.
|Атрибут|Значение|
|---|---|
|name|EntryPointType|
|use|необязательный|
...
Ресурс, к которому предоставляется доступ, объявлен и настроен в манифесте службы.
|Атрибут|Значение|
|---|---|
|name|ResourceRef|
|use|обязательно|
...
Пользователь или группа, которым назначены права доступа к ресурсу, должны быть объявлены в разделе Principals.
|Атрибут|Значение|
|---|---|
|name|PrincipalRef|
|use|обязательно|
...
Права, которые необходимо предоставить. Значение по умолчанию — Read.
|Атрибут|Значение|
|---|---|
|name|GrantRights|
|по умолчанию|чтение|
...
Тип ресурса, определенный в манифесте службы (конечная точка или сертификат).
|Атрибут|Значение|
|---|---|
|name|ResourceType|
|use|необязательный|
...
|Тип|[StatefulServiceTypeType](#statefulservicetypetype-complextype)|

#### <a name="statelessservicetype"></a>StatelessServiceType
|Атрибут|Значение|
|---|---|
|name|StatelessServiceType|
|Тип|[StatelessServiceTypeType](#statelessservicetypetype-complextype)|

#### <a name="statefulservicegrouptype"></a>StatefulServiceGroupType
|Атрибут|Значение|
|---|---|
|name|StatefulServiceGroupType|
|Тип|[StatefulServiceGroupTypeType](#statefulservicegrouptypetype-complextype)|

#### <a name="statelessservicegrouptype"></a>StatelessServiceGroupType
|Атрибут|Значение|
|---|---|
|name|StatelessServiceGroupType|
|Тип|[StatelessServiceGroupTypeType](#statelessservicegrouptypetype-complextype)|
...
#### <a name="name"></a>ИМЯ
Имя члена группы служб, заданное относительно имени группы служб.
|Атрибут|Значение|
|---|---|
|name|ИМЯ|
|use|обязательно|
...
Определяемый пользователем идентификатор типа для группы служб. Например, ActorQueueSGType. Это значение используется в файле ApplicationManifest.xml для идентификации группы служб.
|Атрибут|Значение|
|---|---|
...
Указывает, создается ли экземпляр группы служб с помощью неявной фабрики. Если это значение False (по умолчанию), один из пакетов кода должен зарегистрировать фабрику групп служб
|Атрибут|Значение|
|---|---|
...
|---|---|
|name|RunAsPolicy|
|Тип|[RunAsPolicyType](#runaspolicytype-complextype)|
|minOccurs|0|
...
|Тип|[SecurityAccessPolicyType](#securityaccesspolicytype-complextype)|
|minOccurs|0|
...
|Тип|[PackageSharingPolicyType](#packagesharingpolicytype-complextype)|
|minOccurs|0|
...
|Тип|[EndpointBindingPolicyType](#endpointbindingpolicytype-complextype)|
|minOccurs|0|
...
|Тип|[ServicePackageResourceGovernancePolicyType](#servicepackageresourcegovernancepolicytype-complextype)|
|minOccurs|0|
|maxOccurs|1|
...
|Тип|[ResourceGovernancePolicyType](#resourcegovernancepolicytype-complextype)|
|minOccurs|0|
...
|Тип|[ContainerHostPoliciesType](#containerhostpoliciestype-complextype)|
|minOccurs|0|
...
Идентификатор этого манифеста службы (неструктурированная строка).
|Атрибут|Значение|
|---|---|
|name|ManifestId|
|use|необязательный|
...
|---|---|
|name|ServiceTypes|
|Тип|[ServiceAndServiceGroupTypesType](#serviceandservicegrouptypestype-complextype)|

#### <a name="codepackage"></a>CodePackage
|Атрибут|Значение|
|---|---|
|name|CodePackage|
|Тип|[CodePackageType](#codepackagetype-complextype)|
|maxOccurs|unbounded|
...
|---|---|
|name|ConfigPackage|
|Тип|[ConfigPackageType](#configpackagetype-complextype)|
|minOccurs|0|
|maxOccurs|unbounded|
...
|---|---|
|name|DataPackage|
|Тип|[DataPackageType](#datapackagetype-complextype)|
|minOccurs|0|
|maxOccurs|unbounded|
...
|---|---|
|name|Ресурсы|
|Тип|[ResourcesType](#resourcestype-complextype)|
|minOccurs|0|
...
|---|---|
|name|Диагностика|
|Тип|[ServiceDiagnosticsType](#servicediagnosticstype-complextype)|
|minOccurs|0|
...
Предел ЦП в количестве логических ядер. Принимаются только положительные целые числа.
|Атрибут|Значение|
|---|---|
|name|CpuCores|
|Тип|xs:string|
...
#### <a name="memoryinmb"></a>MemoryInMB
Ограничения памяти (в МБ). Принимаются только положительные целые числа.
|Атрибут|Значение|
|---|---|
|name|MemoryInMB|
|Тип|xs:string|
...
#### <a name="contentchecksum"></a>ContentChecksum
Значение контрольной суммы содержимого ServicePackage.
|Атрибут|Значение|
|---|---|
|name|ContentChecksum|
|Тип|xs:string|
...
|Тип|[StatelessServiceType](#statelessservicetype-complextype)|

#### <a name="statefulservice"></a>StatefulService
|Атрибут|Значение|
|---|---|
|name|StatefulService|
|Тип|[StatefulServiceType](#statefulservicetype-complextype)|

#### <a name="statelessservicegroup"></a>StatelessServiceGroup
|Атрибут|Значение|
|---|---|
|name|StatelessServiceGroup|
|Тип|[StatelessServiceGroupType](#statelessservicegrouptype-complextype)|

#### <a name="statefulservicegroup"></a>StatefulServiceGroup
|Атрибут|Значение|
|---|---|
|name|StatefulServiceGroup|
|Тип|[StatefulServiceGroupType](#statefulservicegrouptype-complextype)|
...
#### <a name="servicetypename"></a>ServiceTypeName
Имя типа службы, объявленное в манифесте службы, экземпляр которого будет создан.
|Атрибут|Значение|
|---|---|
|name|ServiceTypeName|
|use|обязательно|
...
#### <a name="placementconstraints"></a>PlacementConstraints
Используется, чтобы контролировать, на каких узлах кластера может выполняться служба. Пара "ключ — значение", которая описывает имя свойства узла и требования службы для этого значения. Из отдельных инструкций можно сформировать необходимое ограничение, сгруппировав их с помощью простой булевой логики. Например, (FirmwareVersion>12 & & InDMZ == True).
|Атрибут|Значение|
|---|---|
|name|PlacementConstraints|
|Тип|xs:string|
...
Указывает максимально допустимый процент неработоспособных служб, превышение которого приведет к оценке приложения как неработоспособного. Значение в процентах по умолчанию: 0.
|Атрибут|Значение|
|---|---|
...
Указывает максимально допустимый процент неработоспособных разделов, превышение которого приведет к оценке службы как неработоспособной. Значение в процентах по умолчанию: 0.
|Атрибут|Значение|
|---|---|
...
Указывает максимально допустимый процент неработоспособных реплик, превышение которого приведет к оценке раздела как неработоспособного. Значение в процентах по умолчанию: 0.
|Атрибут|Значение|
|---|---|
...
#### <a name="servicetypename"></a>ServiceTypeName
Определяемый пользователем идентификатор типа для службы. Например, QueueType или CalculatorType. Это значение используется в файле ApplicationManifest.xml для идентификации службы.
|Атрибут|Значение|
|---|---|
|name|ServiceTypeName|
|use|обязательно|
...
Описывает определяемые пользователем параметры для атрибутов ServiceComponent или Application. Он состоит из одного или нескольких разделов пар "ключ — значение".
...
|Тип|[WindowsFabricDeploymentInformation](#windowsfabricdeploymentinformation-complextype)|
|minOccurs|0|
...
Это расположение манифеста инфраструктуры, который создается в системе.
|Атрибут|Значение|
|---|---|
...
#### <a name="nodename"></a>NodeName
Это имя узла, к которому будет применено обновление Fabric
|Атрибут|Значение|
|---|---|
|name|NodeName|
|Тип|xs:string|
...
Имя EXE-файла, который используется службой установщика для обновления 
|Атрибут|Значение|
|---|---|
...
Параметры для EXE-файла точки входа установки
|Атрибут|Значение|
|---|---|
...
Имя EXE-файла, который используется службой установщика, чтобы отменить обновление
|Атрибут|Значение|
|---|---|
