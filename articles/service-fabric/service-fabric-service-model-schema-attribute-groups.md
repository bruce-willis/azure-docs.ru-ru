...
Имя манифеста службы. Оно должно соответствовать имени, объявленному в элементе ServiceManifest манифеста службы.
|Атрибут|Значение|
|---|---|
...
Версия манифеста службы. Она должна соответствовать версии, объявленной в манифесте службы.
|Атрибут|Значение|
|---|---|
