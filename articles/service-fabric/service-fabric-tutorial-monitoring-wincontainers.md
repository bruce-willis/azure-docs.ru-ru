...
Еще одним преимуществом агента OMS является то, что но дает возможность изменить собираемые счетчики производительности, воспользовавшись пользовательским интерфейсом OMS, а не настраивая агент системы диагностики Azure и каждый раз выполняя обновление с помощью шаблона Resource Manager. Чтобы сделать это, на целевой странице решения мониторинга контейнеров (или Service Fabric) щелкните **рабочая область OMS**.

В рабочей области OMS можно просмотреть решения, создавать настраиваемые панели мониторинга, а также настраивать агент OMS. 
