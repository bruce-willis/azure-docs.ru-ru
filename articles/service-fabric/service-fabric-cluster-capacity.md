...
При использовании узлов одного типа максимальное количество узлов в масштабируемом наборе виртуальных машин не может превышать 100. Возможно, для достижения нужного масштаба вам потребуется добавить масштабируемые наборы виртуальных машин, так как функция автомасштабирования не может добавлять их автоматически. Добавление масштабируемых наборов виртуальных машин в динамический кластер является непростой задачей. Обычно это приводит к тому, что пользователи подготавливают новые кластеры, указывая нужные типы узлов при их создании. 
