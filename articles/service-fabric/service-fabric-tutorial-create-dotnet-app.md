...
В первой части цикла вы узнаете, как выполнять приведенные далее задачи.
...
* [Установите Visual Studio 2017](https://www.visualstudio.com/) версии 15.5 или более поздней версии, а также рабочие нагрузки **Разработка в Azure** и **ASP.NET и веб-разработка**.
...
В проекте **VotingData** щелкните правой кнопкой мыши папку **Контроллеры**, а затем выберите **Добавить -> Новый элемент -> Класс**. Назовите файл **VoteDataController.cs** и нажмите кнопку **Добавить**. Замените содержимое файла следующим содержимым, а затем сохраните изменения.
...
4. Вернитесь в браузер и выберите один из вариантов голосования или добавьте новый вариант. Выполнение остановится на первой точке останова в контроллере API клиентского веб-интерфейса.
    ...
    1. В этом месте код JavaScript в браузере отправляет запрос контроллеру веб-API в службе веб-интерфейса.
