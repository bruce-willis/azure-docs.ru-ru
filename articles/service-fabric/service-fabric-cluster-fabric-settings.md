...
|PlacementConstraints|Строка символов в кодировке Юникод, по умолчанию — L""|Статическое| PlacementConstraints для службы BackupRestore |
|SecretEncryptionCertThumbprint|Строка символов в кодировке Юникод, по умолчанию — L""|Динамический|Отпечаток сертификата X509 шифрования секрета |
|SecretEncryptionCertX509StoreName|Строка символов в кодировке Юникод, по умолчанию — L"My"|  Динамический|    Это означает, что сертификат используется для шифрования и дешифрования учетных записей. Название хранилища сертификатов X.509, которое используется для шифрования и расшифровки учетных данных хранилища, используемых службой резервного восстановления |
...
|LinuxExternalExecutablePath|Строка символов в кодировке Юникод, по умолчанию — L"/usr/bin/" |Статическое|Основной каталог внешних исполняемых команд на узле.|
...
|InvokeContainerApi|Строка символов в кодировке Юникод, по умолчанию — L"Admin"|Динамический|Вызов API контейнера |
