...
Приложение в формате sfpkg можно скачать по [ссылке на SFPKG-файл](https://aka.ms/POA/POA_v2.0.2.sfpkg). Это удобно для [развертывания приложения на основе Azure Resource Manager](service-fabric-application-arm-resource.md).
...
### <a name="version-202-latest"></a>Версия 2.0.2 (последняя)
