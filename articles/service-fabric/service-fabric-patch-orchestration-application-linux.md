...
Приложение в формате sfpkg можно скачать по [ссылке на SFPKG-файл](https://go.microsoft.com/fwlink/?linkid=867984&pc=sfpkg). Это удобно для [развертывания приложения на основе Azure Resource Manager](service-fabric-application-arm-resource.md).
