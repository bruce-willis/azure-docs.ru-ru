...
ms.locfileid: "34809749"
---
<!-- The schema reference articles were generated by the Python script found in the end of this file -->

# <a name="service-model-xml-schema-documentation"></a>Документация по элементам схемы XML для модели службы
В этой статье описывается файл схемы ServiceFabricServiceModel.xsd, устанавливаемый вместе с пакетом SDK Service Fabric.  По умолчанию файл схемы устанавливается по следующему пути: *C:\Program Files\Microsoft SDKs\Service Fabric\schemas\ServiceFabricServiceModel.xsd*.

## <a name="namespace-bindings"></a>Привязки пространств имен
|Prefix (Префикс)|Универсальный код ресурса (URI) пространства имен|
|---|---|
|xs|http://www.w3.org/2001/XMLSchema|

## <a name="component-summary"></a>Сводка по компоненту 
Ниже приведены компоненты, определенные в пространстве имен http://schemas.microsoft.com/2011/01/fabric в ServiceFabricServiceModel.xsd.
- [244 элемента](service-fabric-service-model-schema-elements.md)
- [103 элемента ComplexTypes](service-fabric-service-model-schema-complex-types.md)
- [1 элемент simpleTypes](service-fabric-service-model-schema-simple-types.md)
- [3 группы элементов](service-fabric-service-model-schema-element-groups.md)
- [16 групп атрибутов](service-fabric-service-model-schema-attribute-groups.md)
