...
Ключевой подход в Service Fabric — многократное использование существующего кода, который затем может быть модернизирован с помощью новых микрослужб. Существует пять этапов модернизации приложения, которые можно начинать и останавливать независимо друг от друга. а именно:
...
**Lift-and-shift**. Многие компании переносят имеющиеся монолитные приложения в контейнеры по двум причинам.
