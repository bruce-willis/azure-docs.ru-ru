...
* _Верхнее пороговое значение загрузки_ — это значение, определяющее, когда служба будет **развернута**. Если среднее время загрузки всех экземпляров разделов выше этого значения, служба развернется.
