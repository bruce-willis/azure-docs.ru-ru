---
title: Настройка Jenkins для приложения Java в Service Fabric в Azure | Документы Майкрософт
...
1. Запустите образ контейнера из расположения, в котором сертификат подключен на локальном компьютере.
...
1. Создайте **элемент** на панели мониторинга Jenkins.
...
1. Настройте свой *Github* (где размещен репозиторий), чтобы он мог обмениваться данными с Jenkins. Выполните следующие действия.
...
1. Чтобы запустить задание Jenkins, выполняющее обновление приложения, отправьте новые изменения в репозиторий Github.
