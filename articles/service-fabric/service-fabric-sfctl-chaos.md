...
| --warning-as-error | Устанавливает политику работоспособности для обработки предупреждений как ошибки. |
