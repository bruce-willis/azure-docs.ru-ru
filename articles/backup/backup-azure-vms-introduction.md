...
Ниже приведены рекомендации, которые следует учитывать при настройке резервного копирования виртуальных машин с неуправляемыми дисками.

> [!Note]
> Следующие методы, которые рекомендуют изменять или управлять учетными записями, применяются только к виртуальным машинам с неуправляемыми дисками. Если вы используете управляемые диски, служба Azure позаботится обо всех управленческих действиях, связанных с хранилищем.
> 
...
* Для резервных копий виртуальных машин уровня "Премиум" в стеке резервных копий виртуальных машин версии 1 рекомендуется выделять только 50 % от общего объема хранилища учетной записи хранения, чтобы служба Azure Backup могла скопировать моментальный снимок в учетную запись хранения и перенести данные из этого скопированного расположения в учетной записи хранения в хранилище.
