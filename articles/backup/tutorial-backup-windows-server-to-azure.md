...
6. Прежде чем запустить скачанный файл, нажмите кнопку **Загрузка** в колонке "Подготовка инфраструктуры" и сохраните файл **Vault Credentials**. Этот файл необходим для подключения агента MARS к хранилищу Служб восстановления.
