...
### <a name="can-i-migrate-my-vault-between-subscriptions-br"></a>Можно ли перенести хранилище из одной подписки в другую? <br/>
Нет. Хранилище создается на уровне подписки, и его нельзя перенести в другую подписку.

### <a name="can-i-migrate-backup-data-to-another-vault-br"></a>Можно ли перенести данные резервного копирования в другое хранилище? <br/>
