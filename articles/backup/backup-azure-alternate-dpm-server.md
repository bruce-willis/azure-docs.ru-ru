...
| 4. |Указанная парольная фраза не соответствует парольной фразе, связанной со следующим сервером: **<server name>** |**Причина:** указанная парольная фраза не соответствует парольной фразе для шифрования, использованной при шифровании восстанавливаемых данных Azure Backup Server. Агенту не удалось расшифровать данные. Поэтому восстановление завершается неудачно.<br>**Решение:** укажите именно ту парольную фразу, которая связана с Azure Backup Server, данные для которого восстанавливаются. |
