...
| Включение архивации виртуальных машин Azure | Оператор резервного копирования, определенный в области группы ресурсов, которая содержит хранилище, участник виртуальной машины для виртуальных машин |
| Архивация виртуальной машины по запросу | Оператор архивации |
| Восстановление виртуальной машины | Оператор резервного копирования, участник группы ресурсов, в которой развертывается виртуальная машина; выбраны права "чтение" для виртуальной сети и "присоединение" для подсети |
