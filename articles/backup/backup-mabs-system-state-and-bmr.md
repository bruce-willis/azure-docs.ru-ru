---
title: Защита состояния системы и ее восстановление до исходного состояния с помощью Azure Backup Server
...
|Azure Backup|Проблема|Восстановление из резервной копии Azure Backup Server|Восстановление из резервной копии состояния системы|Восстановление исходного состояния системы|
|----------|---------|---------------------------|------------------------------------|-------|
