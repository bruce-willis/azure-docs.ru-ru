...
URL-адрес для этого примера неправильно отображается на странице. Для решения этой проблемы скопируйте URL-адрес ниже и вставьте его в строку URL-адреса в браузере: `https://jsfiddle.net/liamca/gkvfLe6s/1/?index=nycjobs&apikey=252044BE3886FE4A8E3BAA4F595114BB&query=api-version=2017-11-11%26queryType=full%26$select=business_title%26search=business_title:/(Sen|Jun)ior/)`
