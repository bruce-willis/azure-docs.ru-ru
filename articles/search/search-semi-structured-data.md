---
title: Руководство по поиску частично структурированных данных в облачном хранилище Azure с помощью службы "Поиск Azure" | Документация Майкрософт
