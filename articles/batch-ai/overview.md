...
* очередь заданий, основанная на приоритетах, для совместного использования кластеров и возможности использования виртуальных машин с низким приоритетом и резервирований Azure;  
