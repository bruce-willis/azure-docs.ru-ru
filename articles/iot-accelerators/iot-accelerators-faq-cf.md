...
При развертывании с [www.azureiotsolutions.com](http://www.azureiotsolutions.com) проверяется, чтобы в вашей подписке был включен API для Карт Bing для организаций, и в решении "Подключенная фабрика" автоматически развертывается интерактивная карта. Если это не так, можно включить интерактивную карту в развертывании следующим образом:
...
![Ключ Bing](./media/iot-accelerators-faq-cf/bing.png)
...
* [Predictive Maintenance solution accelerator overview](iot-accelerators-predictive-overview.md) (Общие сведения об акселераторе решения для прогнозного обслуживания)
