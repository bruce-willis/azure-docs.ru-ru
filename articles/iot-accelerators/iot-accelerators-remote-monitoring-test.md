...
1. В разделе **Мониторинг** щелкните **Метрики**. Убедитесь, что число **подключенных устройств** равно двум:
    ...
    ![Количество подключенных клиентов](./media/iot-accelerators-remote-monitoring-test/connecteddevices.png)
...
1. В браузере перейдите к **панели мониторинга** решения удаленного мониторинга. На панели телеметрии **панели мониторинга** выберите вкладку **температура**. На диаграмме появятся значения температуры для всех имитированных устройств:
    ...
    ![Данные телеметрии температуры](./media/iot-accelerators-remote-monitoring-test/telemetry.png)
...
1. Чтобы проверить отправку, перейдите по адресу [https://hub.docker.com/](https://hub.docker.com/). Найдите репозиторий **lightbulb** и выберите **Сведения**. Затем выберите **Теги**:
    ...
    ![Центр Docker](./media/iot-accelerators-remote-monitoring-test/dockerhub.png)
...
![Просмотр списка доступных виртуальных устройств](./media/iot-accelerators-remote-monitoring-test/devicesmodellist.png)

Вы можете просмотреть данные телеметрии из виртуального устройства:

![Просмотр данных телеметрии устройства Lightbulb](./media/iot-accelerators-remote-monitoring-test/devicestelemetry.png)

Вы можете вызвать методы **SwitchOn** и **SwitchOff** на устройстве:

![Вызов методов устройства Lightbulb](./media/iot-accelerators-remote-monitoring-test/devicesmethods.png)
...
![Добавление измененного устройства Chiller](./media/iot-accelerators-remote-monitoring-test/devicesupdatedchiller.png)
...
Теперь вы знаете, как настраивать службу моделирования устройств. Далее мы предлагаем вам ознакомиться со статьей [Подключение устройства к предварительно настроенному решению для удаленного мониторинга (Node.js)](iot-accelerators-connecting-devices-node.md).
