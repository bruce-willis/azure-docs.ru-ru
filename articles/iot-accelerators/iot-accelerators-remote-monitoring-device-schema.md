...
Дополнительные сведения о файле JavaScript, который обновляет объект состояния устройства, см. в статье [Implement the device model behavior](iot-accelerators-remote-monitoring-device-behavior.md) (Реакция модели устройства на событие).
...
Дополнительные сведения о файле JavaScript, который реализует реагирование устройства, см. в статье [Implement the device model behavior](iot-accelerators-remote-monitoring-device-behavior.md) (Реакция модели устройства на событие).
...
Теперь, когда вы узнали о схеме JSON, мы предлагаем ознакомиться со статьей [Implement the device model behavior](iot-accelerators-remote-monitoring-device-behavior.md) (Реакция модели устройства на событие).
