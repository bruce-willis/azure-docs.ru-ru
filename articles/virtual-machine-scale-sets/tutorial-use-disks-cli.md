---
title: Руководство. Создание и использование дисков для масштабируемых наборов с помощью Azure CLI | Документы Майкрософт
description: Узнайте, как с помощью Azure CLI создавать и использовать управляемые диски с масштабируемым набором виртуальных машин, в том числе добавлять, подготавливать, перечислять и отсоединять диски.
...
> [Использование пользовательского образа для экземпляров виртуальных машин в масштабируемом наборе](tutorial-use-custom-image-cli.md)