---
title: Использование API Индексатора видео Azure | Документация Майкрософт
...
ms.locfileid: "39449488"
---
# <a name="use-azure-video-indexer-api"></a>Использование API Индексатора видео
...
В этой статье объясняется, как разработчики могут воспользоваться преимуществами [API Индексатора видео](https://api-portal.videoindexer.ai/). См. дополнительные сведения об [Индексаторе видео](video-indexer-overview.md).

## <a name="subscribe-to-the-api"></a>Оформление подписки на API

1. Войдите.

    Чтобы начать разработку с помощью Индексатора видео, необходимо сначала войти на портал [этой службы](https://api-portal.videoindexer.ai/). 
    
    ![Регистрация](./media/video-indexer-use-apis/video-indexer-api01.png)
...
* Чтобы получить идентификатор учетной записи, используйте портал Индексатора видео:

    1. Войдите на портал [Индексатора видео](https://www.videoindexer.ai/).
...
* Чтобы получить идентификатор учетной записи с помощью программных средств, примените API:
