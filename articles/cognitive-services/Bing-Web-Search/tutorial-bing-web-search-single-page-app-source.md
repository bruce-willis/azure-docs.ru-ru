---
title: Одностраничное веб-приложение для службы "Поиск в Интернете Bing" (исходный код) | Документация Майкрософт
description: Исходный код для руководства по использованию API Bing для поиска в Интернете в одностраничном веб-приложении.
