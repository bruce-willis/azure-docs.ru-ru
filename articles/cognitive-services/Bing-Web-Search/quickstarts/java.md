---
title: Вызов и ответ. Краткое руководство по Azure Cognitive Services и API Bing для поиска в Интернете для Java | Документация Майкрософт
description: Получение информации и примеров кода, которые помогут вам приступить к работе с API Bing для поиска в Интернете с использованием Microsoft Cognitive Services в Azure.
...
3. Добавьте указанный код в файл с именем `BingWebSearch.java`.
4. Замените значение `subscriptionKey` ключом доступа, используемым в вашей подписке.
...
> [Руководство по одностраничным приложениям для Поиска Bing в Интернете](../tutorial-bing-web-search-single-page-app.md)

## <a name="see-also"></a>См. также 

[Общие сведения о Поиске Bing в Интернете](../overview.md)  
