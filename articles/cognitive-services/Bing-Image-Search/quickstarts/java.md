---
title: Вызов и ответ. Краткое руководство по Azure Cognitive Services и API "Поиск изображений Bing" для Java | Документация Майкрософт
...
ms.locfileid: "35382132"
---
# <a name="call-and-response-your-first-bing-image-search-query-in-java"></a>Вызов и ответ: ваш первый запрос к API Bing для поиска изображений на Java
