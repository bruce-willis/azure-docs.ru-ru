---
title: Вызов и ответ. Краткое руководство по Azure Cognitive Services и API "Поиск изображений Bing" для C# | Документация Майкрософт
...
ms.locfileid: "35382145"
---
# <a name="call-and-response-your-first-bing-image-search-query-in-c"></a>Вызов и ответ: ваш первый запрос к API Bing для поиска изображений на C#
...
1. Замените `Program.cs` указанным кодом.
2. Замените значение `accessKey` ключом доступа, допустимым для своей подписки.
