---
title: Вызов и ответ. Краткое руководство по Azure Cognitive Services и API "Поиск изображений Bing" для PHP | Документация Майкрософт
...
ms.locfileid: "35382104"
---
# <a name="call-and-response-your-first-bing-image-search-query-in-php"></a>Вызов и ответ: ваш первый запрос к API Bing для поиска изображений на PHP
...
4. Замените значение `accessKey` ключом доступа, допустимым для своей подписки.
