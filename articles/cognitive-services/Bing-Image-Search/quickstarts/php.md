---
title: Краткое руководство. Отправка поисковых запросов с помощью REST API для API Bing для поиска изображений через PHP
description: Из этого краткого руководства можно узнать, как с помощью PHP отправлять поисковые запросы в API Bing для поиска, чтобы получить список подходящих изображений.
...
ms.locfileid: "41929702"
---
# <a name="quickstart-send-search-queries-using-the-rest-api-and-php"></a>Краткое руководство. Отправка поисковых запросов с помощью REST API и PHP
