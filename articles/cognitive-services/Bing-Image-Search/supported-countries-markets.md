---
title: Поддерживаемые страны, регионы и языки для API Bing для поиска изображений в Azure | Документация Майкрософт
...
ms.locfileid: "39004444"
---
# <a name="bing-image-search-countriesregions-and-languages"></a>Страны, регионы и языки в API Bing для поиска изображений
