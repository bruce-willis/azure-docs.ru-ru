---
title: Начало работы с API распознавания эмоций для JavaScript | Документация Майкрософт
description: Информация и примеры кода, которые помогут вам приступить к работе с API распознавания эмоций с использованием JavaScript в Cognitive Services.
