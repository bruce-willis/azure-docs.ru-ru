---
title: Краткое руководство по API компьютерного зрения для C#. Анализ локального изображения | Документация Майкрософт
titleSuffix: Microsoft Cognitive Services
description: Из этого краткого руководства вы узнаете, как с помощью API компьютерного зрения и C# анализировать локальные изображения в Cognitive Services.
...
ms.locfileid: "43771978"
---
# <a name="quickstart-analyze-a-local-image---rest-c35"></a>Краткое руководство по анализу локального изображения (REST, C&#35;)

Из этого краткого руководства вы узнаете, как анализировать локальное изображение с помощью API компьютерного зрения, чтобы извлечь визуальные признаки.
...
> [Использование API компьютерного зрения с C#](../Tutorials/CSharpTutorial.md)
