---
title: Краткое руководство по обновлению базы знаний в Azure Cognitive Services с использованием Java | Документация Майкрософт
...
1. Вам потребуется библиотека [apache httpclient](http://hc.apache.org/downloads.cgi). Вы можете скачать двоичный файл 4.x.x.tar.gz HttpClient, который содержит все необходимые JAR-файлы для импорта в проект.
