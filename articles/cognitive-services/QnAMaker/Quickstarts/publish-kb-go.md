---
title: Краткое руководство. Публикация базы знаний с помощью Go в Azure Cognitive Services | Документация Майкрософт
...
ms.locfileid: "43770838"
---
# <a name="publish-a-knowledge-base-in-go"></a>Публикация базы знаний на Go
