---
title: Краткое руководство по Java для API службы QnA Maker (v4) от Майкрософт — Azure Cognitive Services | Документация Майкрософт
description: Сведения и примеры кода для быстрого начала работы с API перевода текстов в Microsoft Cognitive Services в Azure.
...
## <a name="get-answers-to-a-question-by-using-a-knowledge-base"></a>Получение ответов на вопрос с помощью базы знаний
