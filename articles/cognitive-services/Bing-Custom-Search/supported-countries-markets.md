---
title: Поддерживаемые страны и языки для API пользовательского поиска Bing в Azure | Документация Майкрософт
description: Узнайте, какие страны и языки поддерживаются в API пользовательского поиска Bing.
...
ms.locfileid: "35381017"
---
# <a name="bing-custom-search-countries-and-languages"></a>Страны и языки в API пользовательского поиска Bing

API пользовательского поиска Bing поддерживает более трех десятков стран, причем во многих из них используется несколько языков. 
...
Страну можно указать с помощью параметра запроса `cc`. Указывая страну, необходимо также задать один или несколько кодов языков с помощью заголовка `Accept-Language`. Поддерживаемые языки различаются в зависимости от страны. Они указаны для каждой страны в таблице **Рынки**.
