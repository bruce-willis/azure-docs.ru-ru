...
2.  Войдите на портал с помощью учетной записи Майкрософт (MSA). Нажмите кнопку **Вход**. Если вы впервые используете портал, выполните следующие дополнительные действия. В противном случае перейдите к шагу 3.
...
4.  На вкладке **Активные** в разделе **Режим поиска** введите URL-адреса сайтов, которые нужно включить в поиск.
5.  Чтобы проверить, возвращает ли экземпляр результаты, введите запрос в области предварительного просмотра в правой части экрана. При отсутствии результатов укажите новый сайт. Bing возвращает результаты только с общедоступных проиндексированных этой службой сайтов.
...
- [Page webpages](./page-webpages.md) (Разбивка веб-страниц на страницы)
