...
## <a name="step-1-create-a-console-application"></a>Шаг 1. Создание консольного приложения

На этом шаге вы воздадите консольное приложение и подготовите ключ обучения и изображения, требуемые для выполнения примера.

1. Запустите Visual Studio 2015 Community Edition. 
2. Создайте новое консольное приложение.
3. Добавьте ссылки на два пакета NuGet:
    * Microsoft.Azure.CognitiveServices.Vision.CustomVision.Training;
    * Microsoft.Azure.CognitiveServices.Vision.CustomVision.Prediction.

4. Замените содержимое файла **Program.cs** кодом, приведенным ниже.
...
Чтобы создать проект Пользовательской службы визуального распознавания, добавьте следующий код в конец метода **Main()**.
...
Чтобы добавить в проект теги, вставьте следующий код после вызова **CreateProject()**:
...
Для проектов обнаружения объектов необходимо определить область объекта с помощью нормализованных координат и тега. Чтобы добавить изображения и области с тегами, вставьте следующий код в конец метода **Main()**:
...
1. Вставьте приведенный ниже код в конец метода **Main()**. Этот код создает первую итерацию в проекте.
...
1. Получите конечную точку, связанную с итерацией по умолчанию, вставив следующий код в конец метода **Main()**. 
...
Выполните сборку и запуск решения. В консоли отобразятся результаты прогнозирования.
