...
На [веб-странице Пользовательской службы визуального распознавания](https://customvision.ai) выберите проект и перейдите на вкладку __Производительность__. Чтобы отобразить сведения об использовании API прогнозирования, выберите __URL-адрес прогнозирования__. Скопируйте следующие данные для использования в приложении:
