...
Этот пример разработан для языка Python.

### <a name="get-the-custom-vision-sdk"></a>Получение пакета SDK для Пользовательской службы визуального распознавания

Чтобы скомпилировать этот пример, необходимо установить пакет SDK для Python с API пользовательского визуального распознавания:
...
## <a name="step-1-get-the-training-and-prediction-keys"></a>Шаг 1. Получение ключей для обучения и прогнозирования
...
В этом примере используются изображения, [размещенные здесь](https://github.com/Azure-Samples/cognitive-services-python-sdk-samples/tree/master/samples/vision/images).

## <a name="step-2-create-a-custom-vision-service-project"></a>Шаг 2. Создание проекта Пользовательской службы визуального распознавания

Чтобы создать проект Пользовательской службы визуального распознавания, создайте файл сценария sample.py с приведенным ниже содержимым. Обратите внимание на разницу между созданием проекта для определения объекта и для классификации изображений: в вызове метода create_project указываются разные предметные области.
...
## <a name="step-3-add-tags-to-your-project"></a>Шаг 3. Добавление тегов в проект

Чтобы добавить в проект теги, добавьте следующий код, который создает два тега:
...
## <a name="step-4-upload-images-to-the-project"></a>Шаг 4. Отправка изображений в проект
...
Чтобы добавить в проект изображения, регионы и теги, вставьте приведенный ниже код после создания тегов. Обратите внимание, что регионы жестко закодированы во встроенном коде, приведенном в этом руководстве. Регион определяет ограничивающий прямоугольник по нормализованным координатам.
...
## <a name="step-5-train-the-project"></a>Шаг 5. Обучение проекта

Итак, вы добавили теги и изображения в проект, и теперь его можно обучить. 

1. Вставьте приведенный ниже код. Этот код создает первую итерацию в проекте. 
2. Обозначьте ее как итерацию по умолчанию.
...
## <a name="step-6-get-and-use-the-default-prediction-endpoint"></a>Шаг 6. Получение и использование конечной точки прогнозирования по умолчанию

Теперь вы готовы использовать созданную модель для прогнозирования. 

1. Получите конечную точку, связанную с итерацией по умолчанию. 
2. Отправьте тестовое изображение в проект, используя эту конечную точку.
