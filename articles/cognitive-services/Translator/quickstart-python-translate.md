---
title: Перевод текста с помощью API перевода текстов и Python | Документация Майкрософт
titleSuffix: Microsoft Cognitive Services
description: Из этого краткого руководства вы узнаете, как перевести текст с одного языка на другой с помощью API перевода текстов и Python в Cognitive Services.
...
ms.locfileid: "43770861"
---
# <a name="quickstart-translate-text-with-python"></a>Краткое руководство. Перевод текста с помощью Python
