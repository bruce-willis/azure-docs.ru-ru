---
title: Преобразование текста с помощью API перевода текстов Microsoft Translator | Документация Майкрософт
description: Преобразование текста с помощью API перевода текстов Microsoft Translator.
