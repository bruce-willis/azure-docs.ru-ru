---
title: Получение вариантов перевода с помощью API перевода текстов и C# | Документация Майкрософт
titleSuffix: Microsoft Cognitive Services
description: Из этого краткого руководства вы узнаете, как найти варианты перевода и примеры контекстуальных терминов, используя API перевода текстов с C# в Cognitive Services.
