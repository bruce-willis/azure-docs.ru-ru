---
title: Определение длины предложения с помощью API перевода текстов и Go | Документация Майкрософт
titleSuffix: Microsoft Cognitive Services
description: С помощью этого краткого руководства вы научитесь определять длину предложений в тексте с помощью API перевода текстов и языка Go в Cognitive Services.
