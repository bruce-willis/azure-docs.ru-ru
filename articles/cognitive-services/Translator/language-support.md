...
API перевода текстов поддерживает следующие языки. Нейронный машинный перевод (NMT) — это новый стандарт высококачественного машинного перевода на основе искусственного интеллекта. Он используется по умолчанию в API перевода текста версии 3, когда доступна нейронная система. Нейронный машинный перевод можно использовать в версии 2 с помощью категории generalnn.
