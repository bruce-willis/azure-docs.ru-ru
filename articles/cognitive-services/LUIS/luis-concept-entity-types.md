...
| **Составная** <br/>[Прошедшая машинное обучение](#machine-learned) | ✔|**Определение**<br>Составная сущность образована из других сущностей, таких как предварительно созданные, простые, регулярное выражение, список, иерархические. Эти отдельные сущности формируют единую сущность. В составных сущностях не допускаются сущности списка. <br><br>**Пример**<br>У составной сущности с именем PlaneTicketOrder могут быть дочерние предварительно созданные сущности `number` и `ToLocation`. <br/><br/>[Руководство](luis-tutorial-composite-entity.md)<br>[Пример ответа для сущности](luis-concept-data-extraction.md#composite-entity-data)|  
