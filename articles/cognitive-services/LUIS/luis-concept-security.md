...
|Ключи конечной точки, добавленные со страницы **[Публикация](luis-how-to-publish-app.md)**|Владелец и участники совместной работы могут добавлять ключи конечных точек|
