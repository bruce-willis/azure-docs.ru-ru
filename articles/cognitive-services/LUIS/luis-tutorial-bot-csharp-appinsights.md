...
* Бот веб-приложения LUIS из **[предыдущего учебника](luis-csharp-tutorial-build-bot-framework-sample.md)** с включенным компонентом Application Insights. 
