---
title: Краткое руководство. Изменение модели и обучение приложения LUIS с помощью Python — Azure Cognitive Services | Документация Майкрософт
