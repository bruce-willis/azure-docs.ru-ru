...
## <a name="examples-of-prebuilt-entities-in-en-us-culture"></a>Примеры предварительно созданных сущностей в языке en-us
В следующей таблице перечислены предварительно созданные сущности с примерами данных и возвращаемых значений.
...
------|------|------|
 ...
 ```builtin.datetimeV2``` | См. [builtin.datetimeV2](luis-reference-prebuilt-datetimev2.md) | См. [builtin.datetimeV2](luis-reference-prebuilt-datetimev2.md) |
