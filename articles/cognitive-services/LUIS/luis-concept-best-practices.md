---
title: Рекомендации по использованию LUIS — Azure | Документы Майкрософт
...
Вместо добавления дополнительных высказываний в намерения регулярно используйте функцию **Просмотра высказываний конечной точки** [активного обучения](label-suggested-utterances.md). Так как приложение постоянно получает высказывания конечной точки, этот список растет и изменяется.
...
* Узнайте, как [спланировать свое приложение](plan-your-app.md) LUIS.
