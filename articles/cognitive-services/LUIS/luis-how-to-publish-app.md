...
Вы всегда можете [протестировать](luis-interactive-test.md) приложения перед его публикацией. 
...
* См. раздел [Manage your LUIS endpoint keys](./luis-how-to-manage-keys.md) (Управление ключами конечной точки LUIS), чтобы добавить ключи к своему приложению LUIS и узнать, как ключи сопоставляются с регионами.
