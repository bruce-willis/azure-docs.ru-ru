---
title: Руководство по вызову приложения Language Understanding (LUIS) с использованием Ruby | Документация Майкрософт
...
ms.locfileid: "36265115"
---
# <a name="tutorial-call-a-luis-endpoint-using-ruby"></a>Руководство по вызову конечной точки LUIS с помощью Ruby
...
## <a name="consume-a-luis-result-using-the-endpoint-api-with-ruby"></a>Получение результата LUIS с помощью API конечной точки с использованием Ruby 
...
3. Запустите приложение Ruby. Отобразится тот же результат JSON, который вы видели ранее в окне браузера.
