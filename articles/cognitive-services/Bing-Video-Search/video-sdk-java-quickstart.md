...
Получите [ключ доступа Cognitive Services](https://azure.microsoft.com/try/cognitive-services/) с помощью **поиска**. Установите зависимости пакета SDK для API "Поиск видео Bing" с помощью Maven, Gradle или другой системы управления зависимостями. Для файла POM Maven требуется объявление:
```
  <dependencies>
    <dependency>
