---
title: 'Краткое руководство: поиск видео Bing, PHP'
...
ms.locfileid: "47224721"
---
# <a name="quickstart-bing-video-search-api-with-php"></a>Краткое руководство: API Bing для поиска видео с использованием PHP

В этой статье показано, как использовать API "Поиск видео Bing", входящий в состав Microsoft Cognitive Services в Azure. Хотя эта статья посвящена языку PHP, API является веб-службой RESTful, совместимой с любым языком программирования, который может выполнять HTTP-запросы и анализировать JSON. 
