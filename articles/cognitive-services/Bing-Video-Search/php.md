---
title: Краткое руководство по Azure Cognitive Services и API "Поиск видео Bing" для PHP | Документация Майкрософт
description: Получите информацию и примеры кода, которые помогут вам быстро приступить к работе с API Bing для поиска видео, входящим в состав Microsoft Cognitive Services в Azure.
...
---
# <a name="quickstart-for-bing-video-search-api-with-php"></a>Краткое руководство по API "Поиск видео Bing" с использованием PHP

В этой статье показано, как использовать API Bing для поиска видео, входящий в состав служб Microsoft Cognitive Services в Azure. Хотя эта статья посвящена языку PHP, API является веб-службой RESTful, совместимой с любым языком программирования, который может выполнять HTTP-запросы и анализировать JSON. 
...
[API Bing для поиска видео](https://docs.microsoft.com/rest/api/cognitiveservices/bing-web-api-v7-reference) возвращает результаты видео из поисковой системы Bing.
