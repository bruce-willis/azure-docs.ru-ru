---
title: Служба "Речь Azure" в Cognitive Services | Документация Майкрософт
...
![Снимок экрана Блокнота с несколькими записями произношения сокращения](media/stt/custom-speech-pronunciation-file.png)
