---
title: Создание акустической модели с помощью службы распознавания речи в Microsoft Cognitive Services | Документы Майкрософт
...
| Каналы | 1 (моно) |
| Формат сэмпла | PCM, 16-разрядные целые числа |
