...
description: Узнайте, как переводить речь с помощью пакета SDK службы "Речь" для Java.
...
ms.locfileid: "48887638"
---
# <a name="translate-speech-with-the-cognitive-services-speech-sdk-for-java"></a>Перевод речи с помощью пакета SDK службы "Речь" (Cognitive Services) для Java
