...
description: Описывается, как получить аналитику для API Bing для поиска новостей.
...
---
# <a name="how-to-get-analytics-for-bing-news-search-api"></a>Как получить аналитику для API Bing для поиска новостей
