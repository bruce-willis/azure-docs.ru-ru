...
скомпилируйте источники TypeScript и сгруппируйте их для использования в браузере одним файлом JavaScript ([npm](https://www.npmjs.com/) необходимо установить на вашем компьютере). Перейдите в корень клонированного репозитория и выполните команды:
