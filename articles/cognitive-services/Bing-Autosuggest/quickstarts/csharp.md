---
title: Краткое руководство по API автозаполнения Bing с использованием C# | Документация Майкрософт
