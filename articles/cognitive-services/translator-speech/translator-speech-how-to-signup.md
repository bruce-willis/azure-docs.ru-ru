---
title: Регистрация API перевода речи Microsoft | Документация Майкрософт
titleSuffix: Cognitive Services
description: Как зарегистрироваться в Microsoft API перевода речи.
...
ms.locfileid: "35380545"
---
# <a name="how-to-sign-up-for-the-microsoft-translator-speech-api"></a>Как зарегистрироваться в Microsoft API перевода речи

Выполните следующие действия, чтобы зарегистрироваться в Microsoft API перевода речи.
...
- После входа в Azure перейдите в раздел [Cognitive Services](https://portal.azure.com/#create/Microsoft.CognitiveServices)
