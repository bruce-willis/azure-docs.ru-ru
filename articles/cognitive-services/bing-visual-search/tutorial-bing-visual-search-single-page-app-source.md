---
title: Одностраничное веб-приложение для службы Bing Visual Search (исходный код) | Документация Майкрософт
...
ms.locfileid: "39002598"
---
# <a name="tutorial-visual-search-single-page-web-app"></a>Руководство по одностраничным веб-приложениям для Bing Visual Search
