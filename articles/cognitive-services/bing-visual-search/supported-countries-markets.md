---
title: Поддерживаемые страны, регионы и языки для API Bing Visual Search | Документация Майкрософт
titleSuffix: Bing Web Search APIs - Cognitive Services
description: Узнайте, какие страны, регионы и языки поддерживаются в API Bing Visual Search.
...
ms.locfileid: "39001234"
---
# <a name="bing-visual-search-countriesregions-and-languages"></a>Страны, регионы и языки в Bing Visual Search
