---
title: Azure Content Moderator. Модерация изображений | Документация Майкрософт
...
![Проверка изображений человеком](images/moderation-reviews-quickstart-dotnet.PNG)
