...
В этом кратком руководстве не демонстрируется применение тегов к изображениям в списке. 
...
При каждом изменении списка необходимо обновить его индекс поиска, прежде чем использовать этот список для проверки изображений.
