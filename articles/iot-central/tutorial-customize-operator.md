...
3. Чтобы изменить панель мониторинга, выберите **Панель мониторинга**:

    ![Страница панели мониторинга шаблона устройства](media/tutorial-customize-operator/dashboard.png)

4. Чтобы добавить плитку ключевого показателя эффективности (КПЭ) на панель мониторинга, выберите **КПЭ**:
...
2. Чтобы обновить серийный номер устройства, измените значение на плитке серийного номера и выберите **Сохранить**:
