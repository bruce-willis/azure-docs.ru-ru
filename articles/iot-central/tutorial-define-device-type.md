...
Используйте *свойства* для хранения сведений о вашем устройстве в приложении. В этом разделе вы добавите облачные свойства к шаблону **подключенного кондиционера** для хранения данных о расположении устройства и даты последнего обслуживания. Обратите внимание, что оба эти свойства устройства можно изменять. Также есть свойства только для чтения, получаемые от устройства, которые нельзя изменить, например серийный номер и версия встроенного ПО устройства.
...
2. Для настройки свойства расположения используйте сведения из следующей таблицы:
...
3. Чтобы добавить свойство даты обслуживания в шаблон устройства, выберите **Дата**.

4. Для настройки свойства даты последнего обслуживания используйте сведения из следующей таблицы:
