...
ms.locfileid: "39003772"
---
# <a name="create-your-azure-iot-central-application"></a>Создание приложения Azure IoT Central

Создать приложение Microsoft Azure IoT Central можно на странице [Создание приложения](https://apps.microsoftiotcentral.com/create). Нужно заполнить все поля на этой странице и нажать кнопку **Создать**. Ниже приводятся сведения о каждом поле.

![Страница создания приложения](media\howto-create-application\image1.png)

## <a name="payment-plan"></a>План оплаты

Вы можете создать пробную или платную версию приложения. Дополнительные сведения о пробных и платных версиях приложения см. [на странице с ценами на Azure IoT Central](https://azure.microsoft.com/pricing/details/iot-central/).
...
Если у вас еще нет подписки, создайте ее на [странице входа в Azure](https://aka.ms/createazuresubscription). После создания подписки Azure перейдите на страницу **Создание приложения**. В раскрывающемся списке **Подписка Azure** отобразится новая подписка.
