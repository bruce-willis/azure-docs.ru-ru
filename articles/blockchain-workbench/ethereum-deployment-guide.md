...
![Общие сведения об изоляции и лидерах консорциума](./media/ethereum-deployment-guide/leader-overview.png)
...
![Размер и производительность сети](./media/ethereum-deployment-guide/network-size-performance.png)
...
Размер виртуальной машины узла майнинга|Размер виртуальной машины, используемой для узлов майнинга.|"Стандартный" A, <br />"Стандартный" D, <br />"Стандартный" D-v2, <br />"Стандартный" серия F, <br />"Стандартный" DS, <br />"Стандартный" FS|Стандартный D1v2
...
Размер виртуальной машины узла транзакций|Размер виртуальной машины, используемой для узлов транзакций.|"Стандартный" A, <br />"Стандартный" D, <br />"Стандартный" D-v2, <br />"Стандартный" серия F, <br />"Стандартный" DS, <br />"Стандартный" FS|Стандартный D1v2
...
![Параметры Ethereum](./media/ethereum-deployment-guide/standalone-leader-deployment.png)
...
Общий ключ для подключения|Общий ключ для подключения между шлюзами виртуальной сети.| 12 или более символов|Нет данных
...
![Расширение MetaMask](./media/ethereum-deployment-guide/metamask-extension.png)
