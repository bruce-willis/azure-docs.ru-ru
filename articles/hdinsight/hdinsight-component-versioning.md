---
title: Компоненты и версии Hadoop в Azure HDInsight
...
| Компонент | HDInsight 4.0 (предварительная версия) | HDInsight 3.6 (по умолчанию) | HDInsight 3.5 | HDInsight 3.4 | HDInsight 3.3 | HDInsight 3.2 | HDInsight 3.1 | HDInsight 3.0 |
| --- | --- | --- | --- | --- | --- | --- | --- |--- |
| Hortonworks Data Platform |3.0 |2.6 |2.5 |2.4 |2.3 |2.2 |2.1.7 |2,0 |
| Apache Hadoop и YARN |2.9.1 |2.7.3 |2.7.3 |2.7.1 |2.7.1 |2.6.0 |2.4.0 |2.2.0 |
...
| Apache Spark |2.3.1 |2.3.0, 2.2.0, 2.1.0 |1.6.2, 2.0 |1.6.0 |1.5.2 |1.3.1 (только для Windows) |-|-|
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| HDInsight 4.0 <br> (предварительная версия) |HDP 3.0 |Ubuntu 16.0.4 LTS |24 сентября 2018 г. | | |Yes |Yes |
| HDInsight 3.6 |HDP 2.6 |Ubuntu 16.0.4 LTS |4 апреля 2017 г. | | |Yes |Yes |
| HDInsight 3.5 <br> (Spark)* |HDP 2.6 |Ubuntu 16.0.4 LTS |30 сентября 2016 г. |13 марта 2019 г. |13 марта 2019 г. |Yes |Yes |

*Поддержка HDInsight 3.5 расширена только для типов кластера Spark*

> [!NOTE]
> По истечении срока поддержки для версии она может стать недоступной на портале Microsoft Azure. Однако доступ к версиям кластера по-прежнему можно будет получить с помощью параметра `Version` в командлете Windows PowerShell [New-AzureHDInsightCluster](https://docs.microsoft.com/powershell/module/azurerm.hdinsight/new-azurermhdinsightcluster) и пакета SDK для .NET до даты вывода.
>
...
| Версия HDInsight | Версия HDP | ОС виртуальной машины | Дата выпуска | Дата прекращения поддержки | Дата вывода | высокую доступность; |  Доступность на портале Azure | 
| --- | --- | --- | --- | --- | --- | --- | --- |
| HDInsight 3.5 <br> (Не Spark) |HDP 2.5 |Ubuntu 16.0.4 LTS |30 сентября 2016 г. |5 сентября 2017 г. |28 июня 2018 года |Yes |Нет  |
...
* Все поддерживаемые регионы, кроме южной Бразилии и западной Японии:
  ...
  | Тип кластера | Hadoop | hbase | Interactive Query | Storm | Spark | ML Server |
  | --- | --- | --- | --- | --- | --- | --- |
  | Головной узел: размер виртуальной машины по умолчанию |D3 v2 |D3 v2 | D13, D14 |A4 v2 |D12 v2 |D12 v2 |
  | Головной узел: рекомендуемые размеры виртуальных машин |D3 v2, D4 v2, D12 v2 |D3 v2, D4 v2, D12 v2  | D13, D14 |A4 v2, A8 v2, A2m v2 |D12 v2, D13 v2, D14 v2 |D12 v2, D13 v2, D14 v2 |
  ...
  | ZooKeeper: размер виртуальной машины по умолчанию | |A4 v2 | |A2 v2 | | |
  | ZooKeeper: рекомендуемые размеры виртуальных машин | |A4 v2, A8 v2, A2m v2 | | A2 v2, A4 v2, A8 v2 | | |
...
* Только южная Бразилия и западная Япония (нет размеров v2):
  ...
  | Тип кластера | Hadoop | hbase | Interactive Query |Storm | Spark | Служба "Машинное обучение" |
  | --- | --- | --- | --- | --- | --- | --- |
