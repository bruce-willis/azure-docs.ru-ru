...
> [!NOTE]
> Новые возможности, описанные в этой статье, доступны в режиме предварительной версии только для следующих типов кластера: Hadoop, Spark и Interactive Query.
