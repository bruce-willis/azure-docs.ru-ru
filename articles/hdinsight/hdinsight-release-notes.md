...
## <a name="notes-for-06272018---release-of-new-open-source-versions-adls-gen2-etc-on-hdinsight-36"></a>Примечания к выпуску от 27 июня 2018 года. Выпуск новых версий с открытым кодом для ADLS поколения 2 и т. п. на HDInsight 3.6
Выпуск HDInsight от июня 2018 года постепенно стал значимым выпуском, объединив большое количество перечисленных ниже обновлений и возможностей, которые мы подготовили для клиентов. Дополнительные сведения см. в [этой записи блога](https://azure.microsoft.com/en-us/blog/enterprises-get-deeper-insights-with-hadoop-and-spark-updates-on-azure-hdinsight/).

Далее перечислены наиболее важные моменты. Подробные заметки о выпуске, исправленные ошибки, известные проблемы и многое другое собрано в [этом документе](https://aka.ms/hdirelnotes).

- **Обновление Hadoop и других проектов с открытым кодом**. Помимо исправления более чем 1000 ошибок в более чем 20 проектах с открытым кодом, это обновление содержит и новые версии Spark (2.3) и Kafka (1.0).
- **Обновление R Server 9.1 до Служб машинного обучения 9.3**. В этом выпуске мы предоставили специалистами по анализу данных и инженерам лучшие проекты с открытым исходным кодом, дополненные инновационными алгоритмами и возможностью легко вводить их в эксплуатацию, причем на любом удобном языке с сохранением скорости Apache Spark. Этот выпуск расширяет возможности, предлагаемые R Server, добавляя поддержку Python. В связи с этим имя кластера изменилось с R Server на Службы машинного обучения. 
- **Поддержка хранилища Azure Data Lake поколения 2**. HDInsight теперь будет поддерживать предварительный выпуск хранилища Azure Data Lake поколения 2. Во всех регионах доступности клиентам будет предоставлена возможность выбрать учетную запись ADSL поколения 2 для хранения кластеров HDInsight.
