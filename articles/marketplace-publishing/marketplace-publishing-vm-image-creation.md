...
3.  Создайте файл PowerShell (или другой исполняемый скрипт) со следующим кодом и сохраните его на локальном компьютере.
    ...
    c. **`<Permission Start Date>`**: чтобы сохранить время в формате UTC, выберите дату начала за день до текущей даты. Например, если сегодня 26 октября 2016 г., выберите значение 25.10.2016. Если используется Azure CLI версии 2.0 (команда az), укажите дату и время для дат начала и окончания, например 10-25-2016T00:00:00Z.
