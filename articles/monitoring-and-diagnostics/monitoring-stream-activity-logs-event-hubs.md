...
4. Щелкните параметр **Концентраторы событий Azure**, выберите пространство имен концентраторов событий, в которые должны отправляться журналы, а затем нажмите кнопку **ОК**.
