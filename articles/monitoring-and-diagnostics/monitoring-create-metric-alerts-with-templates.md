...
## <a name="resource-manager-template-for-metric-alert-that-monitors-multiple-resources"></a>Шаблон Resource Manager для оповещения метрики с возможностью мониторинга нескольких ресурсов

В предыдущем разделе описаны примеры шаблонов Azure Resource Manager для создания оповещений на основе метрик, которые отслеживают один ресурс. Теперь Azure Monitor поддерживает мониторинг нескольких ресурсов с одним правилом генерации оповещений о метриках. Эта предварительная версия функции сейчас доступна только с помощью шаблонов Azure Resource Manager и REST API и поддерживается только для виртуальных машин. Поддержка портала для создания и редактирования таких правил ожидается в ближайшее время.
...
### <a name="all-virtual-machines-in-one-or-more-resource-groups"></a>Все виртуальные машины в одной или нескольких группах ресурсов

Этот шаблон позволяет создать правило генерации оповещений метрики, которое отслеживает процент загрузки ЦП для всех виртуальных машин (в одном регионе Azure) в одной или нескольких группах ресурсов.

Для работы с этим руководством сохраните приведенный ниже код JSON в виде файла all-vms-in-resource-group.json.
...
Для работы с этим руководством сохраните и измените приведенный ниже код JSON в виде файла all-vms-in-resource-group.parameters.json.
...
### <a name="all-virtual-machines-in-a-subscription"></a>Все виртуальные машины в подписке

Этот шаблон позволяет создать правило генерации оповещений метрики, которое отслеживает процент загрузки ЦП для всех виртуальных машин (в одном регионе Azure) в подписке.

Для работы с этим руководством сохраните приведенный ниже код JSON в виде файла all-vms-in-subscription.json.
...
Приведенный выше шаблон можно использовать с файлом параметров, указанным ниже.
Для работы с этим руководством сохраните и измените приведенный ниже код JSON в виде файла all-vms-in-subscription.parameters.json.
...
### <a name="a-list-of-virtual-machines"></a>Список виртуальных машин

Этот шаблон позволяет создать правило генерации оповещений метрики, которое отслеживает процент загрузки ЦП для списка виртуальных машин (в одном регионе Azure) в подписке.

Для работы с этим руководством сохраните приведенный ниже код JSON в виде файла list-of-vms.json.
...
Приведенный выше шаблон можно использовать с файлом параметров, указанным ниже.
Для работы с этим руководством сохраните и измените приведенный ниже код JSON в виде файла list-of-vms.parameters.json.
