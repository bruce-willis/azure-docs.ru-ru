...
В этой статье показано, как можно использовать [шаблон Azure Resource Manager](../azure-resource-manager/resource-group-authoring-templates.md) для настройки [новых оповещений метрик](monitoring-near-real-time-metric-alerts.md) в Azure Monitor. Шаблоны Resource Manager позволяют программно настроить оповещения согласованным и воспроизводимым образом в разных средах. Сейчас в [этом наборе типов ресурсов](monitoring-near-real-time-metric-alerts.md#metrics-and-dimensions-supported) доступны новые оповещения метрик.

> [!IMPORTANT]
> Шаблон Resource Manager, указанный для оповещения метрики, не будет работать для типа ресурсов Microsoft.OperationalInsights/workspaces, поскольку поддержка метрик в Log Analytics доступна в предварительной версии. Пользователи, заинтересованные в использовании функций предварительной версии с шаблоном ресурсов, могут связаться со [службой обратной связи по оповещениям Azure](mailto:azurealertsfeedback@microsoft.com)
...
## <a name="resource-manager-template-for-a-simple-metric-alert"></a>Шаблон Resource Manager для простого оповещения метрики
...
В целях данного руководства сохраните приведенную ниже JSON в виде файла simplemetricalert.json.
...
Описание схемы и свойств правила генерации оповещений [доступно здесь](https://docs.microsoft.com/en-us/rest/api/monitor/metricalerts/createorupdate).
...
Сохраните приведенную ниже JSON в виде файла simplemetricalert.parameters.json и измените его соответствующим образом.
...
## <a name="resource-manager-template-for-a-more-advanced-metric-alert"></a>Шаблон Resource Manager для более сложного оповещения метрики
...
В целях данного руководства сохраните приведенную ниже JSON в виде файла advancedmetricalert.json.
...
В целях данного руководства сохраните и измените приведенную ниже JSON в виде файла advancedmetricalert.parameters.json.
...
* Дополнительные сведения об [оповещениях в Azure](monitoring-overview-unified-alerts.md)
* Сведения о [создании группы действий с помощью шаблона Resource Manager](monitoring-create-action-group-with-resource-manager-template.md)
