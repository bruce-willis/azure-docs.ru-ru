...
|Capacity|Емкость (предварительная версия)|Процент|Средняя|Метрика использования для службы ApiManagement|Расположение|
...
|connections_failed|Общее количество неудачных подключений|Count|Всего|Общее количество неудачных подключений|Нет измерений|
...
|serverlog_storage_usage|Используемый объем хранилища для журнала сервера|Байты|Средняя|Используемый объем хранилища для журнала сервера|Нет измерений|
|serverlog_storage_limit|Максимальный объем хранилища для журнала сервера|Байты|Средняя|Максимальный объем хранилища для журнала сервера|Нет измерений|
|active_connections|Общее количество активных подключений|Count|Всего|Общее количество активных подключений|Нет измерений|
|connections_failed|Общее количество неудачных подключений|Count|Всего|Общее количество неудачных подключений|Нет измерений|
...
|DipAvailability|Доступность выделенного IP-адреса (DIP)|Count|Средняя|Доступность конечных точек выделенного IP-адреса на основе результатов проверки|ProtocolType, DipPort, VipAddress, VipPort, DipAddress|
...
|Метрика|Отображаемое имя метрики|Единица измерения|Тип статистической обработки|ОПИСАНИЕ|Измерения|
|---|---|---|---|---|---|
|ConnectionCount|Число подключений|Count|Максимальная|Количество пользовательских подключений.|Нет измерений|
|ConnectionCountPerSecond|Число подключений в секунду|Число/с|Средняя|Среднее число подключений в секунду.|Нет измерений|
|MessageCount|Количество сообщений|Count|Максимальная|Общее количество сообщений в месяц|Нет измерений|
|MessageCountPerSecond|Число сообщений в секунду|Число/с|Средняя|Среднее число сообщений|Нет измерений|
|MessageUsed|Сообщение использовано|Процент|Максимальная|Использованный процент сообщений в месяц|Нет измерений|
|ConnectionUsed|Подключений использовано|Процент|Максимальная|Использованный процент подключений|Нет измерений|
...
|SystemLoad|Нагрузка на систему|Процент|Максимальная|Процент нагрузки на систему|Нет измерений|
