...
| Оповещения о запросах поиска по журналам | Уведомления | Log Analytics | <ul><li>**Webhook:** [оповещения Log Analytics](../log-analytics/log-analytics-alerts-actions.md#webhook-actions).</li></ul> |
