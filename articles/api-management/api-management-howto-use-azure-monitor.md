...
1. В строке меню внизу страницы выберите **Оповещения (классические)**.

    ![оповещения](./media/api-management-azure-monitor/api-management-alert-rules-blade.png)
