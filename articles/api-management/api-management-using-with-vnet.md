...
* **Тестирование API на портале Azure.** Если API тестируется на портале Azure и экземпляр службы управления API интегрирован с внутренней виртуальной сетью, для разрешения имен будут использоваться DNS-серверы, настроенные в виртуальной сети. Если при тестировании на портале Azure отображается код 404, убедитесь, что DNS-серверы для виртуальной сети могут правильно разрешить имя узла для экземпляра службы управления API. 
